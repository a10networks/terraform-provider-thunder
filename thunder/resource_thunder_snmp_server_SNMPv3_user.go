...
func resourceSnmpServerSNMPv3User() *schema.Resource {
	return &schema.Resource{
		Create: resourceSnmpServerSNMPv3UserCreate,
		Update: resourceSnmpServerSNMPv3UserUpdate,
		Read:   resourceSnmpServerSNMPv3UserRead,
		Delete: resourceSnmpServerSNMPv3UserDelete,
...
func resourceSnmpServerSNMPv3UserCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if client.Host != "" {
		...
		d.SetId(name1)
		go_thunder.PostSnmpServerSNMPv3User(client.Token, data, client.Host)

		return resourceSnmpServerSNMPv3UserRead(d, meta)

	}
	return nil
}

func resourceSnmpServerSNMPv3UserRead(d *schema.ResourceData, meta interface{}) error {
	logger := util.GetLoggerInstance()
	client := meta.(Thunder)
...
func resourceSnmpServerSNMPv3UserUpdate(d *schema.ResourceData, meta interface{}) error {
	logger := util.GetLoggerInstance()
	client := meta.(Thunder)
	...
	if client.Host != "" {
		...
		data := dataToSnmpServerSNMPv3User(d)
		logger.Println("[INFO] received formatted data from method data to SnmpServerSNMPv3User ")
		go_thunder.PutSnmpServerSNMPv3User(client.Token, name1, data, client.Host)
...
func resourceSnmpServerSNMPv3UserDelete(d *schema.ResourceData, meta interface{}) error {
	logger := util.GetLoggerInstance()
	client := meta.(Thunder)
