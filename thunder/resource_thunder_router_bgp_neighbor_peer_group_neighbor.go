...
func resourceRouterBgpNeighborPeerGroupNeighbor() *schema.Resource {
	return &schema.Resource{
		Create: resourceRouterBgpNeighborPeerGroupNeighborCreate,
		Update: resourceRouterBgpNeighborPeerGroupNeighborUpdate,
		Read:   resourceRouterBgpNeighborPeerGroupNeighborRead,
		Delete: resourceRouterBgpNeighborPeerGroupNeighborDelete,
...
func resourceRouterBgpNeighborPeerGroupNeighborCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if client.Host != "" {
		...
		go_thunder.PostRouterBgpNeighborPeerGroupNeighbor(client.Token, name, data, client.Host)

		return resourceRouterBgpNeighborPeerGroupNeighborRead(d, meta)

	}
	return nil
}

func resourceRouterBgpNeighborPeerGroupNeighborRead(d *schema.ResourceData, meta interface{}) error {
	logger := util.GetLoggerInstance()
	client := meta.(Thunder)
...
func resourceRouterBgpNeighborPeerGroupNeighborUpdate(d *schema.ResourceData, meta interface{}) error {
	logger := util.GetLoggerInstance()
	client := meta.(Thunder)
	...
	if client.Host != "" {
		...
		data := dataToRouterBgpNeighborPeerGroupNeighbor(d)
		logger.Println("[INFO] received formatted data from method data to RouterBgpNeighborPeerGroupNeighbor ")
		go_thunder.PutRouterBgpNeighborPeerGroupNeighbor(client.Token, name1, name2, data, client.Host)
...
func resourceRouterBgpNeighborPeerGroupNeighborDelete(d *schema.ResourceData, meta interface{}) error {
	logger := util.GetLoggerInstance()
	client := meta.(Thunder)
