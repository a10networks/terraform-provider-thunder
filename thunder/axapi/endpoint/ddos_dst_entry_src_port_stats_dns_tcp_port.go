...
type DdosDstEntrySrcPortStats struct {
	Inst struct {
		PortNum int `json:"port-num"`

		Protocol string `json:"protocol"`

		Stats DdosDstEntrySrcPortStatsStats `json:"stats"`

		DstEntryName string
	} `json:"src-port"`
}

type DdosDstEntrySrcPortStatsStats struct {
	DnsTcpPort DdosDstEntrySrcPortStatsStatsDnsTcpPort `json:"dns-tcp-port"`
}

type DdosDstEntrySrcPortStatsStatsDnsTcpPort struct {
...
func (p *DdosDstEntrySrcPortStats) GetId() string {
	return "1"
}

func (p *DdosDstEntrySrcPortStats) getPath() string {
	return "ddos/dst/entry/" + p.Inst.DstEntryName + "/src-port/" + strconv.Itoa(p.Inst.PortNum) + "+" + p.Inst.Protocol + "/stats?dns-tcp-port=true"
}

func (p *DdosDstEntrySrcPortStats) Post(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstEntrySrcPortStats::Post")
...
func (p *DdosDstEntrySrcPortStats) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstEntrySrcPortStats::Get")
	headers := axapi.GenRequestHeader(authToken)
...
func (p *DdosDstEntrySrcPortStats) Put(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstEntrySrcPortStats::Put")
	headers := axapi.GenRequestHeader(authToken)
	payloadBytes, err := axapi.SerializeToJson(p)
	if err != nil {
		logger.Println("Failed to serialize struct as json", err)
...
func (p *DdosDstEntrySrcPortStats) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstEntrySrcPortStats::Delete")
	headers := axapi.GenRequestHeader(authToken)
