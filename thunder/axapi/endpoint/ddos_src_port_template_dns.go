...
type DdosSrcPortTemplateDns struct {
	Inst struct {
		...
		QueryResolutionCheck DdosSrcPortTemplateDnsQueryResolutionCheck334 `json:"query-resolution-check"`
...
type DdosSrcPortTemplateDnsQueryResolutionCheck334 struct {
