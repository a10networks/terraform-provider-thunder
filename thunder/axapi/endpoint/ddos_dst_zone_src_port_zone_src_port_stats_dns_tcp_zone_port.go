...
type DdosDstZoneSrcPortZoneSrcPortStats struct {
	Inst struct {
		PortNum int `json:"port-num"`

		Protocol string `json:"protocol"`

		Stats DdosDstZoneSrcPortZoneSrcPortStatsStats `json:"stats"`

		ZoneName string
	} `json:"zone-src-port"`
}

type DdosDstZoneSrcPortZoneSrcPortStatsStats struct {
	DnsTcpZonePort DdosDstZoneSrcPortZoneSrcPortStatsStatsDnsTcpZonePort `json:"dns-tcp-zone-port"`
}

type DdosDstZoneSrcPortZoneSrcPortStatsStatsDnsTcpZonePort struct {
	...
	Tcp_req_incomplete                       int `json:"tcp_req_incomplete"`
	...
	Query_forward_rate_exceed                int `json:"query_forward_rate_exceed"`
...
func (p *DdosDstZoneSrcPortZoneSrcPortStats) GetId() string {
	return "1"
}

func (p *DdosDstZoneSrcPortZoneSrcPortStats) getPath() string {
	return "ddos/dst/zone/" + p.Inst.ZoneName + "/src-port/zone-src-port/" + strconv.Itoa(p.Inst.PortNum) + "+" + p.Inst.Protocol + "/stats?dns-tcp-zone-port=true"
}

func (p *DdosDstZoneSrcPortZoneSrcPortStats) Post(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZoneSrcPortZoneSrcPortStats::Post")
...
func (p *DdosDstZoneSrcPortZoneSrcPortStats) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZoneSrcPortZoneSrcPortStats::Get")
	headers := axapi.GenRequestHeader(authToken)
...
func (p *DdosDstZoneSrcPortZoneSrcPortStats) Put(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZoneSrcPortZoneSrcPortStats::Put")
	headers := axapi.GenRequestHeader(authToken)
	payloadBytes, err := axapi.SerializeToJson(p)
	if err != nil {
		logger.Println("Failed to serialize struct as json", err)
...
func (p *DdosDstZoneSrcPortZoneSrcPortStats) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZoneSrcPortZoneSrcPortStats::Delete")
	headers := axapi.GenRequestHeader(authToken)
