...
type SlbVirtualServerPortStats51Stats struct {
    Imap_vport SlbVirtualServerPortStats51StatsImap_vport `json:"imap_vport"`
}


type SlbVirtualServerPortStats51StatsImap_vport struct {
    Num int `json:"num"`
    Curr int `json:"curr"`
...
func (p *SlbVirtualServerPortStats51) getPath() string{
    return "slb/virtual-server/" +p.Inst.Name + "/port/" +strconv.Itoa(p.Inst.PortNumber)+"+"+p.Inst.Protocol+"/stats?imap_vport=true"
}
