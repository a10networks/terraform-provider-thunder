...
type DdosDstEntryPortRangeStats5 struct {
	Inst struct {
		...
		Stats DdosDstEntryPortRangeStats5Stats `json:"stats"`

		DstEntryName string
	} `json:"port-range"`
}

type DdosDstEntryPortRangeStats5Stats struct {
	HttpPort DdosDstEntryPortRangeStats5StatsHttpPort `json:"http-port"`
}

type DdosDstEntryPortRangeStats5StatsHttpPort struct {
...
func (p *DdosDstEntryPortRangeStats5) GetId() string {
	return "1"
}

func (p *DdosDstEntryPortRangeStats5) getPath() string {
	return "ddos/dst/entry/" + p.Inst.DstEntryName + "/port-range/" + strconv.Itoa(p.Inst.PortRangeStart) + "+" + strconv.Itoa(p.Inst.PortRangeEnd) + "+" + p.Inst.Protocol + "/stats?http-port=true"
}

func (p *DdosDstEntryPortRangeStats5) Post(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstEntryPortRangeStats5::Post")
...
func (p *DdosDstEntryPortRangeStats5) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstEntryPortRangeStats5::Get")
	headers := axapi.GenRequestHeader(authToken)
...
func (p *DdosDstEntryPortRangeStats5) Put(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstEntryPortRangeStats5::Put")
	headers := axapi.GenRequestHeader(authToken)
	payloadBytes, err := axapi.SerializeToJson(p)
	if err != nil {
		logger.Println("Failed to serialize struct as json", err)
...
func (p *DdosDstEntryPortRangeStats5) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstEntryPortRangeStats5::Delete")
	headers := axapi.GenRequestHeader(authToken)
