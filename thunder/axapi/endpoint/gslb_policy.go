...
type GslbPolicy struct {
    ...
    ActiveRdt GslbPolicyActiveRdt384 `json:"active-rdt"`
    ...
    AutoMap GslbPolicyAutoMap385 `json:"auto-map"`
    BwCostEnable int `json:"bw-cost-enable"`
    BwCostFailBreak int `json:"bw-cost-fail-break"`
    Capacity GslbPolicyCapacity386 `json:"capacity"`
    ConnectionLoad GslbPolicyConnectionLoad387 `json:"connection-load"`
    Dns GslbPolicyDns388 `json:"dns"`
    Edns GslbPolicyEdns392 `json:"edns"`
    GeoLocationList []GslbPolicyGeoLocationList `json:"geo-location-list"`
    GeoLocationMatch GslbPolicyGeoLocationMatch393 `json:"geo-location-match"`
...
type GslbPolicyActiveRdt384 struct {
...
type GslbPolicyAutoMap385 struct {
...
type GslbPolicyCapacity386 struct {
...
type GslbPolicyConnectionLoad387 struct {
...
type GslbPolicyDns388 struct {
    ...
    Ipv6 []GslbPolicyDnsIpv6389 `json:"ipv6"`
    BlockAction int `json:"block-action"`
    ActionType string `json:"action-type"`
    ProxyBlockPortRangeList []GslbPolicyDnsProxyBlockPortRangeList390 `json:"proxy-block-port-range-list"`
    BlockValue []GslbPolicyDnsBlockValue391 `json:"block-value"`
...
type GslbPolicyGeoLocationMatch393 struct {
