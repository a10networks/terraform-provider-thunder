...
type DdosDstZoneSrcPortZoneSrcPortStats44 struct {
	Inst struct {
		PortNum int `json:"port-num"`

		Protocol string `json:"protocol"`

		Stats DdosDstZoneSrcPortZoneSrcPortStats44Stats `json:"stats"`

		ZoneName string
	} `json:"zone-src-port"`
}

type DdosDstZoneSrcPortZoneSrcPortStats44Stats struct {
	TcpZonePort DdosDstZoneSrcPortZoneSrcPortStats44StatsTcpZonePort `json:"tcp-zone-port"`
}

type DdosDstZoneSrcPortZoneSrcPortStats44StatsTcpZonePort struct {
...
func (p *DdosDstZoneSrcPortZoneSrcPortStats44) GetId() string {
	return "1"
}

func (p *DdosDstZoneSrcPortZoneSrcPortStats44) getPath() string {
	return "ddos/dst/zone/" + p.Inst.ZoneName + "/src-port/zone-src-port/" + strconv.Itoa(p.Inst.PortNum) + "+" + p.Inst.Protocol + "/stats?tcp-zone-port=true"
}

func (p *DdosDstZoneSrcPortZoneSrcPortStats44) Post(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZoneSrcPortZoneSrcPortStats44::Post")
...
func (p *DdosDstZoneSrcPortZoneSrcPortStats44) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZoneSrcPortZoneSrcPortStats44::Get")
	headers := axapi.GenRequestHeader(authToken)
...
func (p *DdosDstZoneSrcPortZoneSrcPortStats44) Put(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZoneSrcPortZoneSrcPortStats44::Put")
	headers := axapi.GenRequestHeader(authToken)
	payloadBytes, err := axapi.SerializeToJson(p)
	if err != nil {
		logger.Println("Failed to serialize struct as json", err)
...
func (p *DdosDstZoneSrcPortZoneSrcPortStats44) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZoneSrcPortZoneSrcPortStats44::Delete")
	headers := axapi.GenRequestHeader(authToken)
