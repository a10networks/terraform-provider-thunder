...
type ScaleoutClusterClusterDevices struct {
	Inst struct {
		ClusterDiscoveryTimeout ScaleoutClusterClusterDevicesClusterDiscoveryTimeout1412 `json:"cluster-discovery-timeout"`

		DeviceIdList []ScaleoutClusterClusterDevicesDeviceIdList `json:"device-id-list"`

		Enable int `json:"enable"`

		MinimumNodes ScaleoutClusterClusterDevicesMinimumNodes1413 `json:"minimum-nodes"`
...
type ScaleoutClusterClusterDevicesClusterDiscoveryTimeout1412 struct {
	Uuid string `json:"uuid"`
}
...
type ScaleoutClusterClusterDevicesMinimumNodes1413 struct {
