...
type TemplateLimitPolicyLimitThroughput2028 struct {
	...
	UplinkBurstsize       int    `json:"uplink-burstsize"`
	UplinkBurstsizeUnit   string `json:"uplink-burstsize-unit" dval:"Mbps,"`
	UplinkRelaxed         int    `json:"uplink-relaxed"`
	Downlink              int    `json:"downlink"`
	DownlinkUnit          string `json:"downlink-unit" dval:"Mbps"`
	DownlinkBurstsize     int    `json:"downlink-burstsize"`
	DownlinkBurstsizeUnit string `json:"downlink-burstsize-unit" dval:"Mbps,"`
	DownlinkRelaxed       int    `json:"downlink-relaxed"`
	Total                 int    `json:"total"`
	TotalUnit             string `json:"total-unit" dval:"Mbps,"`
	TotalBurstsize        int    `json:"total-burstsize"`
	TotalBurstsizeUnit    string `json:"total-burstsize-unit" dval:"Mbps,"`
	TotalRelaxed          int    `json:"total-relaxed"`
	Uuid                  string `json:"uuid"`
}
