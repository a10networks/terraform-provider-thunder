...
type DdosDstEntryPortRangeStats7 struct {
	Inst struct {
		...
		Stats DdosDstEntryPortRangeStats7Stats `json:"stats"`

		DstEntryName string
	} `json:"port-range"`
}

type DdosDstEntryPortRangeStats7Stats struct {
	SipTcpPort DdosDstEntryPortRangeStats7StatsSipTcpPort `json:"sip-tcp-port"`
}

type DdosDstEntryPortRangeStats7StatsSipTcpPort struct {
...
func (p *DdosDstEntryPortRangeStats7) GetId() string {
	return "1"
}

func (p *DdosDstEntryPortRangeStats7) getPath() string {
	return "ddos/dst/entry/" + p.Inst.DstEntryName + "/port-range/" + strconv.Itoa(p.Inst.PortRangeStart) + "+" + strconv.Itoa(p.Inst.PortRangeEnd) + "+" + p.Inst.Protocol + "/stats?sip-tcp-port=true"
}

func (p *DdosDstEntryPortRangeStats7) Post(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstEntryPortRangeStats7::Post")
...
func (p *DdosDstEntryPortRangeStats7) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstEntryPortRangeStats7::Get")
	headers := axapi.GenRequestHeader(authToken)
...
func (p *DdosDstEntryPortRangeStats7) Put(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstEntryPortRangeStats7::Put")
	headers := axapi.GenRequestHeader(authToken)
	payloadBytes, err := axapi.SerializeToJson(p)
	if err != nil {
		logger.Println("Failed to serialize struct as json", err)
...
func (p *DdosDstEntryPortRangeStats7) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstEntryPortRangeStats7::Delete")
	headers := axapi.GenRequestHeader(authToken)
