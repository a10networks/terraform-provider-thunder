...
type DdosDstZonePortZoneServiceStats37 struct {
	Inst struct {
		PortNum int `json:"port-num"`

		Protocol string `json:"protocol"`

		Stats DdosDstZonePortZoneServiceStats37Stats `json:"stats"`

		ZoneName string
	} `json:"zone-service"`
}

type DdosDstZonePortZoneServiceStats37Stats struct {
	SipTcpZonePort DdosDstZonePortZoneServiceStats37StatsSipTcpZonePort `json:"sip-tcp-zone-port"`
}

type DdosDstZonePortZoneServiceStats37StatsSipTcpZonePort struct {
...
func (p *DdosDstZonePortZoneServiceStats37) GetId() string {
	return "1"
}

func (p *DdosDstZonePortZoneServiceStats37) getPath() string {
	return "ddos/dst/zone/" + p.Inst.ZoneName + "/port/zone-service/" + strconv.Itoa(p.Inst.PortNum) + "+" + p.Inst.Protocol + "/stats?sip-tcp-zone-port=true"
}

func (p *DdosDstZonePortZoneServiceStats37) Post(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortZoneServiceStats37::Post")
...
func (p *DdosDstZonePortZoneServiceStats37) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortZoneServiceStats37::Get")
	headers := axapi.GenRequestHeader(authToken)
...
func (p *DdosDstZonePortZoneServiceStats37) Put(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortZoneServiceStats37::Put")
	headers := axapi.GenRequestHeader(authToken)
	payloadBytes, err := axapi.SerializeToJson(p)
	if err != nil {
		logger.Println("Failed to serialize struct as json", err)
...
func (p *DdosDstZonePortZoneServiceStats37) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortZoneServiceStats37::Delete")
	headers := axapi.GenRequestHeader(authToken)
