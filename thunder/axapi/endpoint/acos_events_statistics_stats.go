...
type AcosEventsStatisticsStatsStats struct {
	...
	Logd_stats_system_logs          int `json:"logd_stats_system_logs"`
	Logd_stats_system_logs_dropped  int `json:"logd_stats_system_logs_dropped"`
	Logd_stats_audit_logs           int `json:"logd_stats_audit_logs"`
	Logd_stats_audit_logs_dropped   int `json:"logd_stats_audit_logs_dropped"`
}
