...
type DdosDstZoneIpProtoProtoNameOper struct {
	IpFilteringPolicyStatistics DdosDstZoneIpProtoProtoNameOperIpFilteringPolicyStatistics `json:"ip-filtering-policy-statistics"`
	...
	SrcBasedPolicyList []DdosDstZoneIpProtoProtoNameOperSrcBasedPolicyList `json:"src-based-policy-list"`
...
type DdosDstZoneIpProtoProtoNameOperIpFilteringPolicyStatistics struct {
	Oper DdosDstZoneIpProtoProtoNameOperIpFilteringPolicyStatisticsOper `json:"oper"`
}

type DdosDstZoneIpProtoProtoNameOperIpFilteringPolicyStatisticsOper struct {
	RuleList []DdosDstZoneIpProtoProtoNameOperIpFilteringPolicyStatisticsOperRuleList `json:"rule-list"`
}

type DdosDstZoneIpProtoProtoNameOperIpFilteringPolicyStatisticsOperRuleList struct {
	Seq                   int `json:"seq"`
	Hits                  int `json:"hits"`
...
type DdosDstZoneIpProtoProtoNameOperSrcBasedPolicyList struct {
	SrcBasedPolicyName  string                                                                 `json:"src-based-policy-name"`
	Oper                DdosDstZoneIpProtoProtoNameOperSrcBasedPolicyListOper                  `json:"oper"`
	PolicyClassListList []DdosDstZoneIpProtoProtoNameOperSrcBasedPolicyListPolicyClassListList `json:"policy-class-list-list"`
}

type DdosDstZoneIpProtoProtoNameOperSrcBasedPolicyListOper struct {
}

type DdosDstZoneIpProtoProtoNameOperSrcBasedPolicyListPolicyClassListList struct {
	ClassListName string                                                                   `json:"class-list-name"`
	Oper          DdosDstZoneIpProtoProtoNameOperSrcBasedPolicyListPolicyClassListListOper `json:"oper"`
}

type DdosDstZoneIpProtoProtoNameOperSrcBasedPolicyListPolicyClassListListOper struct {
