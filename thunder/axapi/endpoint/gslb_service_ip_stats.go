...
type GslbServiceIpStats struct {
	...
	ServiceList []GslbServiceIpStatsServiceList `json:"service-list"`
...
type GslbServiceIpStatsServiceList struct {
	PortNum   int                                `json:"port-num"`
	PortProto string                             `json:"port-proto"`
	Label     string                             `json:"label"`
	Stats     GslbServiceIpStatsServiceListStats `json:"stats"`
}

type GslbServiceIpStatsServiceListStats struct {
	Active  int `json:"active"`
	Current int `json:"current"`
}
