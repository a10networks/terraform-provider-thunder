...
type DdosDstZonePortZoneServiceStats struct {
	Inst struct {
		PortNum int `json:"port-num"`

		Protocol string `json:"protocol"`

		Stats DdosDstZonePortZoneServiceStatsStats `json:"stats"`

		ZoneName string
	} `json:"zone-service"`
}

type DdosDstZonePortZoneServiceStatsStats struct {
	DnsTcpZonePort DdosDstZonePortZoneServiceStatsStatsDnsTcpZonePort `json:"dns-tcp-zone-port"`
}

type DdosDstZonePortZoneServiceStatsStatsDnsTcpZonePort struct {
...
func (p *DdosDstZonePortZoneServiceStats) GetId() string {
	return "1"
}

func (p *DdosDstZonePortZoneServiceStats) getPath() string {
	return "ddos/dst/zone/" + p.Inst.ZoneName + "/port/zone-service/" + strconv.Itoa(p.Inst.PortNum) + "+" + p.Inst.Protocol + "/stats?dns-tcp-zone-port=true"
}

func (p *DdosDstZonePortZoneServiceStats) Post(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortZoneServiceStats::Post")
...
func (p *DdosDstZonePortZoneServiceStats) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortZoneServiceStats::Get")
	headers := axapi.GenRequestHeader(authToken)
...
func (p *DdosDstZonePortZoneServiceStats) Put(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortZoneServiceStats::Put")
	headers := axapi.GenRequestHeader(authToken)
	payloadBytes, err := axapi.SerializeToJson(p)
	if err != nil {
		logger.Println("Failed to serialize struct as json", err)
...
func (p *DdosDstZonePortZoneServiceStats) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortZoneServiceStats::Delete")
	headers := axapi.GenRequestHeader(authToken)
