...
type DdosDstEntryPortRangeStats6 struct {
	Inst struct {
		...
		Stats DdosDstEntryPortRangeStats6Stats `json:"stats"`

		DstEntryName string
	} `json:"port-range"`
}

type DdosDstEntryPortRangeStats6Stats struct {
	L4SslPort DdosDstEntryPortRangeStats6StatsL4SslPort `json:"l4-ssl-port"`
}

type DdosDstEntryPortRangeStats6StatsL4SslPort struct {
...
func (p *DdosDstEntryPortRangeStats6) GetId() string {
	return "1"
}

func (p *DdosDstEntryPortRangeStats6) getPath() string {
	return "ddos/dst/entry/" + p.Inst.DstEntryName + "/port-range/" + strconv.Itoa(p.Inst.PortRangeStart) + "+" + strconv.Itoa(p.Inst.PortRangeEnd) + "+" + p.Inst.Protocol + "/stats?l4-ssl-port=true"
}

func (p *DdosDstEntryPortRangeStats6) Post(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstEntryPortRangeStats6::Post")
...
func (p *DdosDstEntryPortRangeStats6) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstEntryPortRangeStats6::Get")
	headers := axapi.GenRequestHeader(authToken)
...
func (p *DdosDstEntryPortRangeStats6) Put(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstEntryPortRangeStats6::Put")
	headers := axapi.GenRequestHeader(authToken)
	payloadBytes, err := axapi.SerializeToJson(p)
	if err != nil {
		logger.Println("Failed to serialize struct as json", err)
...
func (p *DdosDstEntryPortRangeStats6) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstEntryPortRangeStats6::Delete")
	headers := axapi.GenRequestHeader(authToken)
