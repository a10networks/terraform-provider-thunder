...
type DdosDstZonePortRangeStats28 struct {
	Inst struct {
		...
		Stats DdosDstZonePortRangeStats28Stats `json:"stats"`

		ZoneName string
	} `json:"port-range"`
}

type DdosDstZonePortRangeStats28Stats struct {
	SipTcpZonePort DdosDstZonePortRangeStats28StatsSipTcpZonePort `json:"sip-tcp-zone-port"`
}

type DdosDstZonePortRangeStats28StatsSipTcpZonePort struct {
...
func (p *DdosDstZonePortRangeStats28) GetId() string {
	return "1"
}

func (p *DdosDstZonePortRangeStats28) getPath() string {
	return "ddos/dst/zone/" + p.Inst.ZoneName + "/port-range/" + strconv.Itoa(p.Inst.PortRangeStart) + "+" + strconv.Itoa(p.Inst.PortRangeEnd) + "+" + p.Inst.Protocol + "/stats?sip-tcp-zone-port=true"
}

func (p *DdosDstZonePortRangeStats28) Post(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortRangeStats28::Post")
...
func (p *DdosDstZonePortRangeStats28) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortRangeStats28::Get")
	headers := axapi.GenRequestHeader(authToken)
...
func (p *DdosDstZonePortRangeStats28) Put(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortRangeStats28::Put")
	headers := axapi.GenRequestHeader(authToken)
	payloadBytes, err := axapi.SerializeToJson(p)
	if err != nil {
		logger.Println("Failed to serialize struct as json", err)
...
func (p *DdosDstZonePortRangeStats28) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortRangeStats28::Delete")
	headers := axapi.GenRequestHeader(authToken)
