...
type DdosDstZonePortRangeStats25 struct {
	Inst struct {
		...
		Stats DdosDstZonePortRangeStats25Stats `json:"stats"`

		ZoneName string
	} `json:"port-range"`
}

type DdosDstZonePortRangeStats25Stats struct {
	HttpZonePort DdosDstZonePortRangeStats25StatsHttpZonePort `json:"http-zone-port"`
}

type DdosDstZonePortRangeStats25StatsHttpZonePort struct {
...
func (p *DdosDstZonePortRangeStats25) GetId() string {
	return "1"
}

func (p *DdosDstZonePortRangeStats25) getPath() string {
	return "ddos/dst/zone/" + p.Inst.ZoneName + "/port-range/" + strconv.Itoa(p.Inst.PortRangeStart) + "+" + strconv.Itoa(p.Inst.PortRangeEnd) + "+" + p.Inst.Protocol + "/stats?http-zone-port=true"
}

func (p *DdosDstZonePortRangeStats25) Post(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortRangeStats25::Post")
...
func (p *DdosDstZonePortRangeStats25) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortRangeStats25::Get")
	headers := axapi.GenRequestHeader(authToken)
...
func (p *DdosDstZonePortRangeStats25) Put(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortRangeStats25::Put")
	headers := axapi.GenRequestHeader(authToken)
	payloadBytes, err := axapi.SerializeToJson(p)
	if err != nil {
		logger.Println("Failed to serialize struct as json", err)
...
func (p *DdosDstZonePortRangeStats25) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortRangeStats25::Delete")
	headers := axapi.GenRequestHeader(authToken)
