...
type DdosDstZoneSrcPortZoneSrcPortStats43 struct {
	Inst struct {
		PortNum int `json:"port-num"`

		Protocol string `json:"protocol"`

		Stats DdosDstZoneSrcPortZoneSrcPortStats43Stats `json:"stats"`

		ZoneName string
	} `json:"zone-src-port"`
}

type DdosDstZoneSrcPortZoneSrcPortStats43Stats struct {
	DnsUdpZonePort DdosDstZoneSrcPortZoneSrcPortStats43StatsDnsUdpZonePort `json:"dns-udp-zone-port"`
}

type DdosDstZoneSrcPortZoneSrcPortStats43StatsDnsUdpZonePort struct {
...
func (p *DdosDstZoneSrcPortZoneSrcPortStats43) GetId() string {
	return "1"
}

func (p *DdosDstZoneSrcPortZoneSrcPortStats43) getPath() string {
	return "ddos/dst/zone/" + p.Inst.ZoneName + "/src-port/zone-src-port/" + strconv.Itoa(p.Inst.PortNum) + "+" + p.Inst.Protocol + "/stats?dns-udp-zone-port=true"
}

func (p *DdosDstZoneSrcPortZoneSrcPortStats43) Post(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZoneSrcPortZoneSrcPortStats43::Post")
...
func (p *DdosDstZoneSrcPortZoneSrcPortStats43) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZoneSrcPortZoneSrcPortStats43::Get")
	headers := axapi.GenRequestHeader(authToken)
...
func (p *DdosDstZoneSrcPortZoneSrcPortStats43) Put(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZoneSrcPortZoneSrcPortStats43::Put")
	headers := axapi.GenRequestHeader(authToken)
	payloadBytes, err := axapi.SerializeToJson(p)
	if err != nil {
		logger.Println("Failed to serialize struct as json", err)
...
func (p *DdosDstZoneSrcPortZoneSrcPortStats43) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZoneSrcPortZoneSrcPortStats43::Delete")
	headers := axapi.GenRequestHeader(authToken)
