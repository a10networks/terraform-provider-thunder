...
type RuleSetRuleOperOper struct {
	...
	Syncookieon        int    `json:"syncookieon"`
	Synacksent         int    `json:"synacksent"`
	Verificationpassed int    `json:"verificationpassed"`
	Verificationfailed int    `json:"verificationfailed"`
	Tcphalfopencount   int    `json:"tcphalfopencount"`
}
...
func (p *RuleSetRuleOper) getPath() string {
	...
	return "rule-set/" + p.Rule_set_name + "/rule/" + p.Name + "/oper"
}
