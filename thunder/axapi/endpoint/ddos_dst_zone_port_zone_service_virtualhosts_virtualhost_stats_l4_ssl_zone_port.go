...
type DdosDstZonePortZoneServiceVirtualhostsVirtualhostStatsStats struct {
	L4SslZonePort DdosDstZonePortZoneServiceVirtualhostsVirtualhostStatsStatsL4SslZonePort `json:"l4-ssl-zone-port"`
}

type DdosDstZonePortZoneServiceVirtualhostsVirtualhostStatsStatsL4SslZonePort struct {
...
func (p *DdosDstZonePortZoneServiceVirtualhostsVirtualhostStats) getPath() string {
	return "ddos/dst/zone/" + p.Inst.ZoneName + "/port/zone-service/" + p.Inst.PortNum + "+" + p.Inst.Protocol + "/virtualhosts/virtualhost/" + p.Inst.Vhost + "/stats?l4-ssl-zone-port=true"
}

func (p *DdosDstZonePortZoneServiceVirtualhostsVirtualhostStats) Post(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortZoneServiceVirtualhostsVirtualhostStats::Post")
...
func (p *DdosDstZonePortZoneServiceVirtualhostsVirtualhostStats) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortZoneServiceVirtualhostsVirtualhostStats::Get")
	headers := axapi.GenRequestHeader(authToken)
...
func (p *DdosDstZonePortZoneServiceVirtualhostsVirtualhostStats) Put(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortZoneServiceVirtualhostsVirtualhostStats::Put")
	headers := axapi.GenRequestHeader(authToken)
	payloadBytes, err := axapi.SerializeToJson(p)
	if err != nil {
		logger.Println("Failed to serialize struct as json", err)
...
func (p *DdosDstZonePortZoneServiceVirtualhostsVirtualhostStats) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortZoneServiceVirtualhostsVirtualhostStats::Delete")
	headers := axapi.GenRequestHeader(authToken)
