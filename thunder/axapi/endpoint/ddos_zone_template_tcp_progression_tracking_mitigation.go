...
type DdosZoneTemplateTcpProgressionTrackingMitigation struct {
	Inst struct {
		ConnectionTracking DdosZoneTemplateTcpProgressionTrackingMitigationConnectionTracking374 `json:"connection-tracking"`

		RequestTracking DdosZoneTemplateTcpProgressionTrackingMitigationRequestTracking375 `json:"request-tracking"`

		SlowAttack DdosZoneTemplateTcpProgressionTrackingMitigationSlowAttack376 `json:"slow-attack"`

		TimeWindowTracking DdosZoneTemplateTcpProgressionTrackingMitigationTimeWindowTracking378 `json:"time-window-tracking"`

		Tcp_name string
	} `json:"mitigation"`
}

type DdosZoneTemplateTcpProgressionTrackingMitigationConnectionTracking374 struct {
...
type DdosZoneTemplateTcpProgressionTrackingMitigationRequestTracking375 struct {
...
type DdosZoneTemplateTcpProgressionTrackingMitigationSlowAttack376 struct {
	...
	Uuid                                  string                                                                                  `json:"uuid"`
	SlowAttackerIdentification            DdosZoneTemplateTcpProgressionTrackingMitigationSlowAttackSlowAttackerIdentification377 `json:"slow-attacker-identification"`
}

type DdosZoneTemplateTcpProgressionTrackingMitigationSlowAttackSlowAttackerIdentification377 struct {
...
type DdosZoneTemplateTcpProgressionTrackingMitigationTimeWindowTracking378 struct {
...
func (p *DdosZoneTemplateTcpProgressionTrackingMitigation) GetId() string {
	return "1"
}

func (p *DdosZoneTemplateTcpProgressionTrackingMitigation) getPath() string {
	return "ddos/zone-template/tcp/" + p.Inst.Tcp_name + "/progression-tracking/mitigation"
}

func (p *DdosZoneTemplateTcpProgressionTrackingMitigation) Post(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosZoneTemplateTcpProgressionTrackingMitigation::Post")
...
func (p *DdosZoneTemplateTcpProgressionTrackingMitigation) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosZoneTemplateTcpProgressionTrackingMitigation::Get")
	headers := axapi.GenRequestHeader(authToken)
...
func (p *DdosZoneTemplateTcpProgressionTrackingMitigation) Put(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosZoneTemplateTcpProgressionTrackingMitigation::Put")
	headers := axapi.GenRequestHeader(authToken)
	payloadBytes, err := axapi.SerializeToJson(p)
	if err != nil {
		logger.Println("Failed to serialize struct as json", err)
...
func (p *DdosZoneTemplateTcpProgressionTrackingMitigation) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosZoneTemplateTcpProgressionTrackingMitigation::Delete")
	headers := axapi.GenRequestHeader(authToken)
