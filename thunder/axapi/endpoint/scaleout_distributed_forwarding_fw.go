...
type ScaleoutDistributedForwardingFwThreshold struct {
	ProtocolThreshold []ScaleoutDistributedForwardingFwThresholdProtocolThreshold `json:"protocol-threshold"`
	GlobalThreshold   int                                                         `json:"global-threshold" dval:"5"`
}

type ScaleoutDistributedForwardingFwThresholdProtocolThreshold struct {
