...
type DdosDstEntryPortStats16 struct {
	Inst struct {
		PortNum int `json:"port-num"`

		Protocol string `json:"protocol"`

		Stats DdosDstEntryPortStats16Stats `json:"stats"`

		DstEntryName string
	} `json:"port"`
}

type DdosDstEntryPortStats16Stats struct {
	TcpPort DdosDstEntryPortStats16StatsTcpPort `json:"tcp-port"`
}

type DdosDstEntryPortStats16StatsTcpPort struct {
...
func (p *DdosDstEntryPortStats16) GetId() string {
	return "1"
}

func (p *DdosDstEntryPortStats16) getPath() string {
	return "ddos/dst/entry/" + p.Inst.DstEntryName + "/port/" + strconv.Itoa(p.Inst.PortNum) + "+" + p.Inst.Protocol + "/stats?tcp-port=true"
}

func (p *DdosDstEntryPortStats16) Post(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstEntryPortStats16::Post")
...
func (p *DdosDstEntryPortStats16) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstEntryPortStats16::Get")
	headers := axapi.GenRequestHeader(authToken)
...
func (p *DdosDstEntryPortStats16) Put(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstEntryPortStats16::Put")
	headers := axapi.GenRequestHeader(authToken)
	payloadBytes, err := axapi.SerializeToJson(p)
	if err != nil {
		logger.Println("Failed to serialize struct as json", err)
...
func (p *DdosDstEntryPortStats16) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstEntryPortStats16::Delete")
	headers := axapi.GenRequestHeader(authToken)
