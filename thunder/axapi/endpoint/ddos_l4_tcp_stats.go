...
type DdosL4TcpStatsStats struct {
	...
	Hybrid_syn_auth_unknown_pass           int `json:"hybrid_syn_auth_unknown_pass"`
	Hybrid_syn_auth_unknown_fail           int `json:"hybrid_syn_auth_unknown_fail"`
	Hybrid_syn_auth_valid_sa_sent          int `json:"hybrid_syn_auth_valid_sa_sent"`
	Hybrid_syn_auth_invalid_sa_sent        int `json:"hybrid_syn_auth_invalid_sa_sent"`
	Hybrid_syn_auth_filter_full            int `json:"hybrid_syn_auth_filter_full"`
	Hybrid_syn_auth_lookup_fail            int `json:"hybrid_syn_auth_lookup_fail"`
	Hybrid_syn_auth_invalid_pass           int `json:"hybrid_syn_auth_invalid_pass"`
	Hybrid_syn_auth_valid_pass             int `json:"hybrid_syn_auth_valid_pass"`
	Hybrid_syn_auth_invalid_fail           int `json:"hybrid_syn_auth_invalid_fail"`
	Hybrid_syn_auth_valid_fail             int `json:"hybrid_syn_auth_valid_fail"`
	Tcp_invalid_synack_rcvd                int `json:"tcp_invalid_synack_rcvd"`
	Hybrid_syn_auth_method_change          int `json:"hybrid_syn_auth_method_change"`
	Tcp_small_window                       int `json:"tcp_small_window"`
	Tcp_small_window_bl                    int `json:"tcp_small_window_bl"`
	Tcp_small_window_drop                  int `json:"tcp_small_window_drop"`
	Hybrid_syn_auth_entry_aged_out         int `json:"hybrid_syn_auth_entry_aged_out"`
	Hybrid_syn_auth_auth_no_match          int `json:"hybrid_syn_auth_auth_no_match"`
}
