...
type DdosNotificationTemplate struct {
	Inst struct {
		Api DdosNotificationTemplateApi324 `json:"api"`
...
type DdosNotificationTemplateApi324 struct {
	...
	Uuid                  string                                       `json:"uuid"`
	Authentication        DdosNotificationTemplateApiAuthentication325 `json:"authentication"`
}

type DdosNotificationTemplateApiAuthentication325 struct {
