...
type DdosNotificationTemplateApi struct {
	Inst struct {
		Authentication DdosNotificationTemplateApiAuthentication323 `json:"authentication"`
...
type DdosNotificationTemplateApiAuthentication323 struct {
...
func (p *DdosNotificationTemplateApi) getPath() string {
	return "ddos/notification-template/" + p.Inst.Notification_template_name + "/api"
}
