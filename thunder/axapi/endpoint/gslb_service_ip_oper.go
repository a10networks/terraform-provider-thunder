...
type GslbServiceIpOper struct {
	...
	ServiceList []GslbServiceIpOperServiceList `json:"service-list"`
}
...
type GslbServiceIpOperServiceList struct {
	PortNum   int                              `json:"port-num"`
	PortProto string                           `json:"port-proto"`
	Label     string                           `json:"label"`
	Oper      GslbServiceIpOperServiceListOper `json:"oper"`
}

type GslbServiceIpOperServiceListOper struct {
	ServicePort         int    `json:"service-port"`
	State               string `json:"state"`
	Disabled            int    `json:"disabled"`
	GslbProtocol        int    `json:"gslb-protocol"`
