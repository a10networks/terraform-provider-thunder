...
type DdosTemplateSslL4 struct {
	Inst struct {
		...
		SslHandshakePolicy DdosTemplateSslL4SslHandshakePolicy339 `json:"ssl-handshake-policy"`

		SslL4TmplName string `json:"ssl-l4-tmpl-name"`

		SslTrafficCheck DdosTemplateSslL4SslTrafficCheck340 `json:"ssl-traffic-check"`
...
type DdosTemplateSslL4SslHandshakePolicy339 struct {
...
type DdosTemplateSslL4SslTrafficCheck340 struct {
