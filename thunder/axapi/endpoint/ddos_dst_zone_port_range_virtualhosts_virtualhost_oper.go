...
type DdosDstZonePortRangeVirtualhostsVirtualhostOper struct {
	Oper DdosDstZonePortRangeVirtualhostsVirtualhostOperOper `json:"oper"`
...
type DataDdosDstZonePortRangeVirtualhostsVirtualhostOper struct {
	DtDdosDstZonePortRangeVirtualhostsVirtualhostOper DdosDstZonePortRangeVirtualhostsVirtualhostOper `json:"virtualhost"`
}

type DdosDstZonePortRangeVirtualhostsVirtualhostOperOper struct {
	Ddos_entry_list       []DdosDstZonePortRangeVirtualhostsVirtualhostOperOperDdos_entry_list `json:"ddos_entry_list"`
...
type DdosDstZonePortRangeVirtualhostsVirtualhostOperOperDdos_entry_list struct {
	...
	HttpFilterRates        []DdosDstZonePortRangeVirtualhostsVirtualhostOperOperDdos_entry_listHttpFilterRates   `json:"http-filter-rates"`
	ResponseSizeRates      []DdosDstZonePortRangeVirtualhostsVirtualhostOperOperDdos_entry_listResponseSizeRates `json:"response-size-rates"`
	DebugStr               string                                                                                `json:"debug-str"`
}

type DdosDstZonePortRangeVirtualhostsVirtualhostOperOperDdos_entry_listHttpFilterRates struct {
...
type DdosDstZonePortRangeVirtualhostsVirtualhostOperOperDdos_entry_listResponseSizeRates struct {
...
func (p *DdosDstZonePortRangeVirtualhostsVirtualhostOper) GetId() string {
	return "1"
}

func (p *DdosDstZonePortRangeVirtualhostsVirtualhostOper) getPath() string {

	return "ddos/dst/zone/" + p.ZoneName + "/port-range/" + p.PortRangeStart + "+" + p.PortRangeEnd + "+" + p.Protocol + "/virtualhosts/virtualhost/" + p.Vhost + "/oper"
}

func (p *DdosDstZonePortRangeVirtualhostsVirtualhostOper) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) (DataDdosDstZonePortRangeVirtualhostsVirtualhostOper, error) {
	logger.Println("DdosDstZonePortRangeVirtualhostsVirtualhostOper::Get")
	headers := axapi.GenRequestHeader(authToken)
	_, axResp, err := axapi.SendGet(host, p.getPath(), "", nil, headers, logger)
	var payload DataDdosDstZonePortRangeVirtualhostsVirtualhostOper
	if err == nil {
		if len(axResp) > 0 {
