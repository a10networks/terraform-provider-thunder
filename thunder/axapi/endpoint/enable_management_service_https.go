...
type EnableManagementServiceHttps struct {
	Inst struct {
		...
		LifCfg EnableManagementServiceHttpsLifCfg `json:"lif-cfg"`
...
type EnableManagementServiceHttpsAclV4List struct {
	...
	LifCfg      EnableManagementServiceHttpsAclV4ListLifCfg      `json:"lif-cfg"`
...
type EnableManagementServiceHttpsAclV4ListLifCfg struct {
	Lif string `json:"lif"`
}
...
type EnableManagementServiceHttpsAclV6List struct {
	...
	LifCfg      EnableManagementServiceHttpsAclV6ListLifCfg      `json:"lif-cfg"`
	Management  int                                              `json:"management"`
	AllDataIntf int                                              `json:"all-data-intf"`
	Uuid        string                                           `json:"uuid"`
	UserTag     string                                           `json:"user-tag"`
...
type EnableManagementServiceHttpsAclV6ListLifCfg struct {
	Lif string `json:"lif"`
}
...
type EnableManagementServiceHttpsLifCfg struct {
	Lif string `json:"lif"`
}
