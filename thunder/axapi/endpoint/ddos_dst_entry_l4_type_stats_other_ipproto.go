...
type DdosDstEntryL4TypeStats1 struct {
	Inst struct {

    Protocol string `json:"protocol"`
    Stats DdosDstEntryL4TypeStats1Stats `json:"stats"`
    DstEntryName string 
...
type DdosDstEntryL4TypeStats1Stats struct {
    OtherIpproto DdosDstEntryL4TypeStats1StatsOtherIpproto `json:"other-ipproto"`
}


type DdosDstEntryL4TypeStats1StatsOtherIpproto struct {
...
func (p *DdosDstEntryL4TypeStats1) GetId() string{
    return "1"
}

func (p *DdosDstEntryL4TypeStats1) getPath() string{
    return "ddos/dst/entry/" +p.Inst.DstEntryName + "/l4-type/"+p.Inst.Protocol+"/stats?other-ipproto=true"
}

func (p *DdosDstEntryL4TypeStats1) Post(authToken string, host string, logger *axapi.ThunderLog) error {
    logger.Println("DdosDstEntryL4TypeStats1::Post")
...
func (p *DdosDstEntryL4TypeStats1) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
    logger.Println("DdosDstEntryL4TypeStats1::Get")
    headers := axapi.GenRequestHeader(authToken)
...
func (p *DdosDstEntryL4TypeStats1) Put(authToken string, host string, logger *axapi.ThunderLog) error {
    logger.Println("DdosDstEntryL4TypeStats1::Put")
    headers := axapi.GenRequestHeader(authToken)
    payloadBytes, err := axapi.SerializeToJson(p)
    if err != nil {
        logger.Println("Failed to serialize struct as json", err)
...
func (p *DdosDstEntryL4TypeStats1) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
    logger.Println("DdosDstEntryL4TypeStats1::Delete")
    headers := axapi.GenRequestHeader(authToken)
