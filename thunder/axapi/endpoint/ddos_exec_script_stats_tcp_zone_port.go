...
type DdosExecScriptStats struct {
	Inst struct {
		Stats DdosExecScriptStatsStats `json:"stats"`
	} `json:"exec-script"`
}

type DdosExecScriptStatsStats struct {
	TcpZonePort DdosExecScriptStatsStatsTcpZonePort `json:"tcp-zone-port"`
}

type DdosExecScriptStatsStatsTcpZonePort struct {
...
func (p *DdosExecScriptStats) GetId() string {
	return "1"
}

func (p *DdosExecScriptStats) getPath() string {
	return "ddos/exec-script/stats?tcp-zone-port=true"
}

func (p *DdosExecScriptStats) Post(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosExecScriptStats::Post")
...
func (p *DdosExecScriptStats) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosExecScriptStats::Get")
	headers := axapi.GenRequestHeader(authToken)
...
func (p *DdosExecScriptStats) Put(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosExecScriptStats::Put")
	headers := axapi.GenRequestHeader(authToken)
	payloadBytes, err := axapi.SerializeToJson(p)
	if err != nil {
		logger.Println("Failed to serialize struct as json", err)
...
func (p *DdosExecScriptStats) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosExecScriptStats::Delete")
	headers := axapi.GenRequestHeader(authToken)
