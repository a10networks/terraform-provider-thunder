...
type DdosDstEntryPortStats11 struct {
	Inst struct {
		...
		Stats DdosDstEntryPortStats11Stats `json:"stats"`

		DstEntryName string
	} `json:"port"`
}

type DdosDstEntryPortStats11Stats struct {
	DnsUdpPort DdosDstEntryPortStats11StatsDnsUdpPort `json:"dns-udp-port"`
}

type DdosDstEntryPortStats11StatsDnsUdpPort struct {
...
func (p *DdosDstEntryPortStats11) getPath() string {
	return "ddos/dst/entry/" + p.Inst.DstEntryName + "/port/" + strconv.Itoa(p.Inst.PortNum) + "+" + p.Inst.Protocol + "/stats?dns-udp-port=true"
}

func (p *DdosDstEntryPortStats11) Post(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstEntryPortStats11::Post")
...
func (p *DdosDstEntryPortStats11) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstEntryPortStats11::Get")
	headers := axapi.GenRequestHeader(authToken)
...
func (p *DdosDstEntryPortStats11) Put(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstEntryPortStats11::Put")
	headers := axapi.GenRequestHeader(authToken)
	payloadBytes, err := axapi.SerializeToJson(p)
	if err != nil {
		logger.Println("Failed to serialize struct as json", err)
...
func (p *DdosDstEntryPortStats11) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstEntryPortStats11::Delete")
	headers := axapi.GenRequestHeader(authToken)
