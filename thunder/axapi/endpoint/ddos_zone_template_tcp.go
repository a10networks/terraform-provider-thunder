...
type DdosZoneTemplateTcp struct {
	Inst struct {
		...
		AgeOutResetServer int `json:"age-out-reset-server"`

		AgeSecond int `json:"age-second" dval:"120"`
		...
		NoConnRstRate int `json:"no-conn-rst-rate"`
		...
		SmallWinCfg DdosZoneTemplateTcpSmallWinCfg `json:"small-win-cfg"`
		...
		TcpHalfOpenTimeout int `json:"tcp-half-open-timeout" dval:"120"`

		TcpHalfOpenTimeoutResetServer int `json:"tcp-half-open-timeout-reset-server"`
...
type DdosZoneTemplateTcpSmallWinCfg struct {
	SmallWindow               int    `json:"small-window"`
	SmallWindowThreshold      int    `json:"small-window-threshold"`
	SmallWindowActionListName string `json:"small-window-action-list-name"`
	SmallWindowAction         string `json:"small-window-action" dval:"drop"`
}
