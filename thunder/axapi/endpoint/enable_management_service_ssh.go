...
type EnableManagementServiceSsh struct {
	Inst struct {
		...
		LifCfg EnableManagementServiceSshLifCfg `json:"lif-cfg"`
...
type EnableManagementServiceSshAclV4List struct {
	...
	LifCfg      EnableManagementServiceSshAclV4ListLifCfg      `json:"lif-cfg"`
...
type EnableManagementServiceSshAclV4ListLifCfg struct {
	Lif string `json:"lif"`
}
...
type EnableManagementServiceSshAclV6List struct {
	...
	LifCfg      EnableManagementServiceSshAclV6ListLifCfg      `json:"lif-cfg"`
	Management  int                                            `json:"management"`
	AllDataIntf int                                            `json:"all-data-intf"`
	Uuid        string                                         `json:"uuid"`
	UserTag     string                                         `json:"user-tag"`
...
type EnableManagementServiceSshAclV6ListLifCfg struct {
	Lif string `json:"lif"`
}
...
type EnableManagementServiceSshLifCfg struct {
	Lif string `json:"lif"`
}
