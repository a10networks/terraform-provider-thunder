...
type DdosDstEntryPortStats13 struct {
	Inst struct {
		PortNum int `json:"port-num"`

		Protocol string `json:"protocol"`

		Stats DdosDstEntryPortStats13Stats `json:"stats"`

		DstEntryName string
	} `json:"port"`
}

type DdosDstEntryPortStats13Stats struct {
	L4SslPort DdosDstEntryPortStats13StatsL4SslPort `json:"l4-ssl-port"`
}

type DdosDstEntryPortStats13StatsL4SslPort struct {
...
func (p *DdosDstEntryPortStats13) GetId() string {
	return "1"
}

func (p *DdosDstEntryPortStats13) getPath() string {
	return "ddos/dst/entry/" + p.Inst.DstEntryName + "/port/" + strconv.Itoa(p.Inst.PortNum) + "+" + p.Inst.Protocol + "/stats?l4-ssl-port=true"
}

func (p *DdosDstEntryPortStats13) Post(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstEntryPortStats13::Post")
...
func (p *DdosDstEntryPortStats13) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstEntryPortStats13::Get")
	headers := axapi.GenRequestHeader(authToken)
...
func (p *DdosDstEntryPortStats13) Put(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstEntryPortStats13::Put")
	headers := axapi.GenRequestHeader(authToken)
	payloadBytes, err := axapi.SerializeToJson(p)
	if err != nil {
		logger.Println("Failed to serialize struct as json", err)
...
func (p *DdosDstEntryPortStats13) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstEntryPortStats13::Delete")
	headers := axapi.GenRequestHeader(authToken)
