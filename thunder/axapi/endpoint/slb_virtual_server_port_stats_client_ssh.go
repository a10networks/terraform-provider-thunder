...
type SlbVirtualServerPortStats49Stats struct {
	ClientSsh SlbVirtualServerPortStats49StatsClientSsh `json:"client-ssh"`
}

type SlbVirtualServerPortStats49StatsClientSsh struct {
...
func (p *SlbVirtualServerPortStats49) getPath() string {
	return "slb/virtual-server/" + p.Inst.Virtual_server_name + "/port/" + strconv.Itoa(p.Inst.PortNumber) + "+" + p.Inst.Protocol + "/stats?client-ssh=true"
}
