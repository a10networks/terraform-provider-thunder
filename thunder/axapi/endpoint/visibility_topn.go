...
type VisibilityTopn struct {
    ...
    Cgnv6NatPoolTopnNode VisibilityTopnCgnv6NatPoolTopnNode3134 `json:"cgnv6-nat-pool-topn-node"`
    Cgnv6NatPoolTopnTmplList []VisibilityTopnCgnv6NatPoolTopnTmplList `json:"cgnv6-nat-pool-topn-tmpl-list"`
    GtpApnPrefixTopnNode VisibilityTopnGtpApnPrefixTopnNode3135 `json:"gtp-apn-prefix-topn-node"`
    GtpApnPrefixTopnTmplList []VisibilityTopnGtpApnPrefixTopnTmplList `json:"gtp-apn-prefix-topn-tmpl-list"`
    GtpNetworkElementTopnNode VisibilityTopnGtpNetworkElementTopnNode3136 `json:"gtp-network-element-topn-node"`
...
type VisibilityTopnCgnv6NatPoolTopnNode3134 struct {
    Activate string `json:"activate"`
    Uuid string `json:"uuid"`
}


type VisibilityTopnCgnv6NatPoolTopnTmplList struct {
    Name string `json:"name"`
    TopnSize int `json:"topn-size"`
    Interval string `json:"interval"`
    Uuid string `json:"uuid"`
    UserTag string `json:"user-tag"`
    Metrics VisibilityTopnCgnv6NatPoolTopnTmplListMetrics `json:"metrics"`
}


type VisibilityTopnCgnv6NatPoolTopnTmplListMetrics struct {
...
type VisibilityTopnGtpApnPrefixTopnNode3135 struct {
    Activate string `json:"activate"`
    Uuid string `json:"uuid"`
}


type VisibilityTopnGtpApnPrefixTopnTmplList struct {
    Name string `json:"name"`
    TopnSize int `json:"topn-size"`
    Interval string `json:"interval"`
    Uuid string `json:"uuid"`
    UserTag string `json:"user-tag"`
    Metrics VisibilityTopnGtpApnPrefixTopnTmplListMetrics `json:"metrics"`
}


type VisibilityTopnGtpApnPrefixTopnTmplListMetrics struct {
...
type VisibilityTopnGtpNetworkElementTopnNode3136 struct {
    Activate string `json:"activate"`
    Uuid string `json:"uuid"`
}


type VisibilityTopnGtpNetworkElementTopnTmplList struct {
    Name string `json:"name"`
    TopnSize int `json:"topn-size"`
    Interval string `json:"interval"`
    Uuid string `json:"uuid"`
    UserTag string `json:"user-tag"`
    Metrics VisibilityTopnGtpNetworkElementTopnTmplListMetrics `json:"metrics"`
}


type VisibilityTopnGtpNetworkElementTopnTmplListMetrics struct {
    UplinkBytes int `json:"uplink-bytes"`
    DownlinkBytes int `json:"downlink-bytes"`
    UplinkPkts int `json:"uplink-pkts"`
    DownlinkPkts int `json:"downlink-pkts"`
...
type VisibilityTopnSamplingEnable struct {
    Counters1 string `json:"counters1"`
}

func (p *VisibilityTopn) GetId() string{
    return "1"
}

func (p *VisibilityTopn) getPath() string{
    return "visibility/topn"
}

func (p *VisibilityTopn) Post(authToken string, host string, logger *axapi.ThunderLog) error {
    logger.Println("VisibilityTopn::Post")
...
func (p *VisibilityTopn) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
    logger.Println("VisibilityTopn::Get")
    headers := axapi.GenRequestHeader(authToken)
...
func (p *VisibilityTopn) Put(authToken string, host string, logger *axapi.ThunderLog) error {
    logger.Println("VisibilityTopn::Put")
    headers := axapi.GenRequestHeader(authToken)
    payloadBytes, err := axapi.SerializeToJson(p)
    if err != nil {
        logger.Println("Failed to serialize struct as json", err)
...
func (p *VisibilityTopn) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
    logger.Println("VisibilityTopn::Delete")
    headers := axapi.GenRequestHeader(authToken)
