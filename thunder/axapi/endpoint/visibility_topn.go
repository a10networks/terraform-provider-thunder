...
type VisibilityTopnTemplGtpPlcyTopnTmplList struct {
	Name     string                                        `json:"name"`
	TopnSize int                                           `json:"topn-size"`
	Interval string                                        `json:"interval"`
	Uuid     string                                        `json:"uuid"`
	UserTag  string                                        `json:"user-tag"`
	Metrics  VisibilityTopnTemplGtpPlcyTopnTmplListMetrics `json:"metrics"`
}

type VisibilityTopnTemplGtpPlcyTopnTmplListMetrics struct {
	RlMessageMonitor int    `json:"rl-message-monitor"`
	Uuid             string `json:"uuid"`
}
