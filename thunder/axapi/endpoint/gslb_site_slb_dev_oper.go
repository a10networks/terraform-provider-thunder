...
type GslbSiteSlbDevOperOper struct {
	...
	DynamicDevList       []GslbSiteSlbDevOperOperDynamicDevList   `json:"dynamic-dev-list"`
	DynVipserverList     []GslbSiteSlbDevOperOperDynVipserverList `json:"dyn-vipserver-list"`
...
type GslbSiteSlbDevOperOperDynamicDevList struct {
...
type GslbSiteSlbDevOperOperDynVipserverList struct {
	DynSvrIp    string                                           `json:"dyn-svr-ip"`
	DynSvrState string                                           `json:"dyn-svr-state"`
	DynSvrHits  int                                              `json:"dyn-svr-hits"`
	PortList    []GslbSiteSlbDevOperOperDynVipserverListPortList `json:"port-list"`
}

type GslbSiteSlbDevOperOperDynVipserverListPortList struct {
