...
type Cgnv6Dns64VirtualserverOper struct {
    
    Name string `json:"name"`
    Oper Cgnv6Dns64VirtualserverOperOper `json:"oper"`
    PortList []Cgnv6Dns64VirtualserverOperPortList `json:"port-list"`

}
type DataCgnv6Dns64VirtualserverOper struct {
    DtCgnv6Dns64VirtualserverOper Cgnv6Dns64VirtualserverOper `json:"dns64-virtualserver"`
}


type Cgnv6Dns64VirtualserverOperOper struct {
    Mac string `json:"mac"`
...
type Cgnv6Dns64VirtualserverOperPortList struct {
    PortNumber int `json:"port-number"`
    Protocol string `json:"protocol"`
    Oper Cgnv6Dns64VirtualserverOperPortListOper `json:"oper"`
}


type Cgnv6Dns64VirtualserverOperPortListOper struct {
    State string `json:"state"`
    ...
    HttpHitsList []Cgnv6Dns64VirtualserverOperPortListOperHttpHitsList `json:"http-hits-list"`
    HttpVportCpuList []Cgnv6Dns64VirtualserverOperPortListOperHttpVportCpuList `json:"http-vport-cpu-list"`
...
type Cgnv6Dns64VirtualserverOperPortListOperHttpHitsList struct {
    Name string `json:"name"`
    HitsCount int `json:"hits-count"`
}


type Cgnv6Dns64VirtualserverOperPortListOperHttpVportCpuList struct {
...
func (p *Cgnv6Dns64VirtualserverOper) GetId() string{
    return "1"
}

func (p *Cgnv6Dns64VirtualserverOper) getPath() string{
    
    return "cgnv6/dns64-virtualserver/"+p.Name+"/oper"
}

func (p *Cgnv6Dns64VirtualserverOper) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) (DataCgnv6Dns64VirtualserverOper,error) {
logger.Println("Cgnv6Dns64VirtualserverOper::Get")
    headers := axapi.GenRequestHeader(authToken)
    _, axResp, err := axapi.SendGet(host, p.getPath(), "", nil, headers, logger)
    var payload DataCgnv6Dns64VirtualserverOper
    if err == nil {
        if len(axResp) > 0{
