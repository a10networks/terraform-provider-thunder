...
type SlbServer struct {
	Inst struct {
		...
		ServiceList []SlbServerServiceList `json:"service-list"`
...
type SlbServerServiceList struct {
	PortNumber            int                                  `json:"port-number"`
	Protocol              string                               `json:"protocol"`
	...
	Uuid                  string                               `json:"uuid"`
	UserTag               string                               `json:"user-tag"`
	SamplingEnable        []SlbServerServiceListSamplingEnable `json:"sampling-enable"`
	PacketCaptureTemplate string                               `json:"packet-capture-template"`
}

type SlbServerServiceListSamplingEnable struct {
	Counters1 string `json:"counters1"`
}
