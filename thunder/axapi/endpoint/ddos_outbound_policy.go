...
type DdosOutboundPolicy struct {
	Inst struct {
		AsnBasedTracking DdosOutboundPolicyAsnBasedTracking326 `json:"asn-based-tracking"`

		CountryBasedTracking DdosOutboundPolicyCountryBasedTracking327 `json:"country-based-tracking"`

		Name string `json:"name"`

		PolicyClassListList []DdosOutboundPolicyPolicyClassListList `json:"policy-class-list-list"`

		PolicyDefaultClassList DdosOutboundPolicyPolicyDefaultClassList328 `json:"policy-default-class-list"`
...
type DdosOutboundPolicyAsnBasedTracking326 struct {
...
type DdosOutboundPolicyCountryBasedTracking327 struct {
	Configuration       string `json:"configuration"`
...
type DdosOutboundPolicyPolicyDefaultClassList328 struct {
