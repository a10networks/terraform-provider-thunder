...
type DdosL4SslPortStats struct {
	Stats DdosL4SslPortStatsStats `json:"stats"`
}
type DataDdosL4SslPortStats struct {
	DtDdosL4SslPortStats DdosL4SslPortStats `json:"l4-ssl-port"`
}

type DdosL4SslPortStatsStats struct {
...
func (p *DdosL4SslPortStats) GetId() string {
	return "1"
}

func (p *DdosL4SslPortStats) getPath() string {
	return "ddos/l4-ssl-port/stats"
}

func (p *DdosL4SslPortStats) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) (DataDdosL4SslPortStats, error) {
	logger.Println("DdosL4SslPortStats::Get")
	headers := axapi.GenRequestHeader(authToken)
	_, axResp, err := axapi.SendGet(host, p.getPath(), "", nil, headers, logger)
	var payload DataDdosL4SslPortStats
	if err == nil {
		if len(axResp) > 0 {
