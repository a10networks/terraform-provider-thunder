...
type DdosTemplateDns struct {
	Inst struct {
		...
		AliasRateThreshold int `json:"alias-rate-threshold"`
		...
		DnssecWildcardRateThreshold int `json:"dnssec-wildcard-rate-threshold"`
		...
		MalformedQueryCheck DdosTemplateDnsMalformedQueryCheck335 `json:"malformed-query-check"`
...
type DdosTemplateDnsMalformedQueryCheck335 struct {
