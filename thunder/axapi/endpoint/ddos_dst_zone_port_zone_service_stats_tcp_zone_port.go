...
type DdosDstZonePortZoneServiceStats39 struct {
	Inst struct {
		PortNum int `json:"port-num"`

		Protocol string `json:"protocol"`

		Stats DdosDstZonePortZoneServiceStats39Stats `json:"stats"`

		ZoneName string
	} `json:"zone-service"`
}

type DdosDstZonePortZoneServiceStats39Stats struct {
	TcpZonePort DdosDstZonePortZoneServiceStats39StatsTcpZonePort `json:"tcp-zone-port"`
}

type DdosDstZonePortZoneServiceStats39StatsTcpZonePort struct {
...
func (p *DdosDstZonePortZoneServiceStats39) GetId() string {
	return "1"
}

func (p *DdosDstZonePortZoneServiceStats39) getPath() string {
	return "ddos/dst/zone/" + p.Inst.ZoneName + "/port/zone-service/" + strconv.Itoa(p.Inst.PortNum) + "+" + p.Inst.Protocol + "/stats?tcp-zone-port=true"
}

func (p *DdosDstZonePortZoneServiceStats39) Post(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortZoneServiceStats39::Post")
...
func (p *DdosDstZonePortZoneServiceStats39) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortZoneServiceStats39::Get")
	headers := axapi.GenRequestHeader(authToken)
...
func (p *DdosDstZonePortZoneServiceStats39) Put(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortZoneServiceStats39::Put")
	headers := axapi.GenRequestHeader(authToken)
	payloadBytes, err := axapi.SerializeToJson(p)
	if err != nil {
		logger.Println("Failed to serialize struct as json", err)
...
func (p *DdosDstZonePortZoneServiceStats39) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortZoneServiceStats39::Delete")
	headers := axapi.GenRequestHeader(authToken)
