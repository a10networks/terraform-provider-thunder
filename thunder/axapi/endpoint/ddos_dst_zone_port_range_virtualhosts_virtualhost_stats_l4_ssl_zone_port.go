...
type DdosDstZonePortRangeVirtualhostsVirtualhostStats struct {
	Inst struct {
		Stats DdosDstZonePortRangeVirtualhostsVirtualhostStatsStats `json:"stats"`
...
type DdosDstZonePortRangeVirtualhostsVirtualhostStatsStats struct {
	L4SslZonePort DdosDstZonePortRangeVirtualhostsVirtualhostStatsStatsL4SslZonePort `json:"l4-ssl-zone-port"`
}

type DdosDstZonePortRangeVirtualhostsVirtualhostStatsStatsL4SslZonePort struct {
	...
	Prog_resp_pkt_rate_exceed                int `json:"prog_resp_pkt_rate_exceed"`
	...
	Ip_filtering_drop                        int `json:"ip_filtering_drop"`
	Ip_filtering_bl                          int `json:"ip_filtering_bl"`
	Src_learn_overflow                       int `json:"src_learn_overflow"`
	Ssl_port_clienthello_bad_len             int `json:"ssl_port_clienthello_bad_len"`
	Ssl_port_clienthello_ext_bad_len         int `json:"ssl_port_clienthello_ext_bad_len"`
	All_src_session_reset                    int `json:"all_src_session_reset"`
	Clear_session_upon_deescalation          int `json:"clear_session_upon_deescalation"`
	Hybrid_auth_unknown_pass                 int `json:"hybrid_auth_unknown_pass"`
	Hybrid_auth_unknown_fail                 int `json:"hybrid_auth_unknown_fail"`
	Hybrid_auth_valid_sa_sent                int `json:"hybrid_auth_valid_sa_sent"`
	Hybrid_auth_invalid_sa_sent              int `json:"hybrid_auth_invalid_sa_sent"`
	Hybrid_auth_filter_full                  int `json:"hybrid_auth_filter_full"`
	Hybrid_auth_lookup_fail                  int `json:"hybrid_auth_lookup_fail"`
	Hybrid_auth_invalid_pass                 int `json:"hybrid_auth_invalid_pass"`
	Hybrid_auth_valid_pass                   int `json:"hybrid_auth_valid_pass"`
	Hybrid_auth_invalid_fail                 int `json:"hybrid_auth_invalid_fail"`
	Hybrid_auth_valid_fail                   int `json:"hybrid_auth_valid_fail"`
	Cipher_suites_limit_exceed               int `json:"cipher_suites_limit_exceed"`
	Client_ext_limit_exceed                  int `json:"client_ext_limit_exceed"`
	Src_handshaking_conn_exceed              int `json:"src_handshaking_conn_exceed"`
	Clienthello_to_appdata_timeout           int `json:"clienthello_to_appdata_timeout"`
	Handshake_finished_to_appdata_timeout    int `json:"handshake_finished_to_appdata_timeout"`
	Dst_tcp_conn_half_open_timeout           int `json:"dst_tcp_conn_half_open_timeout"`
	Dst_tcp_conn_half_open_timeout_rst_sent  int `json:"dst_tcp_conn_half_open_timeout_rst_sent"`
	Dst_tcp_sess_aged_rst_sent               int `json:"dst_tcp_sess_aged_rst_sent"`
	Prog_query_exceed                        int `json:"prog_query_exceed"`
	Prog_think_exceed                        int `json:"prog_think_exceed"`
	Dynamic_count_warn                       int `json:"dynamic_count_warn"`
	Virtualhost_policy_match                 int `json:"virtualhost_policy_match"`
	Virtualhost_policy_not_match             int `json:"virtualhost_policy_not_match"`
	...
	Hybrid_auth_method_change                int `json:"hybrid_auth_method_change"`
	Small_window_excd                        int `json:"small_window_excd"`
	Src_small_window_excd                    int `json:"src_small_window_excd"`
	Small_window_rcv                         int `json:"small_window_rcv"`
	Hybrid_auth_entry_aged_out               int `json:"hybrid_auth_entry_aged_out"`
	...
	Hybrid_auth_auth_no_match                int `json:"hybrid_auth_auth_no_match"`
	Tcp_auth_drop_syn                        int `json:"tcp_auth_drop_syn"`
	Src_auth_drop_syn                        int `json:"src_auth_drop_syn"`
	Tcp_auth_drop_ack                        int `json:"tcp_auth_drop_ack"`
	Src_auth_drop_ack                        int `json:"src_auth_drop_ack"`
	Tcp_auth_drop_rst                        int `json:"tcp_auth_drop_rst"`
	Src_auth_drop_rst                        int `json:"src_auth_drop_rst"`
	Tcp_auth_drop_ack_pass_auth              int `json:"tcp_auth_drop_ack_pass_auth"`
	Src_auth_drop_ack_pass_auth              int `json:"src_auth_drop_ack_pass_auth"`
	Tcp_auth_drop_ack_fail_auth              int `json:"tcp_auth_drop_ack_fail_auth"`
	Src_auth_drop_ack_fail_auth              int `json:"src_auth_drop_ack_fail_auth"`
	Tcp_auth_drop_rst_pass_auth              int `json:"tcp_auth_drop_rst_pass_auth"`
	Src_auth_drop_rst_pass_auth              int `json:"src_auth_drop_rst_pass_auth"`
	Tcp_auth_drop_rst_fail_auth              int `json:"tcp_auth_drop_rst_fail_auth"`
	Src_auth_drop_rst_fail_auth              int `json:"src_auth_drop_rst_fail_auth"`
	Hybrid_auth_auth_no_match_rst_rcv        int `json:"hybrid_auth_auth_no_match_rst_rcv"`
	Hybrid_auth_auth_no_match_ack_rcv        int `json:"hybrid_auth_auth_no_match_ack_rcv"`
	Tcp_auth_drop_ack_xmit                   int `json:"tcp_auth_drop_ack_xmit"`
	Src_auth_drop_ack_xmit                   int `json:"src_auth_drop_ack_xmit"`
	Tcp_auth_drop_rst_xmit                   int `json:"tcp_auth_drop_rst_xmit"`
	Src_auth_drop_rst_xmit                   int `json:"src_auth_drop_rst_xmit"`
	Same_sport_dport_drop                    int `json:"same_sport_dport_drop"`
	Tcp_psh_rcvd                             int `json:"tcp_psh_rcvd"`
	Tcp_psh_ack_rcvd                         int `json:"tcp_psh_ack_rcvd"`
	Tcp_fin_ack_rcvd                         int `json:"tcp_fin_ack_rcvd"`
	Tcp_rst_ack_rcvd                         int `json:"tcp_rst_ack_rcvd"`
	Tcp_urg_rcvd                             int `json:"tcp_urg_rcvd"`
	Tcp_ece_rcvd                             int `json:"tcp_ece_rcvd"`
	Tcp_cwr_rcvd                             int `json:"tcp_cwr_rcvd"`
	Tcp_empty_ack_rcvd                       int `json:"tcp_empty_ack_rcvd"`
	Tcp_ack_data_rcvd                        int `json:"tcp_ack_data_rcvd"`
	Tcp_syn_ack_drop                         int `json:"tcp_syn_ack_drop"`
	Tcp_psh_ack_drop                         int `json:"tcp_psh_ack_drop"`
	Tcp_fin_ack_drop                         int `json:"tcp_fin_ack_drop"`
	Tcp_rst_ack_drop                         int `json:"tcp_rst_ack_drop"`
	Tcp_ack_drop                             int `json:"tcp_ack_drop"`
	Tcp_fin_drop                             int `json:"tcp_fin_drop"`
	Tcp_rst_drop                             int `json:"tcp_rst_drop"`
	Tcp_psh_drop                             int `json:"tcp_psh_drop"`
	Tcp_urg_drop                             int `json:"tcp_urg_drop"`
	Tcp_ece_drop                             int `json:"tcp_ece_drop"`
	Tcp_cwr_drop                             int `json:"tcp_cwr_drop"`
	Tcp_empty_ack_drop                       int `json:"tcp_empty_ack_drop"`
	Tcp_ack_data_drop                        int `json:"tcp_ack_data_drop"`
	Tcp_syn_fwd                              int `json:"tcp_syn_fwd"`
	Tcp_syn_ack_fwd                          int `json:"tcp_syn_ack_fwd"`
	Tcp_psh_ack_fwd                          int `json:"tcp_psh_ack_fwd"`
	Tcp_fin_ack_fwd                          int `json:"tcp_fin_ack_fwd"`
	Tcp_rst_ack_fwd                          int `json:"tcp_rst_ack_fwd"`
	Tcp_ack_fwd                              int `json:"tcp_ack_fwd"`
	Tcp_fin_fwd                              int `json:"tcp_fin_fwd"`
	Tcp_rst_fwd                              int `json:"tcp_rst_fwd"`
	Tcp_psh_fwd                              int `json:"tcp_psh_fwd"`
	Tcp_urg_fwd                              int `json:"tcp_urg_fwd"`
	Tcp_ece_fwd                              int `json:"tcp_ece_fwd"`
	Tcp_cwr_fwd                              int `json:"tcp_cwr_fwd"`
	Tcp_empty_ack_fwd                        int `json:"tcp_empty_ack_fwd"`
	Tcp_ack_data_fwd                         int `json:"tcp_ack_data_fwd"`
...
func (p *DdosDstZonePortRangeVirtualhostsVirtualhostStats) GetId() string {
	return "1"
}

func (p *DdosDstZonePortRangeVirtualhostsVirtualhostStats) getPath() string {
	return "ddos/dst/zone/" + p.Inst.ZoneName + "/port-range/" + p.Inst.PortRangeStart + "+" + p.Inst.PortRangeEnd + "+" + p.Inst.Protocol + "/virtualhosts/virtualhost/" + p.Inst.Vhost + "/stats?l4-ssl-zone-port=true"
}

func (p *DdosDstZonePortRangeVirtualhostsVirtualhostStats) Post(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortRangeVirtualhostsVirtualhostStats::Post")
...
func (p *DdosDstZonePortRangeVirtualhostsVirtualhostStats) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortRangeVirtualhostsVirtualhostStats::Get")
	headers := axapi.GenRequestHeader(authToken)
...
func (p *DdosDstZonePortRangeVirtualhostsVirtualhostStats) Put(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortRangeVirtualhostsVirtualhostStats::Put")
	headers := axapi.GenRequestHeader(authToken)
	payloadBytes, err := axapi.SerializeToJson(p)
	if err != nil {
		logger.Println("Failed to serialize struct as json", err)
...
func (p *DdosDstZonePortRangeVirtualhostsVirtualhostStats) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortRangeVirtualhostsVirtualhostStats::Delete")
	headers := axapi.GenRequestHeader(authToken)
