...
type DdosDstEntrySrcPortRangeStats struct {
	Inst struct {
		...
		Stats DdosDstEntrySrcPortRangeStatsStats `json:"stats"`

		DstEntryName string
	} `json:"src-port-range"`
}

type DdosDstEntrySrcPortRangeStatsStats struct {
	TcpPort DdosDstEntrySrcPortRangeStatsStatsTcpPort `json:"tcp-port"`
}

type DdosDstEntrySrcPortRangeStatsStatsTcpPort struct {
...
func (p *DdosDstEntrySrcPortRangeStats) GetId() string {
	return "1"
}

func (p *DdosDstEntrySrcPortRangeStats) getPath() string {
	return "ddos/dst/entry/" + p.Inst.DstEntryName + "/src-port-range/" + strconv.Itoa(p.Inst.SrcPortRangeStart) + "+" + strconv.Itoa(p.Inst.SrcPortRangeEnd) + "+" + p.Inst.Protocol + "/stats?tcp-port=true"
}

func (p *DdosDstEntrySrcPortRangeStats) Post(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstEntrySrcPortRangeStats::Post")
...
func (p *DdosDstEntrySrcPortRangeStats) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstEntrySrcPortRangeStats::Get")
	headers := axapi.GenRequestHeader(authToken)
...
func (p *DdosDstEntrySrcPortRangeStats) Put(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstEntrySrcPortRangeStats::Put")
	headers := axapi.GenRequestHeader(authToken)
	payloadBytes, err := axapi.SerializeToJson(p)
	if err != nil {
		logger.Println("Failed to serialize struct as json", err)
...
func (p *DdosDstEntrySrcPortRangeStats) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstEntrySrcPortRangeStats::Delete")
	headers := axapi.GenRequestHeader(authToken)
