...
type Sessions struct {
	Inst struct {
		Ext SessionsExt1487 `json:"ext"`

		Smp SessionsSmp1488 `json:"smp"`

		SmpTable SessionsSmpTable1489 `json:"smp-table"`

		Uuid string `json:"uuid"`
	} `json:"sessions"`
}

type SessionsExt1487 struct {
	Uuid string `json:"uuid"`
}

type SessionsSmp1488 struct {
	Uuid string `json:"uuid"`
}

type SessionsSmpTable1489 struct {
	Uuid string `json:"uuid"`
}
