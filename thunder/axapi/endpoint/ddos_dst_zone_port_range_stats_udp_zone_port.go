...
type DdosDstZonePortRangeStats31 struct {
	Inst struct {
		...
		Stats DdosDstZonePortRangeStats31Stats `json:"stats"`

		ZoneName string
	} `json:"port-range"`
}

type DdosDstZonePortRangeStats31Stats struct {
	UdpZonePort DdosDstZonePortRangeStats31StatsUdpZonePort `json:"udp-zone-port"`
}

type DdosDstZonePortRangeStats31StatsUdpZonePort struct {
...
func (p *DdosDstZonePortRangeStats31) GetId() string {
	return "1"
}

func (p *DdosDstZonePortRangeStats31) getPath() string {
	return "ddos/dst/zone/" + p.Inst.ZoneName + "/port-range/" + strconv.Itoa(p.Inst.PortRangeStart) + "+" + strconv.Itoa(p.Inst.PortRangeEnd) + "+" + p.Inst.Protocol + "/stats?udp-zone-port=true"
}

func (p *DdosDstZonePortRangeStats31) Post(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortRangeStats31::Post")
...
func (p *DdosDstZonePortRangeStats31) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortRangeStats31::Get")
	headers := axapi.GenRequestHeader(authToken)
...
func (p *DdosDstZonePortRangeStats31) Put(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortRangeStats31::Put")
	headers := axapi.GenRequestHeader(authToken)
	payloadBytes, err := axapi.SerializeToJson(p)
	if err != nil {
		logger.Println("Failed to serialize struct as json", err)
...
func (p *DdosDstZonePortRangeStats31) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortRangeStats31::Delete")
	headers := axapi.GenRequestHeader(authToken)
