...
type DdosDstZonePortZoneServiceStats40 struct {
	Inst struct {
		PortNum int `json:"port-num"`

		Protocol string `json:"protocol"`

		Stats DdosDstZonePortZoneServiceStats40Stats `json:"stats"`

		ZoneName string
	} `json:"zone-service"`
}

type DdosDstZonePortZoneServiceStats40Stats struct {
	UdpZonePort DdosDstZonePortZoneServiceStats40StatsUdpZonePort `json:"udp-zone-port"`
}

type DdosDstZonePortZoneServiceStats40StatsUdpZonePort struct {
...
func (p *DdosDstZonePortZoneServiceStats40) GetId() string {
	return "1"
}

func (p *DdosDstZonePortZoneServiceStats40) getPath() string {
	return "ddos/dst/zone/" + p.Inst.ZoneName + "/port/zone-service/" + strconv.Itoa(p.Inst.PortNum) + "+" + p.Inst.Protocol + "/stats?udp-zone-port=true"
}

func (p *DdosDstZonePortZoneServiceStats40) Post(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortZoneServiceStats40::Post")
...
func (p *DdosDstZonePortZoneServiceStats40) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortZoneServiceStats40::Get")
	headers := axapi.GenRequestHeader(authToken)
...
func (p *DdosDstZonePortZoneServiceStats40) Put(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortZoneServiceStats40::Put")
	headers := axapi.GenRequestHeader(authToken)
	payloadBytes, err := axapi.SerializeToJson(p)
	if err != nil {
		logger.Println("Failed to serialize struct as json", err)
...
func (p *DdosDstZonePortZoneServiceStats40) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortZoneServiceStats40::Delete")
	headers := axapi.GenRequestHeader(authToken)
