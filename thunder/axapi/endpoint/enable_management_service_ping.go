...
type EnableManagementServicePingAclV4List struct {
	...
	LifCfg      EnableManagementServicePingAclV4ListLifCfg      `json:"lif-cfg"`
...
type EnableManagementServicePingAclV4ListLifCfg struct {
	Lif string `json:"lif"`
}
...
type EnableManagementServicePingAclV6List struct {
	...
	LifCfg      EnableManagementServicePingAclV6ListLifCfg      `json:"lif-cfg"`
	Management  int                                             `json:"management"`
	AllDataIntf int                                             `json:"all-data-intf"`
	Uuid        string                                          `json:"uuid"`
	UserTag     string                                          `json:"user-tag"`
...
type EnableManagementServicePingAclV6ListLifCfg struct {
	Lif string `json:"lif"`
}
