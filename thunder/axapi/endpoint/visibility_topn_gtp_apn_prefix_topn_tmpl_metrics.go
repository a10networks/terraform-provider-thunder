...
type VisibilityTopnGtpApnPrefixTopnTmplMetrics struct {
	Inst struct {
		...
		Gtp_apn_prefix_topn_tmpl_name string
	} `json:"metrics"`
}

func (p *VisibilityTopnGtpApnPrefixTopnTmplMetrics) GetId() string {
	return "1"
}

func (p *VisibilityTopnGtpApnPrefixTopnTmplMetrics) getPath() string {
	return "visibility/topn/gtp-apn-prefix-topn-tmpl/" + p.Inst.Gtp_apn_prefix_topn_tmpl_name + "/metrics"
}

func (p *VisibilityTopnGtpApnPrefixTopnTmplMetrics) Post(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("VisibilityTopnGtpApnPrefixTopnTmplMetrics::Post")
...
func (p *VisibilityTopnGtpApnPrefixTopnTmplMetrics) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("VisibilityTopnGtpApnPrefixTopnTmplMetrics::Get")
	headers := axapi.GenRequestHeader(authToken)
...
func (p *VisibilityTopnGtpApnPrefixTopnTmplMetrics) Put(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("VisibilityTopnGtpApnPrefixTopnTmplMetrics::Put")
	headers := axapi.GenRequestHeader(authToken)
	payloadBytes, err := axapi.SerializeToJson(p)
	if err != nil {
		logger.Println("Failed to serialize struct as json", err)
...
func (p *VisibilityTopnGtpApnPrefixTopnTmplMetrics) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("VisibilityTopnGtpApnPrefixTopnTmplMetrics::Delete")
	headers := axapi.GenRequestHeader(authToken)
