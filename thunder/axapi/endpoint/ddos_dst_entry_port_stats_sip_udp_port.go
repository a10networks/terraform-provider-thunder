...
type DdosDstEntryPortStats15 struct {
	Inst struct {

    PortNum int `json:"port-num"`
    Protocol string `json:"protocol"`
    Stats DdosDstEntryPortStats15Stats `json:"stats"`
    DstEntryName string 
...
type DdosDstEntryPortStats15Stats struct {
    SipUdpPort DdosDstEntryPortStats15StatsSipUdpPort `json:"sip-udp-port"`
}


type DdosDstEntryPortStats15StatsSipUdpPort struct {
...
func (p *DdosDstEntryPortStats15) GetId() string{
    return "1"
}

func (p *DdosDstEntryPortStats15) getPath() string{
    return "ddos/dst/entry/" +p.Inst.DstEntryName + "/port/" +strconv.Itoa(p.Inst.PortNum)+"+"+p.Inst.Protocol+"/stats?sip-udp-port=true"
}

func (p *DdosDstEntryPortStats15) Post(authToken string, host string, logger *axapi.ThunderLog) error {
    logger.Println("DdosDstEntryPortStats15::Post")
...
func (p *DdosDstEntryPortStats15) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
    logger.Println("DdosDstEntryPortStats15::Get")
    headers := axapi.GenRequestHeader(authToken)
...
func (p *DdosDstEntryPortStats15) Put(authToken string, host string, logger *axapi.ThunderLog) error {
    logger.Println("DdosDstEntryPortStats15::Put")
    headers := axapi.GenRequestHeader(authToken)
    payloadBytes, err := axapi.SerializeToJson(p)
    if err != nil {
        logger.Println("Failed to serialize struct as json", err)
...
func (p *DdosDstEntryPortStats15) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
    logger.Println("DdosDstEntryPortStats15::Delete")
    headers := axapi.GenRequestHeader(authToken)
