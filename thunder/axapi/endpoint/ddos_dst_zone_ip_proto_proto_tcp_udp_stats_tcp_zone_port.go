...
type DdosDstZoneIpProtoProtoTcpUdpStats struct {
	Inst struct {
		Protocol string `json:"protocol"`

		Stats DdosDstZoneIpProtoProtoTcpUdpStatsStats `json:"stats"`

		ZoneName string
	} `json:"proto-tcp-udp"`
}

type DdosDstZoneIpProtoProtoTcpUdpStatsStats struct {
	TcpZonePort DdosDstZoneIpProtoProtoTcpUdpStatsStatsTcpZonePort `json:"tcp-zone-port"`
}

type DdosDstZoneIpProtoProtoTcpUdpStatsStatsTcpZonePort struct {
...
func (p *DdosDstZoneIpProtoProtoTcpUdpStats) GetId() string {
	return "1"
}

func (p *DdosDstZoneIpProtoProtoTcpUdpStats) getPath() string {
	return "ddos/dst/zone/" + p.Inst.ZoneName + "/ip-proto/proto-tcp-udp/" + p.Inst.Protocol + "/stats?tcp-zone-port=true"
}

func (p *DdosDstZoneIpProtoProtoTcpUdpStats) Post(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZoneIpProtoProtoTcpUdpStats::Post")
...
func (p *DdosDstZoneIpProtoProtoTcpUdpStats) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZoneIpProtoProtoTcpUdpStats::Get")
	headers := axapi.GenRequestHeader(authToken)
...
func (p *DdosDstZoneIpProtoProtoTcpUdpStats) Put(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZoneIpProtoProtoTcpUdpStats::Put")
	headers := axapi.GenRequestHeader(authToken)
	payloadBytes, err := axapi.SerializeToJson(p)
	if err != nil {
		logger.Println("Failed to serialize struct as json", err)
...
func (p *DdosDstZoneIpProtoProtoTcpUdpStats) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZoneIpProtoProtoTcpUdpStats::Delete")
	headers := axapi.GenRequestHeader(authToken)
