...
type DdosDstZoneIpProtoProtoNumberOper struct {
	IpFilteringPolicyStatistics DdosDstZoneIpProtoProtoNumberOperIpFilteringPolicyStatistics `json:"ip-filtering-policy-statistics"`
	...
	SrcBasedPolicyList []DdosDstZoneIpProtoProtoNumberOperSrcBasedPolicyList `json:"src-based-policy-list"`
...
type DdosDstZoneIpProtoProtoNumberOperIpFilteringPolicyStatistics struct {
	Oper DdosDstZoneIpProtoProtoNumberOperIpFilteringPolicyStatisticsOper `json:"oper"`
}

type DdosDstZoneIpProtoProtoNumberOperIpFilteringPolicyStatisticsOper struct {
	RuleList []DdosDstZoneIpProtoProtoNumberOperIpFilteringPolicyStatisticsOperRuleList `json:"rule-list"`
}

type DdosDstZoneIpProtoProtoNumberOperIpFilteringPolicyStatisticsOperRuleList struct {
	Seq                   int `json:"seq"`
	Hits                  int `json:"hits"`
...
type DdosDstZoneIpProtoProtoNumberOperSrcBasedPolicyList struct {
	SrcBasedPolicyName  string                                                                   `json:"src-based-policy-name"`
	Oper                DdosDstZoneIpProtoProtoNumberOperSrcBasedPolicyListOper                  `json:"oper"`
	PolicyClassListList []DdosDstZoneIpProtoProtoNumberOperSrcBasedPolicyListPolicyClassListList `json:"policy-class-list-list"`
}

type DdosDstZoneIpProtoProtoNumberOperSrcBasedPolicyListOper struct {
}

type DdosDstZoneIpProtoProtoNumberOperSrcBasedPolicyListPolicyClassListList struct {
	ClassListName string                                                                     `json:"class-list-name"`
	Oper          DdosDstZoneIpProtoProtoNumberOperSrcBasedPolicyListPolicyClassListListOper `json:"oper"`
}

type DdosDstZoneIpProtoProtoNumberOperSrcBasedPolicyListPolicyClassListListOper struct {
