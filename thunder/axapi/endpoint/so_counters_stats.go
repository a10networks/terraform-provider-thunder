...
type SoCountersStatsStats struct {
	...
	So_pkts_l3_redirect_encap_mtu_error_drop       int `json:"so_pkts_l3_redirect_encap_mtu_error_drop"`
	...
	So_pkts_l2redirect_same_pkt_multiple_times     int `json:"so_pkts_l2redirect_same_pkt_multiple_times"`
	So_slb_shadow_session_created                  int `json:"so_slb_shadow_session_created"`
	So_pkts_cgn_traffic_map_mismatch_drop          int `json:"so_pkts_cgn_traffic_map_mismatch_drop"`
	So_pkts_redirection_loop_drop                  int `json:"so_pkts_redirection_loop_drop"`
	So_pkts_l2redirect_frag_vlan_retrieval_error   int `json:"so_pkts_l2redirect_frag_vlan_retrieval_error"`
	So_pkts_l2redirect_tx_frag_vlan_add_fail       int `json:"so_pkts_l2redirect_tx_frag_vlan_add_fail"`
}
