...
type SystemViewHardwareViewOper struct {
    
    Oper SystemViewHardwareViewOperOper `json:"oper"`

}
type DataSystemViewHardwareViewOper struct {
    DtSystemViewHardwareViewOper SystemViewHardwareViewOper `json:"hardware-view"`
}


type SystemViewHardwareViewOperOper struct {
    ...
    SslCards SystemViewHardwareViewOperOperSslCards `json:"ssl-cards"`
    Octeon int `json:"octeon"`
    CompressionCards SystemViewHardwareViewOperOperCompressionCards `json:"compression-cards"`
    ...
    NvmFirmwareVersoin string `json:"nvm-firmware-versoin"`
    ...
    RaidList []SystemViewHardwareViewOperOperRaidList `json:"raid-list"`
    ...
    BypassList []SystemViewHardwareViewOperOperBypassList `json:"bypass-list"`
...
type SystemViewHardwareViewOperOperSslCards struct {
...
type SystemViewHardwareViewOperOperCompressionCards struct {
...
type SystemViewHardwareViewOperOperRaidList struct {
...
type SystemViewHardwareViewOperOperBypassList struct {
    BypassName string `json:"bypass-name"`
    BypassInfo string `json:"bypass-info"`
}

func (p *SystemViewHardwareViewOper) GetId() string{
    return "1"
}

func (p *SystemViewHardwareViewOper) getPath() string{
    return "system-view/hardware-view/oper"
}

func (p *SystemViewHardwareViewOper) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) (DataSystemViewHardwareViewOper,error) {
logger.Println("SystemViewHardwareViewOper::Get")
    headers := axapi.GenRequestHeader(authToken)
    _, axResp, err := axapi.SendGet(host, p.getPath(), "", nil, headers, logger)
    var payload DataSystemViewHardwareViewOper
    if err == nil {
        if len(axResp) > 0{
