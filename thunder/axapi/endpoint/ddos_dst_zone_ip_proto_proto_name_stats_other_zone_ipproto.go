...
type DdosDstZoneIpProtoProtoNameStats22 struct {
	Inst struct {
		Protocol string `json:"protocol"`

		Stats DdosDstZoneIpProtoProtoNameStats22Stats `json:"stats"`

		ZoneName string
	} `json:"proto-name"`
}

type DdosDstZoneIpProtoProtoNameStats22Stats struct {
	OtherZoneIpproto DdosDstZoneIpProtoProtoNameStats22StatsOtherZoneIpproto `json:"other-zone-ipproto"`
}

type DdosDstZoneIpProtoProtoNameStats22StatsOtherZoneIpproto struct {
...
func (p *DdosDstZoneIpProtoProtoNameStats22) GetId() string {
	return "1"
}

func (p *DdosDstZoneIpProtoProtoNameStats22) getPath() string {
	return "ddos/dst/zone/" + p.Inst.ZoneName + "/ip-proto/proto-name/" + p.Inst.Protocol + "/stats?other-zone-ipproto=true"
}

func (p *DdosDstZoneIpProtoProtoNameStats22) Post(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZoneIpProtoProtoNameStats22::Post")
...
func (p *DdosDstZoneIpProtoProtoNameStats22) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZoneIpProtoProtoNameStats22::Get")
	headers := axapi.GenRequestHeader(authToken)
...
func (p *DdosDstZoneIpProtoProtoNameStats22) Put(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZoneIpProtoProtoNameStats22::Put")
	headers := axapi.GenRequestHeader(authToken)
	payloadBytes, err := axapi.SerializeToJson(p)
	if err != nil {
		logger.Println("Failed to serialize struct as json", err)
...
func (p *DdosDstZoneIpProtoProtoNameStats22) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZoneIpProtoProtoNameStats22::Delete")
	headers := axapi.GenRequestHeader(authToken)
