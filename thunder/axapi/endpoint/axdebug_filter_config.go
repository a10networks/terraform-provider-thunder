...
type AxdebugFilterConfig struct {
	Inst struct {
		...
		InnerIp int `json:"inner-ip"`

		InnerIpv4Address string `json:"inner-ipv4-address"`

		InnerIpv4Netmask string `json:"inner-ipv4-netmask"`

		InnerIpv6 int `json:"inner-ipv6"`

		InnerIpv6Address string `json:"inner-ipv6-address"`
