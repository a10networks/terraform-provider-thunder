...
type EnableManagementServiceNtpAclV4List struct {
	...
	LifCfg      EnableManagementServiceNtpAclV4ListLifCfg      `json:"lif-cfg"`
...
type EnableManagementServiceNtpAclV4ListLifCfg struct {
	Lif string `json:"lif"`
}
...
type EnableManagementServiceNtpAclV6List struct {
	...
	LifCfg      EnableManagementServiceNtpAclV6ListLifCfg      `json:"lif-cfg"`
	Management  int                                            `json:"management"`
	AllDataIntf int                                            `json:"all-data-intf"`
	Uuid        string                                         `json:"uuid"`
	UserTag     string                                         `json:"user-tag"`
...
type EnableManagementServiceNtpAclV6ListLifCfg struct {
	Lif string `json:"lif"`
}
