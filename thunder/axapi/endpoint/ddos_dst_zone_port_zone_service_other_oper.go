...
type DdosDstZonePortZoneServiceOtherOper struct {
	...
	SrcBasedPolicyList []DdosDstZonePortZoneServiceOtherOperSrcBasedPolicyList `json:"src-based-policy-list"`
...
type DdosDstZonePortZoneServiceOtherOperIpFilteringPolicyStatistics struct {
	Oper DdosDstZonePortZoneServiceOtherOperIpFilteringPolicyStatisticsOper `json:"oper"`
}

type DdosDstZonePortZoneServiceOtherOperIpFilteringPolicyStatisticsOper struct {
	RuleList []DdosDstZonePortZoneServiceOtherOperIpFilteringPolicyStatisticsOperRuleList `json:"rule-list"`
}

type DdosDstZonePortZoneServiceOtherOperIpFilteringPolicyStatisticsOperRuleList struct {
	Seq                   int `json:"seq"`
	Hits                  int `json:"hits"`
...
type DdosDstZonePortZoneServiceOtherOperSrcBasedPolicyList struct {
	SrcBasedPolicyName  string                                                                     `json:"src-based-policy-name"`
	Oper                DdosDstZonePortZoneServiceOtherOperSrcBasedPolicyListOper                  `json:"oper"`
	PolicyClassListList []DdosDstZonePortZoneServiceOtherOperSrcBasedPolicyListPolicyClassListList `json:"policy-class-list-list"`
}

type DdosDstZonePortZoneServiceOtherOperSrcBasedPolicyListOper struct {
}

type DdosDstZonePortZoneServiceOtherOperSrcBasedPolicyListPolicyClassListList struct {
	ClassListName string                                                                       `json:"class-list-name"`
	Oper          DdosDstZonePortZoneServiceOtherOperSrcBasedPolicyListPolicyClassListListOper `json:"oper"`
}

type DdosDstZonePortZoneServiceOtherOperSrcBasedPolicyListPolicyClassListListOper struct {
