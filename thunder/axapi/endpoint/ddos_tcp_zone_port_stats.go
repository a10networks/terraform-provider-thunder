...
type DdosTcpZonePortStats struct {
	Stats DdosTcpZonePortStatsStats `json:"stats"`
}
type DataDdosTcpZonePortStats struct {
	DtDdosTcpZonePortStats DdosTcpZonePortStats `json:"tcp-zone-port"`
}

type DdosTcpZonePortStatsStats struct {
...
func (p *DdosTcpZonePortStats) GetId() string {
	return "1"
}

func (p *DdosTcpZonePortStats) getPath() string {
	return "ddos/tcp-zone-port/stats"
}

func (p *DdosTcpZonePortStats) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) (DataDdosTcpZonePortStats, error) {
	logger.Println("DdosTcpZonePortStats::Get")
	headers := axapi.GenRequestHeader(authToken)
	_, axResp, err := axapi.SendGet(host, p.getPath(), "", nil, headers, logger)
	var payload DataDdosTcpZonePortStats
	if err == nil {
		if len(axResp) > 0 {
