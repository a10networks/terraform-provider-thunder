...
type FwGtpStatsApnPrefixStats struct {
	...
	VldMessageMonitor                            int    `json:"vld-message-monitor"`
	GenMessageLengthMonitor                      int    `json:"gen-message-length-monitor"`
	...
	FltMessageMonitor                            int    `json:"flt-message-monitor"`
	RatFltMessageMonitor                         int    `json:"rat-flt-message-monitor"`
	ApnImsiFltMessageMonitor                     int    `json:"apn-imsi-flt-message-monitor"`
	MsisdnFltMessageMonitor                      int    `json:"msisdn-flt-message-monitor"`
	GtpInGtpFltMessageMonitor                    int    `json:"gtp-in-gtp-flt-message-monitor"`
...
type FwGtpStatsStats struct {
	...
	BladeNoFwdRoute                       int `json:"blade-no-fwd-route"`
	BladeNoRevRoute                       int `json:"blade-no-rev-route"`
	...
	GtpUTunnelRateLimitEntryCreateFailure int `json:"gtp-u-tunnel-rate-limit-entry-create-failure"`
	...
	BladeGtpRateLimitT3CtrCreateFailure   int `json:"blade-gtp-rate-limit-t3-ctr-create-failure"`
	BladeGtpRateLimitEntryCreateFailure   int `json:"blade-gtp-rate-limit-entry-create-failure"`
	...
	DropVldGtpUEchoOutOfState             int `json:"drop-vld-gtp-u-echo-out-of-state-"`
	GtpCreateSessionRequestRetxDrop       int `json:"gtp-create-session-request-retx-drop"`
	...
	GtpURrMessageDrop                     int `json:"gtp-u-rr-message-drop"`
	DropGtpFragOrJumboPkt                 int `json:"drop-gtp-frag-or-jumbo-pkt"`
	GtpV0CVerNotSupp                      int `json:"gtp-v0-c-ver-not-supp"`
	GtpV1CVerNotSupp                      int `json:"gtp-v1-c-ver-not-supp"`
	GtpV2CVerNotSupp                      int `json:"gtp-v2-c-ver-not-supp"`
	GtpCHandoverInProgressWithConn        int `json:"gtp-c-handover-in-progress-with-conn"`
	GtpCConnCreatePktDrop                 int `json:"gtp-c-conn-create-pkt-drop"`
	...
	BladeGtpSmpDecSessCountCheckFailed    int `json:"blade-gtp-smp-dec-sess-count-check-failed"`
	...
	GtpUStatelessForward                  int `json:"gtp-u-stateless-forward"`
	GtpEchoStatelessForward               int `json:"gtp-echo-stateless-forward"`
	GtpUFragPktProcessed                  int `json:"gtp-u-frag-pkt-processed"`
	GtpCFragPktReceived                   int `json:"gtp-c-frag-pkt-received"`
	GtpUFragPktReceived                   int `json:"gtp-u-frag-pkt-received"`
	GtpCFragOrJumboPktProcessed           int `json:"gtp-c-frag-or-jumbo-pkt-processed"`
	GtpEchoFragOrJumboPktProcessed        int `json:"gtp-echo-frag-or-jumbo-pkt-processed"`
	GtpUTunnelFragOrJumboPktProcessed     int `json:"gtp-u-tunnel-frag-or-jumbo-pkt-processed"`
	BladeGtpSmpSessionCountCheckFailed    int `json:"blade-gtp-smp-session-count-check-failed"`
	GtpSyncTxFwDropSessionCreate          int `json:"gtp-sync-tx-fw-drop-session-create"`
	...
	GtpUMonitorForward                    int `json:"gtp-u-monitor-forward"`
	GtpExt_hdrIncorrectLength             int `json:"gtp-ext_hdr-incorrect-length"`
}
