...
type DdosDstZoneSrcPortRangeStats struct {
	Inst struct {
		...
		Stats DdosDstZoneSrcPortRangeStatsStats `json:"stats"`

		ZoneName string
	} `json:"src-port-range"`
}

type DdosDstZoneSrcPortRangeStatsStats struct {
	TcpZonePort DdosDstZoneSrcPortRangeStatsStatsTcpZonePort `json:"tcp-zone-port"`
}

type DdosDstZoneSrcPortRangeStatsStatsTcpZonePort struct {
...
func (p *DdosDstZoneSrcPortRangeStats) GetId() string {
	return "1"
}

func (p *DdosDstZoneSrcPortRangeStats) getPath() string {
	return "ddos/dst/zone/" + p.Inst.ZoneName + "/src-port-range/" + strconv.Itoa(p.Inst.SrcPortRangeStart) + "+" + strconv.Itoa(p.Inst.SrcPortRangeEnd) + "+" + p.Inst.Protocol + "/stats?tcp-zone-port=true"
}

func (p *DdosDstZoneSrcPortRangeStats) Post(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZoneSrcPortRangeStats::Post")
...
func (p *DdosDstZoneSrcPortRangeStats) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZoneSrcPortRangeStats::Get")
	headers := axapi.GenRequestHeader(authToken)
...
func (p *DdosDstZoneSrcPortRangeStats) Put(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZoneSrcPortRangeStats::Put")
	headers := axapi.GenRequestHeader(authToken)
	payloadBytes, err := axapi.SerializeToJson(p)
	if err != nil {
		logger.Println("Failed to serialize struct as json", err)
...
func (p *DdosDstZoneSrcPortRangeStats) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZoneSrcPortRangeStats::Delete")
	headers := axapi.GenRequestHeader(authToken)
