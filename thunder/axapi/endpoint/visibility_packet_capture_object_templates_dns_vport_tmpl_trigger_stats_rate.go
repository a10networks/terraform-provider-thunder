...
type VisibilityPacketCaptureObjectTemplatesDnsVportTmplTriggerStatsRate struct {
	Inst struct {
...
func (p *VisibilityPacketCaptureObjectTemplatesDnsVportTmplTriggerStatsRate) GetId() string {
	return "1"
}

func (p *VisibilityPacketCaptureObjectTemplatesDnsVportTmplTriggerStatsRate) getPath() string {
	return "visibility/packet-capture/object-templates/dns_vport-tmpl/" + p.Inst.Dns_vport_tmpl_name + "/trigger-stats-rate"
}

func (p *VisibilityPacketCaptureObjectTemplatesDnsVportTmplTriggerStatsRate) Post(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("VisibilityPacketCaptureObjectTemplatesDnsVportTmplTriggerStatsRate::Post")
...
func (p *VisibilityPacketCaptureObjectTemplatesDnsVportTmplTriggerStatsRate) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("VisibilityPacketCaptureObjectTemplatesDnsVportTmplTriggerStatsRate::Get")
	headers := axapi.GenRequestHeader(authToken)
...
func (p *VisibilityPacketCaptureObjectTemplatesDnsVportTmplTriggerStatsRate) Put(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("VisibilityPacketCaptureObjectTemplatesDnsVportTmplTriggerStatsRate::Put")
	headers := axapi.GenRequestHeader(authToken)
	payloadBytes, err := axapi.SerializeToJson(p)
	if err != nil {
		logger.Println("Failed to serialize struct as json", err)
...
func (p *VisibilityPacketCaptureObjectTemplatesDnsVportTmplTriggerStatsRate) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("VisibilityPacketCaptureObjectTemplatesDnsVportTmplTriggerStatsRate::Delete")
	headers := axapi.GenRequestHeader(authToken)
