...
type HarmonyControllerProfile struct {
	Inst struct {
		...
		Force HarmonyControllerProfileForce493 `json:"force"`
		...
		ReSync HarmonyControllerProfileReSync494 `json:"re-sync"`

		Region string `json:"region"`

		SecretValue string `json:"secret-value"`

		ThunderMgmtIp HarmonyControllerProfileThunderMgmtIp495 `json:"thunder-mgmt-ip"`

		Tunnel HarmonyControllerProfileTunnel496 `json:"tunnel"`
...
type HarmonyControllerProfileForce493 struct {
	Deregister int `json:"deregister"`
}

type HarmonyControllerProfileReSync494 struct {
	SchemaRegistry int `json:"schema-registry"`
	AnalyticsBus   int `json:"analytics-bus"`
}

type HarmonyControllerProfileThunderMgmtIp495 struct {
	IpAddress string `json:"ip-address"`
	Ipv6Addr  string `json:"ipv6-addr"`
	Uuid      string `json:"uuid"`
}

type HarmonyControllerProfileTunnel496 struct {
