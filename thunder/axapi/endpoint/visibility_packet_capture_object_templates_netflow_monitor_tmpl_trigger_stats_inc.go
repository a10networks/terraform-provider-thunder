...
type VisibilityPacketCaptureObjectTemplatesNetflowMonitorTmplTriggerStatsInc struct {
	Inst struct {
...
func (p *VisibilityPacketCaptureObjectTemplatesNetflowMonitorTmplTriggerStatsInc) GetId() string {
	return "1"
}

func (p *VisibilityPacketCaptureObjectTemplatesNetflowMonitorTmplTriggerStatsInc) getPath() string {
	return "visibility/packet-capture/object-templates/netflow-monitor-tmpl/" + p.Inst.Netflow_monitor_tmpl_name + "/trigger-stats-inc"
}

func (p *VisibilityPacketCaptureObjectTemplatesNetflowMonitorTmplTriggerStatsInc) Post(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("VisibilityPacketCaptureObjectTemplatesNetflowMonitorTmplTriggerStatsInc::Post")
...
func (p *VisibilityPacketCaptureObjectTemplatesNetflowMonitorTmplTriggerStatsInc) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("VisibilityPacketCaptureObjectTemplatesNetflowMonitorTmplTriggerStatsInc::Get")
	headers := axapi.GenRequestHeader(authToken)
...
func (p *VisibilityPacketCaptureObjectTemplatesNetflowMonitorTmplTriggerStatsInc) Put(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("VisibilityPacketCaptureObjectTemplatesNetflowMonitorTmplTriggerStatsInc::Put")
	headers := axapi.GenRequestHeader(authToken)
	payloadBytes, err := axapi.SerializeToJson(p)
	if err != nil {
		logger.Println("Failed to serialize struct as json", err)
...
func (p *VisibilityPacketCaptureObjectTemplatesNetflowMonitorTmplTriggerStatsInc) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("VisibilityPacketCaptureObjectTemplatesNetflowMonitorTmplTriggerStatsInc::Delete")
	headers := axapi.GenRequestHeader(authToken)
