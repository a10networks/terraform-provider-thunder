...
type VisibilityPacketCaptureObjectTemplatesTemplGtpPlcyTmplTriggerStatsInc struct {
	Inst struct {
...
func (p *VisibilityPacketCaptureObjectTemplatesTemplGtpPlcyTmplTriggerStatsInc) GetId() string {
	return "1"
}

func (p *VisibilityPacketCaptureObjectTemplatesTemplGtpPlcyTmplTriggerStatsInc) getPath() string {
	return "visibility/packet-capture/object-templates/templ-gtp-plcy-tmpl/" + p.Inst.Templ_gtp_plcy_tmpl_name + "/trigger-stats-inc"
}

func (p *VisibilityPacketCaptureObjectTemplatesTemplGtpPlcyTmplTriggerStatsInc) Post(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("VisibilityPacketCaptureObjectTemplatesTemplGtpPlcyTmplTriggerStatsInc::Post")
...
func (p *VisibilityPacketCaptureObjectTemplatesTemplGtpPlcyTmplTriggerStatsInc) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("VisibilityPacketCaptureObjectTemplatesTemplGtpPlcyTmplTriggerStatsInc::Get")
	headers := axapi.GenRequestHeader(authToken)
...
func (p *VisibilityPacketCaptureObjectTemplatesTemplGtpPlcyTmplTriggerStatsInc) Put(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("VisibilityPacketCaptureObjectTemplatesTemplGtpPlcyTmplTriggerStatsInc::Put")
	headers := axapi.GenRequestHeader(authToken)
	payloadBytes, err := axapi.SerializeToJson(p)
	if err != nil {
		logger.Println("Failed to serialize struct as json", err)
...
func (p *VisibilityPacketCaptureObjectTemplatesTemplGtpPlcyTmplTriggerStatsInc) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("VisibilityPacketCaptureObjectTemplatesTemplGtpPlcyTmplTriggerStatsInc::Delete")
	headers := axapi.GenRequestHeader(authToken)
