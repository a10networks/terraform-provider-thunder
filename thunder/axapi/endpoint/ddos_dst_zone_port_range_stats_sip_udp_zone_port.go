...
type DdosDstZonePortRangeStats29 struct {
	Inst struct {
		...
		Stats DdosDstZonePortRangeStats29Stats `json:"stats"`

		ZoneName string
	} `json:"port-range"`
}

type DdosDstZonePortRangeStats29Stats struct {
	SipUdpZonePort DdosDstZonePortRangeStats29StatsSipUdpZonePort `json:"sip-udp-zone-port"`
}

type DdosDstZonePortRangeStats29StatsSipUdpZonePort struct {
...
func (p *DdosDstZonePortRangeStats29) GetId() string {
	return "1"
}

func (p *DdosDstZonePortRangeStats29) getPath() string {
	return "ddos/dst/zone/" + p.Inst.ZoneName + "/port-range/" + strconv.Itoa(p.Inst.PortRangeStart) + "+" + strconv.Itoa(p.Inst.PortRangeEnd) + "+" + p.Inst.Protocol + "/stats?sip-udp-zone-port=true"
}

func (p *DdosDstZonePortRangeStats29) Post(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortRangeStats29::Post")
...
func (p *DdosDstZonePortRangeStats29) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortRangeStats29::Get")
	headers := axapi.GenRequestHeader(authToken)
...
func (p *DdosDstZonePortRangeStats29) Put(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortRangeStats29::Put")
	headers := axapi.GenRequestHeader(authToken)
	payloadBytes, err := axapi.SerializeToJson(p)
	if err != nil {
		logger.Println("Failed to serialize struct as json", err)
...
func (p *DdosDstZonePortRangeStats29) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortRangeStats29::Delete")
	headers := axapi.GenRequestHeader(authToken)
