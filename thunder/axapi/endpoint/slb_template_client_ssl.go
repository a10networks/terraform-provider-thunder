...
type SlbTemplateClientSsl struct {
	Inst struct {
		...
		Ja4Enable int `json:"ja4-enable"`

		Ja4InsertHttpHeader string `json:"ja4-insert-http-header"`

		Ja4RejectClassList string `json:"ja4-reject-class-list"`

		Ja4RejectMaxNumberPerHost int `json:"ja4-reject-max-number-per-host"`

		Ja4Ttl int `json:"ja4-ttl" dval:"600"`
		...
		RequireSniCertMatched int `json:"require-sni-cert-matched"`

		RequireWebCategory int `json:"require-web-category"`

		SamplingEnable []SlbTemplateClientSslSamplingEnable `json:"sampling-enable"`
		...
		SessionKeyLoggingEnable int `json:"session-key-logging-enable"`
...
type SlbTemplateClientSslExceptionWebCategory struct {
	ExceptionCategory string `json:"exception-category"`
}
...
type SlbTemplateClientSslSamplingEnable struct {
...
type SlbTemplateClientSslWebCategory struct {
	BypassedCategory string `json:"bypassed-category"`
}
