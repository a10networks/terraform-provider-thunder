...
type DdosDstEntryPortStats12 struct {
	Inst struct {
		PortNum int `json:"port-num"`

		Protocol string `json:"protocol"`

		Stats DdosDstEntryPortStats12Stats `json:"stats"`

		DstEntryName string
	} `json:"port"`
}

type DdosDstEntryPortStats12Stats struct {
	HttpPort DdosDstEntryPortStats12StatsHttpPort `json:"http-port"`
}

type DdosDstEntryPortStats12StatsHttpPort struct {
...
func (p *DdosDstEntryPortStats12) GetId() string {
	return "1"
}

func (p *DdosDstEntryPortStats12) getPath() string {
	return "ddos/dst/entry/" + p.Inst.DstEntryName + "/port/" + strconv.Itoa(p.Inst.PortNum) + "+" + p.Inst.Protocol + "/stats?http-port=true"
}

func (p *DdosDstEntryPortStats12) Post(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstEntryPortStats12::Post")
...
func (p *DdosDstEntryPortStats12) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstEntryPortStats12::Get")
	headers := axapi.GenRequestHeader(authToken)
...
func (p *DdosDstEntryPortStats12) Put(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstEntryPortStats12::Put")
	headers := axapi.GenRequestHeader(authToken)
	payloadBytes, err := axapi.SerializeToJson(p)
	if err != nil {
		logger.Println("Failed to serialize struct as json", err)
...
func (p *DdosDstEntryPortStats12) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstEntryPortStats12::Delete")
	headers := axapi.GenRequestHeader(authToken)
