...
type OverlayTunnelVtepHostList struct {
	...
	RemoteIpv6Vtep string `json:"remote-ipv6-vtep"`
	Uuid           string `json:"uuid"`
}
...
type OverlayTunnelVtepRemoteIpv6AddressList struct {
	...
	GreKeepalive OverlayTunnelVtepRemoteIpv6AddressListGreKeepalive `json:"gre-keepalive"`
	UseGreKey    OverlayTunnelVtepRemoteIpv6AddressListUseGreKey    `json:"use-gre-key"`
	VniList      []OverlayTunnelVtepRemoteIpv6AddressListVniList    `json:"vni-list"`
}
...
type OverlayTunnelVtepRemoteIpv6AddressListGreKeepalive struct {
	RetryTime  int    `json:"retry-time" dval:"10"`
	RetryCount int    `json:"retry-count"`
	Uuid       string `json:"uuid"`
}

type OverlayTunnelVtepRemoteIpv6AddressListUseGreKey struct {
	GreKey int    `json:"gre-key"`
	Uuid   string `json:"uuid"`
}

type OverlayTunnelVtepRemoteIpv6AddressListVniList struct {
	Segment int    `json:"segment"`
	Uuid    string `json:"uuid"`
}
