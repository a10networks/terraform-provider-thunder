...
type DdosDnsCacheDomainGroupDomainListPolicyPacketCapturing struct {
	Inst struct {
		...
		Domain_list_policy_name string
...
func (p *DdosDnsCacheDomainGroupDomainListPolicyPacketCapturing) getPath() string {
	return "ddos/dns-cache/" + p.Inst.Dns_cache_name + "/domain-group/domain-list-policy/" + p.Inst.Domain_list_policy_name + "/packet-capturing"
}
