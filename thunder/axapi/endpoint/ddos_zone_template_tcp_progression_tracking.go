...
type DdosZoneTemplateTcpProgressionTracking struct {
    ...
    ConnectionTracking DdosZoneTemplateTcpProgressionTrackingConnectionTracking318 `json:"connection-tracking"`
    ...
    TimeWindowTracking DdosZoneTemplateTcpProgressionTrackingTimeWindowTracking319 `json:"time-window-tracking"`
...
type DdosZoneTemplateTcpProgressionTrackingConnectionTracking318 struct {
...
type DdosZoneTemplateTcpProgressionTrackingTimeWindowTracking319 struct {
...
func (p *DdosZoneTemplateTcpProgressionTracking) getPath() string{
    return "ddos/zone-template/tcp/" +p.Inst.Name + "/progression-tracking"
}
