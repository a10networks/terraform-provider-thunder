...
type DdosDstZonePortZoneServiceVirtualhostsVirtualhostOperOper struct {
	Ddos_entry_list       []DdosDstZonePortZoneServiceVirtualhostsVirtualhostOperOperDdos_entry_list `json:"ddos_entry_list"`
...
type DdosDstZonePortZoneServiceVirtualhostsVirtualhostOperOperDdos_entry_list struct {
	...
	HttpFilterRates        []DdosDstZonePortZoneServiceVirtualhostsVirtualhostOperOperDdos_entry_listHttpFilterRates   `json:"http-filter-rates"`
	ResponseSizeRates      []DdosDstZonePortZoneServiceVirtualhostsVirtualhostOperOperDdos_entry_listResponseSizeRates `json:"response-size-rates"`
	HwBlockedRules         []DdosDstZonePortZoneServiceVirtualhostsVirtualhostOperOperDdos_entry_listHwBlockedRules    `json:"hw-blocked-rules"`
	DebugStr               string                                                                                      `json:"debug-str"`
}

type DdosDstZonePortZoneServiceVirtualhostsVirtualhostOperOperDdos_entry_listHttpFilterRates struct {
...
type DdosDstZonePortZoneServiceVirtualhostsVirtualhostOperOperDdos_entry_listResponseSizeRates struct {
...
type DdosDstZonePortZoneServiceVirtualhostsVirtualhostOperOperDdos_entry_listHwBlockedRules struct {
	RuleDstIp       string `json:"rule-dst-ip"`
	HwBlockingState string `json:"hw-blocking-state"`
}

func (p *DdosDstZonePortZoneServiceVirtualhostsVirtualhostOper) GetId() string {
	return "1"
}

func (p *DdosDstZonePortZoneServiceVirtualhostsVirtualhostOper) getPath() string {

	return "ddos/dst/zone/" + p.ZoneName + "/port/zone-service/" + p.PortNum + "+" + p.Protocol + "/virtualhosts/virtualhost/" + p.Vhost + "/oper"
}

func (p *DdosDstZonePortZoneServiceVirtualhostsVirtualhostOper) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) (DataDdosDstZonePortZoneServiceVirtualhostsVirtualhostOper, error) {
	logger.Println("DdosDstZonePortZoneServiceVirtualhostsVirtualhostOper::Get")
	headers := axapi.GenRequestHeader(authToken)
	_, axResp, err := axapi.SendGet(host, p.getPath(), "", nil, headers, logger)
	var payload DataDdosDstZonePortZoneServiceVirtualhostsVirtualhostOper
	if err == nil {
		if len(axResp) > 0 {
