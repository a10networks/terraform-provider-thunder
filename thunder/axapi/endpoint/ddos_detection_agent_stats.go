...
type DdosDetectionAgentStatsStats struct {
	...
	XflowExtendPktRcv                 int `json:"xflow-extend-pkt-rcv"`
	XflowExtendByteRcv                int `json:"xflow-extend-byte-rcv"`
	XflowDstEntryMissExtendPktRcv     int `json:"xflow-dst-entry-miss-extend-pkt-rcv"`
