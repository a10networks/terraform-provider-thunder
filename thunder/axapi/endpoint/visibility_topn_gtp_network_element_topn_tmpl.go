...
type VisibilityTopnGtpNetworkElementTopnTmpl struct {
    ...
    Metrics VisibilityTopnGtpNetworkElementTopnTmplMetrics3133 `json:"metrics"`
...
type VisibilityTopnGtpNetworkElementTopnTmplMetrics3133 struct {
...
func (p *VisibilityTopnGtpNetworkElementTopnTmpl) GetId() string{
    return url.QueryEscape(p.Inst.Name)
}

func (p *VisibilityTopnGtpNetworkElementTopnTmpl) getPath() string{
    return "visibility/topn/gtp-network-element-topn-tmpl"
}

func (p *VisibilityTopnGtpNetworkElementTopnTmpl) Post(authToken string, host string, logger *axapi.ThunderLog) error {
    logger.Println("VisibilityTopnGtpNetworkElementTopnTmpl::Post")
...
func (p *VisibilityTopnGtpNetworkElementTopnTmpl) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
    logger.Println("VisibilityTopnGtpNetworkElementTopnTmpl::Get")
    headers := axapi.GenRequestHeader(authToken)
...
func (p *VisibilityTopnGtpNetworkElementTopnTmpl) Put(authToken string, host string, logger *axapi.ThunderLog) error {
    logger.Println("VisibilityTopnGtpNetworkElementTopnTmpl::Put")
    headers := axapi.GenRequestHeader(authToken)
    payloadBytes, err := axapi.SerializeToJson(p)
    if err != nil {
        logger.Println("Failed to serialize struct as json", err)
...
func (p *VisibilityTopnGtpNetworkElementTopnTmpl) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
    logger.Println("VisibilityTopnGtpNetworkElementTopnTmpl::Delete")
    headers := axapi.GenRequestHeader(authToken)
