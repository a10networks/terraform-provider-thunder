...
type DdosDstZoneSrcPortZoneSrcPortStats45 struct {
	Inst struct {
		PortNum int `json:"port-num"`

		Protocol string `json:"protocol"`

		Stats DdosDstZoneSrcPortZoneSrcPortStats45Stats `json:"stats"`

		ZoneName string
	} `json:"zone-src-port"`
}

type DdosDstZoneSrcPortZoneSrcPortStats45Stats struct {
	UdpZonePort DdosDstZoneSrcPortZoneSrcPortStats45StatsUdpZonePort `json:"udp-zone-port"`
}

type DdosDstZoneSrcPortZoneSrcPortStats45StatsUdpZonePort struct {
...
func (p *DdosDstZoneSrcPortZoneSrcPortStats45) GetId() string {
	return "1"
}

func (p *DdosDstZoneSrcPortZoneSrcPortStats45) getPath() string {
	return "ddos/dst/zone/" + p.Inst.ZoneName + "/src-port/zone-src-port/" + strconv.Itoa(p.Inst.PortNum) + "+" + p.Inst.Protocol + "/stats?udp-zone-port=true"
}

func (p *DdosDstZoneSrcPortZoneSrcPortStats45) Post(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZoneSrcPortZoneSrcPortStats45::Post")
...
func (p *DdosDstZoneSrcPortZoneSrcPortStats45) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZoneSrcPortZoneSrcPortStats45::Get")
	headers := axapi.GenRequestHeader(authToken)
...
func (p *DdosDstZoneSrcPortZoneSrcPortStats45) Put(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZoneSrcPortZoneSrcPortStats45::Put")
	headers := axapi.GenRequestHeader(authToken)
	payloadBytes, err := axapi.SerializeToJson(p)
	if err != nil {
		logger.Println("Failed to serialize struct as json", err)
...
func (p *DdosDstZoneSrcPortZoneSrcPortStats45) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZoneSrcPortZoneSrcPortStats45::Delete")
	headers := axapi.GenRequestHeader(authToken)
