...
type EnableManagementServiceSnmp struct {
	Inst struct {
		...
		LifCfg EnableManagementServiceSnmpLifCfg `json:"lif-cfg"`
...
type EnableManagementServiceSnmpAclV4List struct {
	...
	LifCfg      EnableManagementServiceSnmpAclV4ListLifCfg      `json:"lif-cfg"`
...
type EnableManagementServiceSnmpAclV4ListLifCfg struct {
	Lif string `json:"lif"`
}
...
type EnableManagementServiceSnmpAclV6List struct {
	...
	LifCfg      EnableManagementServiceSnmpAclV6ListLifCfg      `json:"lif-cfg"`
	Management  int                                             `json:"management"`
	AllDataIntf int                                             `json:"all-data-intf"`
	Uuid        string                                          `json:"uuid"`
	UserTag     string                                          `json:"user-tag"`
...
type EnableManagementServiceSnmpAclV6ListLifCfg struct {
	Lif string `json:"lif"`
}
...
type EnableManagementServiceSnmpLifCfg struct {
	Lif string `json:"lif"`
}
