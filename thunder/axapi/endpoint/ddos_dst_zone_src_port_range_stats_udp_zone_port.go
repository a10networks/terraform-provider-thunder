...
type DdosDstZoneSrcPortRangeStats41 struct {
	Inst struct {
		...
		Stats DdosDstZoneSrcPortRangeStats41Stats `json:"stats"`

		ZoneName string
	} `json:"src-port-range"`
}

type DdosDstZoneSrcPortRangeStats41Stats struct {
	UdpZonePort DdosDstZoneSrcPortRangeStats41StatsUdpZonePort `json:"udp-zone-port"`
}

type DdosDstZoneSrcPortRangeStats41StatsUdpZonePort struct {
...
func (p *DdosDstZoneSrcPortRangeStats41) GetId() string {
	return "1"
}

func (p *DdosDstZoneSrcPortRangeStats41) getPath() string {
	return "ddos/dst/zone/" + p.Inst.ZoneName + "/src-port-range/" + strconv.Itoa(p.Inst.SrcPortRangeStart) + "+" + strconv.Itoa(p.Inst.SrcPortRangeEnd) + "+" + p.Inst.Protocol + "/stats?udp-zone-port=true"
}

func (p *DdosDstZoneSrcPortRangeStats41) Post(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZoneSrcPortRangeStats41::Post")
...
func (p *DdosDstZoneSrcPortRangeStats41) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZoneSrcPortRangeStats41::Get")
	headers := axapi.GenRequestHeader(authToken)
...
func (p *DdosDstZoneSrcPortRangeStats41) Put(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZoneSrcPortRangeStats41::Put")
	headers := axapi.GenRequestHeader(authToken)
	payloadBytes, err := axapi.SerializeToJson(p)
	if err != nil {
		logger.Println("Failed to serialize struct as json", err)
...
func (p *DdosDstZoneSrcPortRangeStats41) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZoneSrcPortRangeStats41::Delete")
	headers := axapi.GenRequestHeader(authToken)
