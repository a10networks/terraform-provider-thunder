...
type SlbVirtualServerPortStats55 struct {
	Inst struct {
		PortNumber int `json:"port-number"`

		Protocol string `json:"protocol"`

		Stats SlbVirtualServerPortStats55Stats `json:"stats"`

		Virtual_server_name string
	} `json:"port"`
}

type SlbVirtualServerPortStats55Stats struct {
	Smtp_vport SlbVirtualServerPortStats55StatsSmtp_vport `json:"smtp_vport"`
}

type SlbVirtualServerPortStats55StatsSmtp_vport struct {
...
func (p *SlbVirtualServerPortStats55) GetId() string {
	return "1"
}

func (p *SlbVirtualServerPortStats55) getPath() string {
	return "slb/virtual-server/" + p.Inst.Virtual_server_name + "/port/" + strconv.Itoa(p.Inst.PortNumber) + "+" + p.Inst.Protocol + "/stats?smtp_vport=true"
}

func (p *SlbVirtualServerPortStats55) Post(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("SlbVirtualServerPortStats55::Post")
...
func (p *SlbVirtualServerPortStats55) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("SlbVirtualServerPortStats55::Get")
	headers := axapi.GenRequestHeader(authToken)
...
func (p *SlbVirtualServerPortStats55) Put(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("SlbVirtualServerPortStats55::Put")
	headers := axapi.GenRequestHeader(authToken)
	payloadBytes, err := axapi.SerializeToJson(p)
	if err != nil {
		logger.Println("Failed to serialize struct as json", err)
...
func (p *SlbVirtualServerPortStats55) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("SlbVirtualServerPortStats55::Delete")
	headers := axapi.GenRequestHeader(authToken)
