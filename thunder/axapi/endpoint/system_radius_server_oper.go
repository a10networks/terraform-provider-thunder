...
type SystemRadiusServerOperOper struct {
	...
	DerivedAttributeName   string                                             `json:"derived-attribute-name"`
	DerivedAttributeValue  string                                             `json:"derived-attribute-value"`
...
type SystemRadiusServerOperOperRadiusTableEntriesList struct {
	...
	DerivedAttrUsergroupValue string `json:"derived-attr-usergroup-value"`
	DerivedAttrUseridValue    string `json:"derived-attr-userid-value"`
