...
type DdosDstZonePortRangeStats30 struct {
	Inst struct {
		...
		Stats DdosDstZonePortRangeStats30Stats `json:"stats"`

		ZoneName string
	} `json:"port-range"`
}

type DdosDstZonePortRangeStats30Stats struct {
	TcpZonePort DdosDstZonePortRangeStats30StatsTcpZonePort `json:"tcp-zone-port"`
}

type DdosDstZonePortRangeStats30StatsTcpZonePort struct {
...
func (p *DdosDstZonePortRangeStats30) GetId() string {
	return "1"
}

func (p *DdosDstZonePortRangeStats30) getPath() string {
	return "ddos/dst/zone/" + p.Inst.ZoneName + "/port-range/" + strconv.Itoa(p.Inst.PortRangeStart) + "+" + strconv.Itoa(p.Inst.PortRangeEnd) + "+" + p.Inst.Protocol + "/stats?tcp-zone-port=true"
}

func (p *DdosDstZonePortRangeStats30) Post(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortRangeStats30::Post")
...
func (p *DdosDstZonePortRangeStats30) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortRangeStats30::Get")
	headers := axapi.GenRequestHeader(authToken)
...
func (p *DdosDstZonePortRangeStats30) Put(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortRangeStats30::Put")
	headers := axapi.GenRequestHeader(authToken)
	payloadBytes, err := axapi.SerializeToJson(p)
	if err != nil {
		logger.Println("Failed to serialize struct as json", err)
...
func (p *DdosDstZonePortRangeStats30) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortRangeStats30::Delete")
	headers := axapi.GenRequestHeader(authToken)
