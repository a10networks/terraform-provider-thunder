...
type DdosDstZoneSrcPortRangeOper struct {
    
    Oper DdosDstZoneSrcPortRangeOperOper `json:"oper"`
    PortInd DdosDstZoneSrcPortRangeOperPortInd `json:"port-ind"`
...
type DataDdosDstZoneSrcPortRangeOper struct {
    DtDdosDstZoneSrcPortRangeOper DdosDstZoneSrcPortRangeOper `json:"src-port-range"`
}


type DdosDstZoneSrcPortRangeOperOper struct {
    Ddos_entry_list []DdosDstZoneSrcPortRangeOperOperDdos_entry_list `json:"ddos_entry_list"`
...
type DdosDstZoneSrcPortRangeOperOperDdos_entry_list struct {
...
type DdosDstZoneSrcPortRangeOperPortInd struct {
    Oper DdosDstZoneSrcPortRangeOperPortIndOper `json:"oper"`
}


type DdosDstZoneSrcPortRangeOperPortIndOper struct {
    Indicators []DdosDstZoneSrcPortRangeOperPortIndOperIndicators `json:"indicators"`
...
type DdosDstZoneSrcPortRangeOperPortIndOperIndicators struct {
    IndicatorName string `json:"indicator-name"`
    IndicatorIndex int `json:"indicator-index"`
    Rate string `json:"rate"`
    IndicatorCfg []DdosDstZoneSrcPortRangeOperPortIndOperIndicatorsIndicatorCfg `json:"indicator-cfg"`
}


type DdosDstZoneSrcPortRangeOperPortIndOperIndicatorsIndicatorCfg struct {
    Level int `json:"level"`
    ZoneThreshold string `json:"zone-threshold"`
    SourceThreshold string `json:"source-threshold"`
}

func (p *DdosDstZoneSrcPortRangeOper) GetId() string{
    return "1"
}

func (p *DdosDstZoneSrcPortRangeOper) getPath() string{
    
    return "ddos/dst/zone/" +p.ZoneName + "/src-port-range/" +strconv.Itoa(p.SrcPortRangeStart)+"+" +strconv.Itoa(p.SrcPortRangeEnd)+"+"+p.Protocol+"/oper"
}

func (p *DdosDstZoneSrcPortRangeOper) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) (DataDdosDstZoneSrcPortRangeOper,error) {
logger.Println("DdosDstZoneSrcPortRangeOper::Get")
    headers := axapi.GenRequestHeader(authToken)
    _, axResp, err := axapi.SendGet(host, p.getPath(), "", nil, headers, logger)
    var payload DataDdosDstZoneSrcPortRangeOper
    if err == nil {
        if len(axResp) > 0{
