...
type RouterBgpNeighborIpv6Neighbor struct {
    ...
    DistributeLists []RouterBgpNeighborIpv6NeighborDistributeLists `json:"distribute-lists"`
    ...
    NeighborFilterLists []RouterBgpNeighborIpv6NeighborNeighborFilterLists `json:"neighbor-filter-lists"`
    NeighborIpv6 string `json:"neighbor-ipv6"`
    NeighborPrefixLists []RouterBgpNeighborIpv6NeighborNeighborPrefixLists `json:"neighbor-prefix-lists"`
    NeighborRouteMapLists []RouterBgpNeighborIpv6NeighborNeighborRouteMapLists `json:"neighbor-route-map-lists"`
...
func (p *RouterBgpNeighborIpv6Neighbor) GetId() string{
    return p.Inst.NeighborIpv6
}

func (p *RouterBgpNeighborIpv6Neighbor) getPath() string{
    return "router/bgp/" +p.Inst.AsNumber + "/neighbor/ipv6-neighbor"
}

func (p *RouterBgpNeighborIpv6Neighbor) Post(authToken string, host string, logger *axapi.ThunderLog) error {
    logger.Println("RouterBgpNeighborIpv6Neighbor::Post")
...
func (p *RouterBgpNeighborIpv6Neighbor) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
    logger.Println("RouterBgpNeighborIpv6Neighbor::Get")
    headers := axapi.GenRequestHeader(authToken)
...
func (p *RouterBgpNeighborIpv6Neighbor) Put(authToken string, host string, logger *axapi.ThunderLog) error {
    logger.Println("RouterBgpNeighborIpv6Neighbor::Put")
    headers := axapi.GenRequestHeader(authToken)
    payloadBytes, err := axapi.SerializeToJson(p)
    if err != nil {
        logger.Println("Failed to serialize struct as json", err)
...
func (p *RouterBgpNeighborIpv6Neighbor) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
    logger.Println("RouterBgpNeighborIpv6Neighbor::Delete")
    headers := axapi.GenRequestHeader(authToken)
