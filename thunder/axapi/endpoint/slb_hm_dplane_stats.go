...
type SlbHmDplaneStatsStats struct {
	...
	Curr_ready_to_free                   int `json:"curr_ready_to_free"`
	...
	Err_entry_create_slb_failed          int `json:"err_entry_create_slb_failed"`
	...
	Total_start_server_conn_err          int `json:"total_start_server_conn_err"`
