...
type DdosDstEntryIpProtoStats struct {
	Inst struct {

    PortNum int `json:"port-num"`
    Stats DdosDstEntryIpProtoStatsStats `json:"stats"`
    DstEntryName string 
...
type DdosDstEntryIpProtoStatsStats struct {
    OtherIpproto DdosDstEntryIpProtoStatsStatsOtherIpproto `json:"other-ipproto"`
}


type DdosDstEntryIpProtoStatsStatsOtherIpproto struct {
...
func (p *DdosDstEntryIpProtoStats) GetId() string{
    return "1"
}

func (p *DdosDstEntryIpProtoStats) getPath() string{
    return "ddos/dst/entry/" +p.Inst.DstEntryName + "/ip-proto/" +strconv.Itoa(p.Inst.PortNum)+"/stats?other-ipproto=true"
}

func (p *DdosDstEntryIpProtoStats) Post(authToken string, host string, logger *axapi.ThunderLog) error {
    logger.Println("DdosDstEntryIpProtoStats::Post")
...
func (p *DdosDstEntryIpProtoStats) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
    logger.Println("DdosDstEntryIpProtoStats::Get")
    headers := axapi.GenRequestHeader(authToken)
...
func (p *DdosDstEntryIpProtoStats) Put(authToken string, host string, logger *axapi.ThunderLog) error {
    logger.Println("DdosDstEntryIpProtoStats::Put")
    headers := axapi.GenRequestHeader(authToken)
    payloadBytes, err := axapi.SerializeToJson(p)
    if err != nil {
        logger.Println("Failed to serialize struct as json", err)
...
func (p *DdosDstEntryIpProtoStats) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
    logger.Println("DdosDstEntryIpProtoStats::Delete")
    headers := axapi.GenRequestHeader(authToken)
