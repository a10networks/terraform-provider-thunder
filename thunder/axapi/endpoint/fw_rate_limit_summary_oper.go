...
type FwRateLimitSummaryOperOper struct {
	...
	Total_num_entries_allocated                 int `json:"total_num_entries_allocated"`
	Total_num_entries_freed                     int `json:"total_num_entries_freed"`
	...
	Total_entries_scope_radius_usergroup        int `json:"total_entries_scope_radius_usergroup"`
	Total_entries_scope_radius_userid           int `json:"total_entries_scope_radius_userid"`
	...
	Total_entries_scope_parent_radius_usergroup int `json:"total_entries_scope_parent_radius_usergroup"`
	Total_entries_scope_parent_radius_userid    int `json:"total_entries_scope_parent_radius_userid"`
}
