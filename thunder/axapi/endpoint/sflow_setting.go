...
type SflowSetting struct {
	Inst struct {
		...
		DdosSourceIdExport int `json:"ddos-source-id-export"`

		DefaultCounterPollingMtu int `json:"default-counter-polling-mtu" dval:"1500"`

		EnlargeZoneName int `json:"enlarge-zone-name"`

		LocalCollection string `json:"local-collection" dval:"disable"`
		...
		OneBlkPerPkt int `json:"one-blk-per-pkt"`
		...
		SamplingRateLimit int `json:"sampling-rate-limit" dval:"1000"`
