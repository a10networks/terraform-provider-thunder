...
type DdosDstEntryPortStats struct {
	Inst struct {
		PortNum int `json:"port-num"`

		Protocol string `json:"protocol"`

		Stats DdosDstEntryPortStatsStats `json:"stats"`

		DstEntryName string
	} `json:"port"`
}

type DdosDstEntryPortStatsStats struct {
	DnsTcpPort DdosDstEntryPortStatsStatsDnsTcpPort `json:"dns-tcp-port"`
}

type DdosDstEntryPortStatsStatsDnsTcpPort struct {
...
func (p *DdosDstEntryPortStats) GetId() string {
	return "1"
}

func (p *DdosDstEntryPortStats) getPath() string {
	return "ddos/dst/entry/" + p.Inst.DstEntryName + "/port/" + strconv.Itoa(p.Inst.PortNum) + "+" + p.Inst.Protocol + "/stats?dns-tcp-port=true"
}

func (p *DdosDstEntryPortStats) Post(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstEntryPortStats::Post")
...
func (p *DdosDstEntryPortStats) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstEntryPortStats::Get")
	headers := axapi.GenRequestHeader(authToken)
...
func (p *DdosDstEntryPortStats) Put(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstEntryPortStats::Put")
	headers := axapi.GenRequestHeader(authToken)
	payloadBytes, err := axapi.SerializeToJson(p)
	if err != nil {
		logger.Println("Failed to serialize struct as json", err)
...
func (p *DdosDstEntryPortStats) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstEntryPortStats::Delete")
	headers := axapi.GenRequestHeader(authToken)
