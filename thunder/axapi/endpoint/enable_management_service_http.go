...
type EnableManagementServiceHttp struct {
	Inst struct {
		...
		LifCfg EnableManagementServiceHttpLifCfg `json:"lif-cfg"`
...
type EnableManagementServiceHttpAclV4List struct {
	...
	LifCfg      EnableManagementServiceHttpAclV4ListLifCfg      `json:"lif-cfg"`
...
type EnableManagementServiceHttpAclV4ListLifCfg struct {
	Lif string `json:"lif"`
}
...
type EnableManagementServiceHttpAclV6List struct {
	...
	LifCfg      EnableManagementServiceHttpAclV6ListLifCfg      `json:"lif-cfg"`
	Management  int                                             `json:"management"`
	AllDataIntf int                                             `json:"all-data-intf"`
	Uuid        string                                          `json:"uuid"`
	UserTag     string                                          `json:"user-tag"`
...
type EnableManagementServiceHttpAclV6ListLifCfg struct {
	Lif string `json:"lif"`
}
...
type EnableManagementServiceHttpLifCfg struct {
	Lif string `json:"lif"`
}
