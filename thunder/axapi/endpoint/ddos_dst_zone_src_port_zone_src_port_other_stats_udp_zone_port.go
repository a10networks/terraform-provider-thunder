...
type DdosDstZoneSrcPortZoneSrcPortOtherStats42 struct {
	Inst struct {
		PortOther string `json:"port-other"`

		Protocol string `json:"protocol"`

		Stats DdosDstZoneSrcPortZoneSrcPortOtherStats42Stats `json:"stats"`

		ZoneName string
	} `json:"zone-src-port-other"`
}

type DdosDstZoneSrcPortZoneSrcPortOtherStats42Stats struct {
	UdpZonePort DdosDstZoneSrcPortZoneSrcPortOtherStats42StatsUdpZonePort `json:"udp-zone-port"`
}

type DdosDstZoneSrcPortZoneSrcPortOtherStats42StatsUdpZonePort struct {
...
func (p *DdosDstZoneSrcPortZoneSrcPortOtherStats42) GetId() string {
	return "1"
}

func (p *DdosDstZoneSrcPortZoneSrcPortOtherStats42) getPath() string {
	return "ddos/dst/zone/" + p.Inst.ZoneName + "/src-port/zone-src-port-other/" + p.Inst.PortOther + "+" + p.Inst.Protocol + "/stats?udp-zone-port=true"
}

func (p *DdosDstZoneSrcPortZoneSrcPortOtherStats42) Post(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZoneSrcPortZoneSrcPortOtherStats42::Post")
...
func (p *DdosDstZoneSrcPortZoneSrcPortOtherStats42) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZoneSrcPortZoneSrcPortOtherStats42::Get")
	headers := axapi.GenRequestHeader(authToken)
...
func (p *DdosDstZoneSrcPortZoneSrcPortOtherStats42) Put(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZoneSrcPortZoneSrcPortOtherStats42::Put")
	headers := axapi.GenRequestHeader(authToken)
	payloadBytes, err := axapi.SerializeToJson(p)
	if err != nil {
		logger.Println("Failed to serialize struct as json", err)
...
func (p *DdosDstZoneSrcPortZoneSrcPortOtherStats42) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZoneSrcPortZoneSrcPortOtherStats42::Delete")
	headers := axapi.GenRequestHeader(authToken)
