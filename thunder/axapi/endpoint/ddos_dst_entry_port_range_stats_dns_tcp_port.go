...
type DdosDstEntryPortRangeStats struct {
	Inst struct {
		...
		Stats DdosDstEntryPortRangeStatsStats `json:"stats"`

		DstEntryName string
	} `json:"port-range"`
}

type DdosDstEntryPortRangeStatsStats struct {
	DnsTcpPort DdosDstEntryPortRangeStatsStatsDnsTcpPort `json:"dns-tcp-port"`
}

type DdosDstEntryPortRangeStatsStatsDnsTcpPort struct {
...
func (p *DdosDstEntryPortRangeStats) GetId() string {
	return "1"
}

func (p *DdosDstEntryPortRangeStats) getPath() string {
	return "ddos/dst/entry/" + p.Inst.DstEntryName + "/port-range/" + strconv.Itoa(p.Inst.PortRangeStart) + "+" + strconv.Itoa(p.Inst.PortRangeEnd) + "+" + p.Inst.Protocol + "/stats?dns-tcp-port=true"
}

func (p *DdosDstEntryPortRangeStats) Post(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstEntryPortRangeStats::Post")
...
func (p *DdosDstEntryPortRangeStats) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstEntryPortRangeStats::Get")
	headers := axapi.GenRequestHeader(authToken)
...
func (p *DdosDstEntryPortRangeStats) Put(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstEntryPortRangeStats::Put")
	headers := axapi.GenRequestHeader(authToken)
	payloadBytes, err := axapi.SerializeToJson(p)
	if err != nil {
		logger.Println("Failed to serialize struct as json", err)
...
func (p *DdosDstEntryPortRangeStats) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstEntryPortRangeStats::Delete")
	headers := axapi.GenRequestHeader(authToken)
