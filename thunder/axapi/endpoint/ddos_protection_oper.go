...
type DdosProtectionOperOper struct {
	...
	SrcZonePortEntryOverflowWarning       string `json:"src-zone-port-entry-overflow-warning"`
	SrcZonePortEntryWarningThreshold      int    `json:"src-zone-port-entry-warning-threshold"`
	SrcZonePortEntryClistWarningThreshold int    `json:"src-zone-port-entry-clist-warning-threshold"`
