...
type TemplateGtpPolicyStats struct {
	Name string `json:"name"`

	Stats TemplateGtpPolicyStatsStats `json:"stats"`
}
type DataTemplateGtpPolicyStats struct {
	DtTemplateGtpPolicyStats TemplateGtpPolicyStats `json:"gtp-policy"`
}

type TemplateGtpPolicyStatsStats struct {
	...
	GtpV2CLoadContrInfoExceed                      int `json:"gtp-v2-c-load-contr-info-exceed"`
	...
	GtpV0CMessageSkippedMsisdnFilteringNoImsi      int `json:"gtp-v0-c-message-skipped-msisdn-filtering-no-imsi"`
	GtpV1CMessageSkippedMsisdnFilteringNoImsi      int `json:"gtp-v1-c-message-skipped-msisdn-filtering-no-imsi"`
	GtpV2CMessageSkippedMsisdnFilteringNoImsi      int `json:"gtp-v2-c-message-skipped-msisdn-filtering-no-imsi"`
	...
	DropVldSanityGtpV2CMessageWithTeidZeroExpected int `json:"drop-vld-sanity-gtp-v2-c-message-with-teid-zero-expected"`
	DropVldSanityGtpV1CMessageWithTeidZeroExpected int `json:"drop-vld-sanity-gtp-v1-c-message-with-teid-zero-expected"`
	DropVldSanityGtpV0CMessageWithTeidZeroExpected int `json:"drop-vld-sanity-gtp-v0-c-message-with-teid-zero-expected"`
	...
	DropVldGtpV0CMessageSkippedApnFilteringNoApn   int `json:"drop-vld-gtp-v0-c-message-skipped-apn-filtering-no-apn"`
	DropVldGtpV1CMessageSkippedApnFilteringNoApn   int `json:"drop-vld-gtp-v1-c-message-skipped-apn-filtering-no-apn"`
	DropVldGtpV2CMessageSkippedApnFilteringNoApn   int `json:"drop-vld-gtp-v2-c-message-skipped-apn-filtering-no-apn"`
...
func (p *TemplateGtpPolicyStats) GetId() string {
	return "1"
}

func (p *TemplateGtpPolicyStats) getPath() string {
	return "template/gtp-policy/" + p.Name + "/stats"
}

func (p *TemplateGtpPolicyStats) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) (DataTemplateGtpPolicyStats, error) {
	logger.Println("TemplateGtpPolicyStats::Get")
	headers := axapi.GenRequestHeader(authToken)
	_, axResp, err := axapi.SendGet(host, p.getPath(), "", nil, headers, logger)
	var payload DataTemplateGtpPolicyStats
	if err == nil {
		if len(axResp) > 0 {
