...
type SlbVirtualServerPortStats50Stats struct {
    Http_vport SlbVirtualServerPortStats50StatsHttp_vport `json:"http_vport"`
}


type SlbVirtualServerPortStats50StatsHttp_vport struct {
    ...
    Curr_http3_conn int `json:"curr_http3_conn"`
    Total_http3_conn int `json:"total_http3_conn"`
    Peak_http3_conn int `json:"peak_http3_conn"`
    Total_http3_bytes int `json:"total_http3_bytes"`
    Http3_control_bytes int `json:"http3_control_bytes"`
    Http3_header_bytes int `json:"http3_header_bytes"`
    Http3_data_bytes int `json:"http3_data_bytes"`
    Http3_goaway_received int `json:"http3_goaway_received"`
    Http3_goaway_sent int `json:"http3_goaway_sent"`
    Http3_stream_closed int `json:"http3_stream_closed"`
}
...
func (p *SlbVirtualServerPortStats50) getPath() string{
    return "slb/virtual-server/" +p.Inst.Name + "/port/" +strconv.Itoa(p.Inst.PortNumber)+"+"+p.Inst.Protocol+"/stats?http_vport=true"
}
