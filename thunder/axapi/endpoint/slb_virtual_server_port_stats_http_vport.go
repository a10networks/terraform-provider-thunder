...
type SlbVirtualServerPortStats51 struct {
	Inst struct {
		PortNumber int `json:"port-number"`

		Protocol string `json:"protocol"`

		Stats SlbVirtualServerPortStats51Stats `json:"stats"`

		Virtual_server_name string
	} `json:"port"`
}

type SlbVirtualServerPortStats51Stats struct {
	Http_vport SlbVirtualServerPortStats51StatsHttp_vport `json:"http_vport"`
}

type SlbVirtualServerPortStats51StatsHttp_vport struct {
...
func (p *SlbVirtualServerPortStats51) GetId() string {
	return "1"
}

func (p *SlbVirtualServerPortStats51) getPath() string {
	return "slb/virtual-server/" + p.Inst.Virtual_server_name + "/port/" + strconv.Itoa(p.Inst.PortNumber) + "+" + p.Inst.Protocol + "/stats?http_vport=true"
}

func (p *SlbVirtualServerPortStats51) Post(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("SlbVirtualServerPortStats51::Post")
...
func (p *SlbVirtualServerPortStats51) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("SlbVirtualServerPortStats51::Get")
	headers := axapi.GenRequestHeader(authToken)
...
func (p *SlbVirtualServerPortStats51) Put(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("SlbVirtualServerPortStats51::Put")
	headers := axapi.GenRequestHeader(authToken)
	payloadBytes, err := axapi.SerializeToJson(p)
	if err != nil {
		logger.Println("Failed to serialize struct as json", err)
...
func (p *SlbVirtualServerPortStats51) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("SlbVirtualServerPortStats51::Delete")
	headers := axapi.GenRequestHeader(authToken)
