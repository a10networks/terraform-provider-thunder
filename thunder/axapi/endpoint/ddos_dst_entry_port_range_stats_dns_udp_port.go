...
type DdosDstEntryPortRangeStats4 struct {
	Inst struct {
		...
		Stats DdosDstEntryPortRangeStats4Stats `json:"stats"`

		DstEntryName string
	} `json:"port-range"`
}

type DdosDstEntryPortRangeStats4Stats struct {
	DnsUdpPort DdosDstEntryPortRangeStats4StatsDnsUdpPort `json:"dns-udp-port"`
}

type DdosDstEntryPortRangeStats4StatsDnsUdpPort struct {
...
func (p *DdosDstEntryPortRangeStats4) GetId() string {
	return "1"
}

func (p *DdosDstEntryPortRangeStats4) getPath() string {
	return "ddos/dst/entry/" + p.Inst.DstEntryName + "/port-range/" + strconv.Itoa(p.Inst.PortRangeStart) + "+" + strconv.Itoa(p.Inst.PortRangeEnd) + "+" + p.Inst.Protocol + "/stats?dns-udp-port=true"
}

func (p *DdosDstEntryPortRangeStats4) Post(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstEntryPortRangeStats4::Post")
...
func (p *DdosDstEntryPortRangeStats4) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstEntryPortRangeStats4::Get")
	headers := axapi.GenRequestHeader(authToken)
...
func (p *DdosDstEntryPortRangeStats4) Put(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstEntryPortRangeStats4::Put")
	headers := axapi.GenRequestHeader(authToken)
	payloadBytes, err := axapi.SerializeToJson(p)
	if err != nil {
		logger.Println("Failed to serialize struct as json", err)
...
func (p *DdosDstEntryPortRangeStats4) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstEntryPortRangeStats4::Delete")
	headers := axapi.GenRequestHeader(authToken)
