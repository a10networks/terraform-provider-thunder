...
type DdosDstEntryPortStats14 struct {
	Inst struct {
		PortNum int `json:"port-num"`

		Protocol string `json:"protocol"`

		Stats DdosDstEntryPortStats14Stats `json:"stats"`

		DstEntryName string
	} `json:"port"`
}

type DdosDstEntryPortStats14Stats struct {
	SipTcpPort DdosDstEntryPortStats14StatsSipTcpPort `json:"sip-tcp-port"`
}

type DdosDstEntryPortStats14StatsSipTcpPort struct {
...
func (p *DdosDstEntryPortStats14) GetId() string {
	return "1"
}

func (p *DdosDstEntryPortStats14) getPath() string {
	return "ddos/dst/entry/" + p.Inst.DstEntryName + "/port/" + strconv.Itoa(p.Inst.PortNum) + "+" + p.Inst.Protocol + "/stats?sip-tcp-port=true"
}

func (p *DdosDstEntryPortStats14) Post(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstEntryPortStats14::Post")
...
func (p *DdosDstEntryPortStats14) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstEntryPortStats14::Get")
	headers := axapi.GenRequestHeader(authToken)
...
func (p *DdosDstEntryPortStats14) Put(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstEntryPortStats14::Put")
	headers := axapi.GenRequestHeader(authToken)
	payloadBytes, err := axapi.SerializeToJson(p)
	if err != nil {
		logger.Println("Failed to serialize struct as json", err)
...
func (p *DdosDstEntryPortStats14) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstEntryPortStats14::Delete")
	headers := axapi.GenRequestHeader(authToken)
