...
type GslbServiceIp struct {
	Inst struct {
		...
		ServiceList []GslbServiceIpServiceList `json:"service-list"`
...
type GslbServiceIpServiceList struct {
	PortNum                    int                                      `json:"port-num"`
	PortProto                  string                                   `json:"port-proto"`
	...
	Uuid                       string                                   `json:"uuid"`
	UserTag                    string                                   `json:"user-tag"`
	SamplingEnable             []GslbServiceIpServiceListSamplingEnable `json:"sampling-enable"`
}

type GslbServiceIpServiceListSamplingEnable struct {
	Counters1 string `json:"counters1"`
}
