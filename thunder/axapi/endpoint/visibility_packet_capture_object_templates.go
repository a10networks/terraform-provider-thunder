...
type VisibilityPacketCaptureObjectTemplates struct {
	Inst struct {
		...
		RuleSetRuleTmplList []VisibilityPacketCaptureObjectTemplatesRuleSetRuleTmplList `json:"rule-set-rule-tmpl-list"`
		...
		SlbServiceTmplList []VisibilityPacketCaptureObjectTemplatesSlbServiceTmplList `json:"slb-service-tmpl-list"`
...
type VisibilityPacketCaptureObjectTemplatesRuleSetRuleTmplList struct {
	Name                 string                                                                        `json:"name"`
	CaptureConfig        string                                                                        `json:"capture-config"`
	Uuid                 string                                                                        `json:"uuid"`
	UserTag              string                                                                        `json:"user-tag"`
	TriggerStatsSeverity VisibilityPacketCaptureObjectTemplatesRuleSetRuleTmplListTriggerStatsSeverity `json:"trigger-stats-severity"`
	TriggerStatsInc      VisibilityPacketCaptureObjectTemplatesRuleSetRuleTmplListTriggerStatsInc      `json:"trigger-stats-inc"`
	TriggerStatsRate     VisibilityPacketCaptureObjectTemplatesRuleSetRuleTmplListTriggerStatsRate     `json:"trigger-stats-rate"`
}

type VisibilityPacketCaptureObjectTemplatesRuleSetRuleTmplListTriggerStatsSeverity struct {
	Error         int    `json:"error"`
	ErrorAlert    int    `json:"error-alert"`
	ErrorWarning  int    `json:"error-warning"`
	ErrorCritical int    `json:"error-critical"`
...
type VisibilityPacketCaptureObjectTemplatesRuleSetRuleTmplListTriggerStatsInc struct {
	SynCookieVerificationFailed int    `json:"syn-cookie-verification-failed"`
	Uuid                        string `json:"uuid"`
}

type VisibilityPacketCaptureObjectTemplatesRuleSetRuleTmplListTriggerStatsRate struct {
	ThresholdExceededBy         int    `json:"threshold-exceeded-by" dval:"5"`
	Duration                    int    `json:"duration" dval:"60"`
	SynCookieVerificationFailed int    `json:"syn-cookie-verification-failed"`
	Uuid                        string `json:"uuid"`
...
type VisibilityPacketCaptureObjectTemplatesSlbServiceTmplList struct {
	Name                 string                                                                       `json:"name"`
	CaptureConfig        string                                                                       `json:"capture-config"`
	Uuid                 string                                                                       `json:"uuid"`
	UserTag              string                                                                       `json:"user-tag"`
	TriggerStatsSeverity VisibilityPacketCaptureObjectTemplatesSlbServiceTmplListTriggerStatsSeverity `json:"trigger-stats-severity"`
	TriggerStatsInc      VisibilityPacketCaptureObjectTemplatesSlbServiceTmplListTriggerStatsInc      `json:"trigger-stats-inc"`
	TriggerStatsRate     VisibilityPacketCaptureObjectTemplatesSlbServiceTmplListTriggerStatsRate     `json:"trigger-stats-rate"`
}

type VisibilityPacketCaptureObjectTemplatesSlbServiceTmplListTriggerStatsSeverity struct {
	Error         int    `json:"error"`
	ErrorAlert    int    `json:"error-alert"`
	ErrorWarning  int    `json:"error-warning"`
	ErrorCritical int    `json:"error-critical"`
...
type VisibilityPacketCaptureObjectTemplatesSlbServiceTmplListTriggerStatsInc struct {
	Es_resp_300 int    `json:"es_resp_300"`
	Es_resp_400 int    `json:"es_resp_400"`
	Es_resp_500 int    `json:"es_resp_500"`
	Resp3xx     int    `json:"resp-3xx"`
...
type VisibilityPacketCaptureObjectTemplatesSlbServiceTmplListTriggerStatsRate struct {
	ThresholdExceededBy int    `json:"threshold-exceeded-by" dval:"5"`
	Duration            int    `json:"duration" dval:"60"`
	Es_resp_300         int    `json:"es_resp_300"`
	Es_resp_400         int    `json:"es_resp_400"`
