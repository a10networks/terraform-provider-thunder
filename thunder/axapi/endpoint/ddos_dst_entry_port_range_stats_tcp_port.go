...
type DdosDstEntryPortRangeStats9 struct {
	Inst struct {
		...
		Stats DdosDstEntryPortRangeStats9Stats `json:"stats"`

		DstEntryName string
	} `json:"port-range"`
}

type DdosDstEntryPortRangeStats9Stats struct {
	TcpPort DdosDstEntryPortRangeStats9StatsTcpPort `json:"tcp-port"`
}

type DdosDstEntryPortRangeStats9StatsTcpPort struct {
...
func (p *DdosDstEntryPortRangeStats9) GetId() string {
	return "1"
}

func (p *DdosDstEntryPortRangeStats9) getPath() string {
	return "ddos/dst/entry/" + p.Inst.DstEntryName + "/port-range/" + strconv.Itoa(p.Inst.PortRangeStart) + "+" + strconv.Itoa(p.Inst.PortRangeEnd) + "+" + p.Inst.Protocol + "/stats?tcp-port=true"
}

func (p *DdosDstEntryPortRangeStats9) Post(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstEntryPortRangeStats9::Post")
...
func (p *DdosDstEntryPortRangeStats9) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstEntryPortRangeStats9::Get")
	headers := axapi.GenRequestHeader(authToken)
...
func (p *DdosDstEntryPortRangeStats9) Put(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstEntryPortRangeStats9::Put")
	headers := axapi.GenRequestHeader(authToken)
	payloadBytes, err := axapi.SerializeToJson(p)
	if err != nil {
		logger.Println("Failed to serialize struct as json", err)
...
func (p *DdosDstEntryPortRangeStats9) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstEntryPortRangeStats9::Delete")
	headers := axapi.GenRequestHeader(authToken)
