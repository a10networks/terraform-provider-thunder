...
type DdosDstZoneIpProtoProtoTcpUdpOper struct {
	IpFilteringPolicyStatistics DdosDstZoneIpProtoProtoTcpUdpOperIpFilteringPolicyStatistics `json:"ip-filtering-policy-statistics"`
...
type DdosDstZoneIpProtoProtoTcpUdpOperIpFilteringPolicyStatistics struct {
	Oper DdosDstZoneIpProtoProtoTcpUdpOperIpFilteringPolicyStatisticsOper `json:"oper"`
}

type DdosDstZoneIpProtoProtoTcpUdpOperIpFilteringPolicyStatisticsOper struct {
	RuleList []DdosDstZoneIpProtoProtoTcpUdpOperIpFilteringPolicyStatisticsOperRuleList `json:"rule-list"`
}

type DdosDstZoneIpProtoProtoTcpUdpOperIpFilteringPolicyStatisticsOperRuleList struct {
	Seq                   int `json:"seq"`
	Hits                  int `json:"hits"`
