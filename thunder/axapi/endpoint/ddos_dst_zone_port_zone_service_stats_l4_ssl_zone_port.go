...
type DdosDstZonePortZoneServiceStats35 struct {
	Inst struct {
		PortNum int `json:"port-num"`

		Protocol string `json:"protocol"`

		Stats DdosDstZonePortZoneServiceStats35Stats `json:"stats"`

		ZoneName string
	} `json:"zone-service"`
}

type DdosDstZonePortZoneServiceStats35Stats struct {
	L4SslZonePort DdosDstZonePortZoneServiceStats35StatsL4SslZonePort `json:"l4-ssl-zone-port"`
}

type DdosDstZonePortZoneServiceStats35StatsL4SslZonePort struct {
...
func (p *DdosDstZonePortZoneServiceStats35) GetId() string {
	return "1"
}

func (p *DdosDstZonePortZoneServiceStats35) getPath() string {
	return "ddos/dst/zone/" + p.Inst.ZoneName + "/port/zone-service/" + strconv.Itoa(p.Inst.PortNum) + "+" + p.Inst.Protocol + "/stats?l4-ssl-zone-port=true"
}

func (p *DdosDstZonePortZoneServiceStats35) Post(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortZoneServiceStats35::Post")
...
func (p *DdosDstZonePortZoneServiceStats35) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortZoneServiceStats35::Get")
	headers := axapi.GenRequestHeader(authToken)
...
func (p *DdosDstZonePortZoneServiceStats35) Put(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortZoneServiceStats35::Put")
	headers := axapi.GenRequestHeader(authToken)
	payloadBytes, err := axapi.SerializeToJson(p)
	if err != nil {
		logger.Println("Failed to serialize struct as json", err)
...
func (p *DdosDstZonePortZoneServiceStats35) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortZoneServiceStats35::Delete")
	headers := axapi.GenRequestHeader(authToken)
