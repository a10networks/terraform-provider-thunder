...
type DdosDstZoneSrcPortZoneSrcPortOper struct {
    
    Oper DdosDstZoneSrcPortZoneSrcPortOperOper `json:"oper"`
    PortInd DdosDstZoneSrcPortZoneSrcPortOperPortInd `json:"port-ind"`
    PortNum int `json:"port-num"`
    Protocol string `json:"protocol"`
    ZoneName string 

}
type DataDdosDstZoneSrcPortZoneSrcPortOper struct {
    DtDdosDstZoneSrcPortZoneSrcPortOper DdosDstZoneSrcPortZoneSrcPortOper `json:"zone-src-port"`
}


type DdosDstZoneSrcPortZoneSrcPortOperOper struct {
    Ddos_entry_list []DdosDstZoneSrcPortZoneSrcPortOperOperDdos_entry_list `json:"ddos_entry_list"`
...
type DdosDstZoneSrcPortZoneSrcPortOperOperDdos_entry_list struct {
...
type DdosDstZoneSrcPortZoneSrcPortOperPortInd struct {
    Oper DdosDstZoneSrcPortZoneSrcPortOperPortIndOper `json:"oper"`
}


type DdosDstZoneSrcPortZoneSrcPortOperPortIndOper struct {
    Indicators []DdosDstZoneSrcPortZoneSrcPortOperPortIndOperIndicators `json:"indicators"`
...
type DdosDstZoneSrcPortZoneSrcPortOperPortIndOperIndicators struct {
    IndicatorName string `json:"indicator-name"`
    IndicatorIndex int `json:"indicator-index"`
    Rate string `json:"rate"`
    IndicatorCfg []DdosDstZoneSrcPortZoneSrcPortOperPortIndOperIndicatorsIndicatorCfg `json:"indicator-cfg"`
}


type DdosDstZoneSrcPortZoneSrcPortOperPortIndOperIndicatorsIndicatorCfg struct {
    Level int `json:"level"`
    ZoneThreshold string `json:"zone-threshold"`
    SourceThreshold string `json:"source-threshold"`
}

func (p *DdosDstZoneSrcPortZoneSrcPortOper) GetId() string{
    return "1"
}

func (p *DdosDstZoneSrcPortZoneSrcPortOper) getPath() string{
    
    return "ddos/dst/zone/" +p.ZoneName + "/src-port/zone-src-port/" +strconv.Itoa(p.PortNum)+"+"+p.Protocol+"/oper"
}

func (p *DdosDstZoneSrcPortZoneSrcPortOper) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) (DataDdosDstZoneSrcPortZoneSrcPortOper,error) {
logger.Println("DdosDstZoneSrcPortZoneSrcPortOper::Get")
    headers := axapi.GenRequestHeader(authToken)
    _, axResp, err := axapi.SendGet(host, p.getPath(), "", nil, headers, logger)
    var payload DataDdosDstZoneSrcPortZoneSrcPortOper
    if err == nil {
        if len(axResp) > 0{
