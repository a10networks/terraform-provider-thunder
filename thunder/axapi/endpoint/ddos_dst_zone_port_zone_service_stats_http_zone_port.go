...
type DdosDstZonePortZoneServiceStats34 struct {
	Inst struct {
		PortNum int `json:"port-num"`

		Protocol string `json:"protocol"`

		Stats DdosDstZonePortZoneServiceStats34Stats `json:"stats"`

		ZoneName string
	} `json:"zone-service"`
}

type DdosDstZonePortZoneServiceStats34Stats struct {
	HttpZonePort DdosDstZonePortZoneServiceStats34StatsHttpZonePort `json:"http-zone-port"`
}

type DdosDstZonePortZoneServiceStats34StatsHttpZonePort struct {
...
func (p *DdosDstZonePortZoneServiceStats34) GetId() string {
	return "1"
}

func (p *DdosDstZonePortZoneServiceStats34) getPath() string {
	return "ddos/dst/zone/" + p.Inst.ZoneName + "/port/zone-service/" + strconv.Itoa(p.Inst.PortNum) + "+" + p.Inst.Protocol + "/stats?http-zone-port=true"
}

func (p *DdosDstZonePortZoneServiceStats34) Post(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortZoneServiceStats34::Post")
...
func (p *DdosDstZonePortZoneServiceStats34) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortZoneServiceStats34::Get")
	headers := axapi.GenRequestHeader(authToken)
...
func (p *DdosDstZonePortZoneServiceStats34) Put(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortZoneServiceStats34::Put")
	headers := axapi.GenRequestHeader(authToken)
	payloadBytes, err := axapi.SerializeToJson(p)
	if err != nil {
		logger.Println("Failed to serialize struct as json", err)
...
func (p *DdosDstZonePortZoneServiceStats34) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortZoneServiceStats34::Delete")
	headers := axapi.GenRequestHeader(authToken)
