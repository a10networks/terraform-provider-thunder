...
type DdosDstZoneStatsStats struct {
	...
	Token_auth_mismatched_packets             int `json:"token_auth_mismatched_packets"`
	Token_auth_invalid_packets                int `json:"token_auth_invalid_packets"`
	Token_auth_current_salt_matched           int `json:"token_auth_current_salt_matched"`
	Token_auth_previous_salt_matched          int `json:"token_auth_previous_salt_matched"`
	Token_auth_session_created                int `json:"token_auth_session_created"`
	Token_auth_session_created_fail           int `json:"token_auth_session_created_fail"`
	Tcp_invalid_synack                        int `json:"tcp_invalid_synack"`
	Zone_tcp_small_window_excd                int `json:"zone_tcp_small_window_excd"`
	Src_tcp_small_window_excd                 int `json:"src_tcp_small_window_excd"`
	Small_window_rcv                          int `json:"small_window_rcv"`
	Multi_pu_src_hash_pu1                     int `json:"multi_pu_src_hash_pu1"`
	Multi_pu_src_hash_pu2                     int `json:"multi_pu_src_hash_pu2"`
	Port_zero_fwd_pkt_rcvd                    int `json:"port_zero_fwd_pkt_rcvd"`
	Port_zero_fwd_byte_rcvd                   int `json:"port_zero_fwd_byte_rcvd"`
	Port_zero_rev_pkt_rcvd                    int `json:"port_zero_rev_pkt_rcvd"`
	Port_zero_rev_byte_rcvd                   int `json:"port_zero_rev_byte_rcvd"`
	Service_miss_fwd_pkt_rcvd                 int `json:"service_miss_fwd_pkt_rcvd"`
