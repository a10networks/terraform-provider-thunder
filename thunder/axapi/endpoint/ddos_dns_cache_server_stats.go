...
type DdosDnsCacheServerStatsStats struct {
	...
	Dns_prebuild_alloc_fail                        int `json:"dns_prebuild_alloc_fail"`
	Suffix_table_trylock_fail                      int `json:"suffix_table_trylock_fail"`
	Insert_apex_zone_node_fail                     int `json:"insert_apex_zone_node_fail"`
	Insert_suffix_fqdn_node_fail                   int `json:"insert_suffix_fqdn_node_fail"`
	Dnssec_rrsig_link_fail                         int `json:"dnssec_rrsig_link_fail"`
