...
type DdosDstZoneIpProtoProtoNumberStats struct {
	Inst struct {
		ProtocolNum int `json:"protocol-num"`

		Stats DdosDstZoneIpProtoProtoNumberStatsStats `json:"stats"`

		ZoneName string
	} `json:"proto-number"`
}

type DdosDstZoneIpProtoProtoNumberStatsStats struct {
	OtherZoneIpproto DdosDstZoneIpProtoProtoNumberStatsStatsOtherZoneIpproto `json:"other-zone-ipproto"`
}

type DdosDstZoneIpProtoProtoNumberStatsStatsOtherZoneIpproto struct {
...
func (p *DdosDstZoneIpProtoProtoNumberStats) GetId() string {
	return "1"
}

func (p *DdosDstZoneIpProtoProtoNumberStats) getPath() string {
	return "ddos/dst/zone/" + p.Inst.ZoneName + "/ip-proto/proto-number/" + strconv.Itoa(p.Inst.ProtocolNum) + "/stats?other-zone-ipproto=true"
}

func (p *DdosDstZoneIpProtoProtoNumberStats) Post(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZoneIpProtoProtoNumberStats::Post")
...
func (p *DdosDstZoneIpProtoProtoNumberStats) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZoneIpProtoProtoNumberStats::Get")
	headers := axapi.GenRequestHeader(authToken)
...
func (p *DdosDstZoneIpProtoProtoNumberStats) Put(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZoneIpProtoProtoNumberStats::Put")
	headers := axapi.GenRequestHeader(authToken)
	payloadBytes, err := axapi.SerializeToJson(p)
	if err != nil {
		logger.Println("Failed to serialize struct as json", err)
...
func (p *DdosDstZoneIpProtoProtoNumberStats) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZoneIpProtoProtoNumberStats::Delete")
	headers := axapi.GenRequestHeader(authToken)
