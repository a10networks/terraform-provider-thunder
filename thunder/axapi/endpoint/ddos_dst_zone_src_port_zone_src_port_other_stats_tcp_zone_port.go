...
type DdosDstZoneSrcPortZoneSrcPortOtherStats struct {
	Inst struct {
		PortOther string `json:"port-other"`

		Protocol string `json:"protocol"`

		Stats DdosDstZoneSrcPortZoneSrcPortOtherStatsStats `json:"stats"`

		ZoneName string
	} `json:"zone-src-port-other"`
}

type DdosDstZoneSrcPortZoneSrcPortOtherStatsStats struct {
	TcpZonePort DdosDstZoneSrcPortZoneSrcPortOtherStatsStatsTcpZonePort `json:"tcp-zone-port"`
}

type DdosDstZoneSrcPortZoneSrcPortOtherStatsStatsTcpZonePort struct {
	...
	Auth_drop                                int `json:"auth_drop"`
	Auth_resp                                int `json:"auth_resp"`
...
func (p *DdosDstZoneSrcPortZoneSrcPortOtherStats) GetId() string {
	return "1"
}

func (p *DdosDstZoneSrcPortZoneSrcPortOtherStats) getPath() string {
	return "ddos/dst/zone/" + p.Inst.ZoneName + "/src-port/zone-src-port-other/" + p.Inst.PortOther + "+" + p.Inst.Protocol + "/stats?tcp-zone-port=true"
}

func (p *DdosDstZoneSrcPortZoneSrcPortOtherStats) Post(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZoneSrcPortZoneSrcPortOtherStats::Post")
...
func (p *DdosDstZoneSrcPortZoneSrcPortOtherStats) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZoneSrcPortZoneSrcPortOtherStats::Get")
	headers := axapi.GenRequestHeader(authToken)
...
func (p *DdosDstZoneSrcPortZoneSrcPortOtherStats) Put(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZoneSrcPortZoneSrcPortOtherStats::Put")
	headers := axapi.GenRequestHeader(authToken)
	payloadBytes, err := axapi.SerializeToJson(p)
	if err != nil {
		logger.Println("Failed to serialize struct as json", err)
...
func (p *DdosDstZoneSrcPortZoneSrcPortOtherStats) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZoneSrcPortZoneSrcPortOtherStats::Delete")
	headers := axapi.GenRequestHeader(authToken)
