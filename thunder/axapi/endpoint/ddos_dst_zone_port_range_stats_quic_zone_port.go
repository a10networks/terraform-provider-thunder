...
type DdosDstZonePortRangeStats27 struct {
	Inst struct {
		...
		Stats DdosDstZonePortRangeStats27Stats `json:"stats"`

		ZoneName string
	} `json:"port-range"`
}

type DdosDstZonePortRangeStats27Stats struct {
	QuicZonePort DdosDstZonePortRangeStats27StatsQuicZonePort `json:"quic-zone-port"`
}

type DdosDstZonePortRangeStats27StatsQuicZonePort struct {
...
func (p *DdosDstZonePortRangeStats27) GetId() string {
	return "1"
}

func (p *DdosDstZonePortRangeStats27) getPath() string {
	return "ddos/dst/zone/" + p.Inst.ZoneName + "/port-range/" + strconv.Itoa(p.Inst.PortRangeStart) + "+" + strconv.Itoa(p.Inst.PortRangeEnd) + "+" + p.Inst.Protocol + "/stats?quic-zone-port=true"
}

func (p *DdosDstZonePortRangeStats27) Post(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortRangeStats27::Post")
...
func (p *DdosDstZonePortRangeStats27) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortRangeStats27::Get")
	headers := axapi.GenRequestHeader(authToken)
...
func (p *DdosDstZonePortRangeStats27) Put(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortRangeStats27::Put")
	headers := axapi.GenRequestHeader(authToken)
	payloadBytes, err := axapi.SerializeToJson(p)
	if err != nil {
		logger.Println("Failed to serialize struct as json", err)
...
func (p *DdosDstZonePortRangeStats27) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortRangeStats27::Delete")
	headers := axapi.GenRequestHeader(authToken)
