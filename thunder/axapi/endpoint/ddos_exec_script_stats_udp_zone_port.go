...
type DdosExecScriptStats46 struct {
	Inst struct {
		Stats DdosExecScriptStats46Stats `json:"stats"`
	} `json:"exec-script"`
}

type DdosExecScriptStats46Stats struct {
	UdpZonePort DdosExecScriptStats46StatsUdpZonePort `json:"udp-zone-port"`
}

type DdosExecScriptStats46StatsUdpZonePort struct {
...
func (p *DdosExecScriptStats46) GetId() string {
	return "1"
}

func (p *DdosExecScriptStats46) getPath() string {
	return "ddos/exec-script/stats?udp-zone-port=true"
}

func (p *DdosExecScriptStats46) Post(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosExecScriptStats46::Post")
...
func (p *DdosExecScriptStats46) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosExecScriptStats46::Get")
	headers := axapi.GenRequestHeader(authToken)
...
func (p *DdosExecScriptStats46) Put(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosExecScriptStats46::Put")
	headers := axapi.GenRequestHeader(authToken)
	payloadBytes, err := axapi.SerializeToJson(p)
	if err != nil {
		logger.Println("Failed to serialize struct as json", err)
...
func (p *DdosExecScriptStats46) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosExecScriptStats46::Delete")
	headers := axapi.GenRequestHeader(authToken)
