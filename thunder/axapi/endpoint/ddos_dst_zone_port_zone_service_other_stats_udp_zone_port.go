...
type DdosDstZonePortZoneServiceOtherStats32 struct {
	Inst struct {
		PortOther string `json:"port-other"`

		Protocol string `json:"protocol"`

		Stats DdosDstZonePortZoneServiceOtherStats32Stats `json:"stats"`

		ZoneName string
	} `json:"zone-service-other"`
}

type DdosDstZonePortZoneServiceOtherStats32Stats struct {
	UdpZonePort DdosDstZonePortZoneServiceOtherStats32StatsUdpZonePort `json:"udp-zone-port"`
}

type DdosDstZonePortZoneServiceOtherStats32StatsUdpZonePort struct {
...
func (p *DdosDstZonePortZoneServiceOtherStats32) GetId() string {
	return "1"
}

func (p *DdosDstZonePortZoneServiceOtherStats32) getPath() string {
	return "ddos/dst/zone/" + p.Inst.ZoneName + "/port/zone-service-other/" + p.Inst.PortOther + "+" + p.Inst.Protocol + "/stats?udp-zone-port=true"
}

func (p *DdosDstZonePortZoneServiceOtherStats32) Post(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortZoneServiceOtherStats32::Post")
...
func (p *DdosDstZonePortZoneServiceOtherStats32) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortZoneServiceOtherStats32::Get")
	headers := axapi.GenRequestHeader(authToken)
...
func (p *DdosDstZonePortZoneServiceOtherStats32) Put(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortZoneServiceOtherStats32::Put")
	headers := axapi.GenRequestHeader(authToken)
	payloadBytes, err := axapi.SerializeToJson(p)
	if err != nil {
		logger.Println("Failed to serialize struct as json", err)
...
func (p *DdosDstZonePortZoneServiceOtherStats32) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortZoneServiceOtherStats32::Delete")
	headers := axapi.GenRequestHeader(authToken)
