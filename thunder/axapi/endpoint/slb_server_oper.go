...
type SlbServerOper struct {
	...
	ServiceList []SlbServerOperServiceList `json:"service-list"`
}
...
type SlbServerOperServiceList struct {
	PortNumber int                          `json:"port-number"`
	Protocol   string                       `json:"protocol"`
	Label      string                       `json:"label"`
	Oper       SlbServerOperServiceListOper `json:"oper"`
}

type SlbServerOperServiceListOper struct {
	State                     string                                        `json:"state"`
	Curr_conn_rate            int                                           `json:"curr_conn_rate"`
	Conn_rate_unit            string                                        `json:"conn_rate_unit"`
	Slow_start_conn_limit     int                                           `json:"slow_start_conn_limit"`
	...
	Aflow_queue_size          int                                           `json:"aflow_queue_size"`
	Resv_conn                 int                                           `json:"resv_conn"`
	AutoNatAddrList           []SlbServerOperServiceListOperAutoNatAddrList `json:"auto-nat-addr-list"`
	DrsAutoNatList            []SlbServerOperServiceListOperDrsAutoNatList  `json:"drs-auto-nat-list"`
	Pool_name                 string                                        `json:"pool_name"`
	NatPoolAddrList           []SlbServerOperServiceListOperNatPoolAddrList `json:"nat-pool-addr-list"`
	DrsIpNatList              []SlbServerOperServiceListOperDrsIpNatList    `json:"drs-ip-nat-list"`
}

type SlbServerOperServiceListOperAutoNatAddrList struct {
	Auto_nat_ip          string `json:"auto_nat_ip"`
	Vrid                 int    `json:"vrid"`
	Ha_group_id          int    `json:"ha_group_id"`
	Ip_rr                int    `json:"ip_rr"`
...
type SlbServerOperServiceListOperDrsAutoNatList struct {
	Drs_name              string                                                            `json:"drs_name"`
	Drs_port              int                                                               `json:"drs_port"`
	DrsAutoNatAddressList []SlbServerOperServiceListOperDrsAutoNatListDrsAutoNatAddressList `json:"drs-auto-nat-address-list"`
}

type SlbServerOperServiceListOperDrsAutoNatListDrsAutoNatAddressList struct {
	Auto_nat_ip          string `json:"auto_nat_ip"`
	Vrid                 int    `json:"vrid"`
	Ha_group_id          int    `json:"ha_group_id"`
	Ip_rr                int    `json:"ip_rr"`
...
type SlbServerOperServiceListOperNatPoolAddrList struct {
	Nat_ip               string `json:"nat_ip"`
	Ports_consumed       int    `json:"ports_consumed"`
	Ports_consumed_total int    `json:"ports_consumed_total"`
	Ports_freed_total    int    `json:"ports_freed_total"`
...
type SlbServerOperServiceListOperDrsIpNatList struct {
	Drs_name        string                                                    `json:"drs_name"`
	Drs_port        int                                                       `json:"drs_port"`
	Pool_name       string                                                    `json:"pool_name"`
	NatPoolAddrList []SlbServerOperServiceListOperDrsIpNatListNatPoolAddrList `json:"nat-pool-addr-list"`
}

type SlbServerOperServiceListOperDrsIpNatListNatPoolAddrList struct {
	Nat_ip               string `json:"nat_ip"`
	Ports_consumed       int    `json:"ports_consumed"`
	Ports_consumed_total int    `json:"ports_consumed_total"`
	Ports_freed_total    int    `json:"ports_freed_total"`
