...
type EnableManagementServiceTelnet struct {
	Inst struct {
		...
		LifCfg EnableManagementServiceTelnetLifCfg `json:"lif-cfg"`
...
type EnableManagementServiceTelnetAclV4List struct {
	...
	LifCfg      EnableManagementServiceTelnetAclV4ListLifCfg      `json:"lif-cfg"`
	Management  int                                               `json:"management"`
	AllDataIntf int                                               `json:"all-data-intf"`
	Uuid        string                                            `json:"uuid"`
...
type EnableManagementServiceTelnetAclV4ListLifCfg struct {
	Lif string `json:"lif"`
}
...
type EnableManagementServiceTelnetAclV6List struct {
	...
	LifCfg      EnableManagementServiceTelnetAclV6ListLifCfg      `json:"lif-cfg"`
	Management  int                                               `json:"management"`
	AllDataIntf int                                               `json:"all-data-intf"`
	Uuid        string                                            `json:"uuid"`
	UserTag     string                                            `json:"user-tag"`
...
type EnableManagementServiceTelnetAclV6ListLifCfg struct {
	Lif string `json:"lif"`
}
...
type EnableManagementServiceTelnetLifCfg struct {
	Lif string `json:"lif"`
}
