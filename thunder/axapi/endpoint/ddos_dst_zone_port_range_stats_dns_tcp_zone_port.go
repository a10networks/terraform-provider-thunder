...
type DdosDstZonePortRangeStats struct {
	Inst struct {
		...
		Stats DdosDstZonePortRangeStatsStats `json:"stats"`

		ZoneName string
	} `json:"port-range"`
}

type DdosDstZonePortRangeStatsStats struct {
	DnsTcpZonePort DdosDstZonePortRangeStatsStatsDnsTcpZonePort `json:"dns-tcp-zone-port"`
}

type DdosDstZonePortRangeStatsStatsDnsTcpZonePort struct {
...
func (p *DdosDstZonePortRangeStats) GetId() string {
	return "1"
}

func (p *DdosDstZonePortRangeStats) getPath() string {
	return "ddos/dst/zone/" + p.Inst.ZoneName + "/port-range/" + strconv.Itoa(p.Inst.PortRangeStart) + "+" + strconv.Itoa(p.Inst.PortRangeEnd) + "+" + p.Inst.Protocol + "/stats?dns-tcp-zone-port=true"
}

func (p *DdosDstZonePortRangeStats) Post(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortRangeStats::Post")
...
func (p *DdosDstZonePortRangeStats) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortRangeStats::Get")
	headers := axapi.GenRequestHeader(authToken)
...
func (p *DdosDstZonePortRangeStats) Put(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortRangeStats::Put")
	headers := axapi.GenRequestHeader(authToken)
	payloadBytes, err := axapi.SerializeToJson(p)
	if err != nil {
		logger.Println("Failed to serialize struct as json", err)
...
func (p *DdosDstZonePortRangeStats) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortRangeStats::Delete")
	headers := axapi.GenRequestHeader(authToken)
