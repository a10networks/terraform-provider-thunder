...
type DdosDstZonePortZoneServiceStats38 struct {
	Inst struct {
		PortNum int `json:"port-num"`

		Protocol string `json:"protocol"`

		Stats DdosDstZonePortZoneServiceStats38Stats `json:"stats"`

		ZoneName string
	} `json:"zone-service"`
}

type DdosDstZonePortZoneServiceStats38Stats struct {
	SipUdpZonePort DdosDstZonePortZoneServiceStats38StatsSipUdpZonePort `json:"sip-udp-zone-port"`
}

type DdosDstZonePortZoneServiceStats38StatsSipUdpZonePort struct {
...
func (p *DdosDstZonePortZoneServiceStats38) GetId() string {
	return "1"
}

func (p *DdosDstZonePortZoneServiceStats38) getPath() string {
	return "ddos/dst/zone/" + p.Inst.ZoneName + "/port/zone-service/" + strconv.Itoa(p.Inst.PortNum) + "+" + p.Inst.Protocol + "/stats?sip-udp-zone-port=true"
}

func (p *DdosDstZonePortZoneServiceStats38) Post(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortZoneServiceStats38::Post")
...
func (p *DdosDstZonePortZoneServiceStats38) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortZoneServiceStats38::Get")
	headers := axapi.GenRequestHeader(authToken)
...
func (p *DdosDstZonePortZoneServiceStats38) Put(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortZoneServiceStats38::Put")
	headers := axapi.GenRequestHeader(authToken)
	payloadBytes, err := axapi.SerializeToJson(p)
	if err != nil {
		logger.Println("Failed to serialize struct as json", err)
...
func (p *DdosDstZonePortZoneServiceStats38) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortZoneServiceStats38::Delete")
	headers := axapi.GenRequestHeader(authToken)
