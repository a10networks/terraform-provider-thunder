...
type DdosDstZoneIpProtoProtoTcpUdpStats23 struct {
	Inst struct {
		Protocol string `json:"protocol"`

		Stats DdosDstZoneIpProtoProtoTcpUdpStats23Stats `json:"stats"`

		ZoneName string
	} `json:"proto-tcp-udp"`
}

type DdosDstZoneIpProtoProtoTcpUdpStats23Stats struct {
	UdpZonePort DdosDstZoneIpProtoProtoTcpUdpStats23StatsUdpZonePort `json:"udp-zone-port"`
}

type DdosDstZoneIpProtoProtoTcpUdpStats23StatsUdpZonePort struct {
...
func (p *DdosDstZoneIpProtoProtoTcpUdpStats23) GetId() string {
	return "1"
}

func (p *DdosDstZoneIpProtoProtoTcpUdpStats23) getPath() string {
	return "ddos/dst/zone/" + p.Inst.ZoneName + "/ip-proto/proto-tcp-udp/" + p.Inst.Protocol + "/stats?udp-zone-port=true"
}

func (p *DdosDstZoneIpProtoProtoTcpUdpStats23) Post(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZoneIpProtoProtoTcpUdpStats23::Post")
...
func (p *DdosDstZoneIpProtoProtoTcpUdpStats23) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZoneIpProtoProtoTcpUdpStats23::Get")
	headers := axapi.GenRequestHeader(authToken)
...
func (p *DdosDstZoneIpProtoProtoTcpUdpStats23) Put(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZoneIpProtoProtoTcpUdpStats23::Put")
	headers := axapi.GenRequestHeader(authToken)
	payloadBytes, err := axapi.SerializeToJson(p)
	if err != nil {
		logger.Println("Failed to serialize struct as json", err)
...
func (p *DdosDstZoneIpProtoProtoTcpUdpStats23) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZoneIpProtoProtoTcpUdpStats23::Delete")
	headers := axapi.GenRequestHeader(authToken)
