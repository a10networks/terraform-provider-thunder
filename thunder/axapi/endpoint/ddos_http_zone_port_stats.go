...
type DdosHttpZonePortStats struct {
	Stats DdosHttpZonePortStatsStats `json:"stats"`
}
type DataDdosHttpZonePortStats struct {
	DtDdosHttpZonePortStats DdosHttpZonePortStats `json:"http-zone-port"`
}

type DdosHttpZonePortStatsStats struct {
...
func (p *DdosHttpZonePortStats) GetId() string {
	return "1"
}

func (p *DdosHttpZonePortStats) getPath() string {
	return "ddos/http-zone-port/stats"
}

func (p *DdosHttpZonePortStats) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) (DataDdosHttpZonePortStats, error) {
	logger.Println("DdosHttpZonePortStats::Get")
	headers := axapi.GenRequestHeader(authToken)
	_, axResp, err := axapi.SendGet(host, p.getPath(), "", nil, headers, logger)
	var payload DataDdosHttpZonePortStats
	if err == nil {
		if len(axResp) > 0 {
