...
type DdosDstEntryPortRangeStats10 struct {
	Inst struct {

    PortRangeEnd int `json:"port-range-end"`
    PortRangeStart int `json:"port-range-start"`
    Protocol string `json:"protocol"`
    Stats DdosDstEntryPortRangeStats10Stats `json:"stats"`
    DstEntryName string 
...
type DdosDstEntryPortRangeStats10Stats struct {
    UdpPort DdosDstEntryPortRangeStats10StatsUdpPort `json:"udp-port"`
}


type DdosDstEntryPortRangeStats10StatsUdpPort struct {
...
func (p *DdosDstEntryPortRangeStats10) GetId() string{
    return "1"
}

func (p *DdosDstEntryPortRangeStats10) getPath() string{
    return "ddos/dst/entry/" +p.Inst.DstEntryName + "/port-range/" +strconv.Itoa(p.Inst.PortRangeStart)+"+" +strconv.Itoa(p.Inst.PortRangeEnd)+"+"+p.Inst.Protocol+"/stats?udp-port=true"
}

func (p *DdosDstEntryPortRangeStats10) Post(authToken string, host string, logger *axapi.ThunderLog) error {
    logger.Println("DdosDstEntryPortRangeStats10::Post")
...
func (p *DdosDstEntryPortRangeStats10) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
    logger.Println("DdosDstEntryPortRangeStats10::Get")
    headers := axapi.GenRequestHeader(authToken)
...
func (p *DdosDstEntryPortRangeStats10) Put(authToken string, host string, logger *axapi.ThunderLog) error {
    logger.Println("DdosDstEntryPortRangeStats10::Put")
    headers := axapi.GenRequestHeader(authToken)
    payloadBytes, err := axapi.SerializeToJson(p)
    if err != nil {
        logger.Println("Failed to serialize struct as json", err)
...
func (p *DdosDstEntryPortRangeStats10) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
    logger.Println("DdosDstEntryPortRangeStats10::Delete")
    headers := axapi.GenRequestHeader(authToken)
