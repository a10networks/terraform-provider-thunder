...
type SlbVirtualServerPortStats50 struct {
	Inst struct {
		...
		Stats SlbVirtualServerPortStats50Stats `json:"stats"`

		Virtual_server_name string
	} `json:"port"`
}

type SlbVirtualServerPortStats50Stats struct {
	Dns_vport SlbVirtualServerPortStats50StatsDns_vport `json:"dns_vport"`
}

type SlbVirtualServerPortStats50StatsDns_vport struct {
	...
	Dns_recursive_resolution_late_ans                  int `json:"dns_recursive_resolution_late_ans"`
	Dns_recursive_resolution_udp_conn                  int `json:"dns_recursive_resolution_udp_conn"`
	Dns_recursive_resolution_tcp_conn                  int `json:"dns_recursive_resolution_tcp_conn"`
	Dns_category_action_drop                           int `json:"dns_category_action_drop"`
	Dns_category_action_respond                        int `json:"dns_category_action_respond"`
	Dns_category_action_permit                         int `json:"dns_category_action_permit"`
	Dns_category_resp_nxdomain                         int `json:"dns_category_resp_nxdomain"`
	Dns_category_resp_noanswer                         int `json:"dns_category_resp_noanswer"`
	Dns_category_resp_a                                int `json:"dns_category_resp_a"`
	Dns_category_resp_aaaa                             int `json:"dns_category_resp_aaaa"`
	Dns_category_resp_cname                            int `json:"dns_category_resp_cname"`
	Dns_category_bypass                                int `json:"dns_category_bypass"`
	Dns_category_async_sent                            int `json:"dns_category_async_sent"`
	Dns_category_async_received                        int `json:"dns_category_async_received"`
	Dns_category_no_local_result                       int `json:"dns_category_no_local_result"`
	Rcode_notzone_receive                              int `json:"rcode_notzone_receive"`
	Rcode_tsig_badsig_receive                          int `json:"rcode_tsig_badsig_receive"`
	Rcode_tsig_badkey_receive                          int `json:"rcode_tsig_badkey_receive"`
	Rcode_tsig_badtime_receive                         int `json:"rcode_tsig_badtime_receive"`
	Rcode_tsig_badtrunc_receive                        int `json:"rcode_tsig_badtrunc_receive"`
	Dns_filter_tld_drop                                int `json:"dns_filter_tld_drop"`
	Dnsrrl_qps_drop                                    int `json:"dnsrrl_qps_drop"`
	Dnsrrl_nx_drop                                     int `json:"dnsrrl_nx_drop"`
...
func (p *SlbVirtualServerPortStats50) getPath() string {
	return "slb/virtual-server/" + p.Inst.Virtual_server_name + "/port/" + strconv.Itoa(p.Inst.PortNumber) + "+" + p.Inst.Protocol + "/stats?dns_vport=true"
}

func (p *SlbVirtualServerPortStats50) Post(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("SlbVirtualServerPortStats50::Post")
...
func (p *SlbVirtualServerPortStats50) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("SlbVirtualServerPortStats50::Get")
	headers := axapi.GenRequestHeader(authToken)
...
func (p *SlbVirtualServerPortStats50) Put(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("SlbVirtualServerPortStats50::Put")
	headers := axapi.GenRequestHeader(authToken)
	payloadBytes, err := axapi.SerializeToJson(p)
	if err != nil {
		logger.Println("Failed to serialize struct as json", err)
...
func (p *SlbVirtualServerPortStats50) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("SlbVirtualServerPortStats50::Delete")
	headers := axapi.GenRequestHeader(authToken)
