...
type DdosDstZonePortZoneServiceStats33 struct {
	Inst struct {
		...
		Stats DdosDstZonePortZoneServiceStats33Stats `json:"stats"`

		ZoneName string
	} `json:"zone-service"`
}

type DdosDstZonePortZoneServiceStats33Stats struct {
	DnsUdpZonePort DdosDstZonePortZoneServiceStats33StatsDnsUdpZonePort `json:"dns-udp-zone-port"`
}

type DdosDstZonePortZoneServiceStats33StatsDnsUdpZonePort struct {
...
func (p *DdosDstZonePortZoneServiceStats33) getPath() string {
	return "ddos/dst/zone/" + p.Inst.ZoneName + "/port/zone-service/" + strconv.Itoa(p.Inst.PortNum) + "+" + p.Inst.Protocol + "/stats?dns-udp-zone-port=true"
}

func (p *DdosDstZonePortZoneServiceStats33) Post(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortZoneServiceStats33::Post")
...
func (p *DdosDstZonePortZoneServiceStats33) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortZoneServiceStats33::Get")
	headers := axapi.GenRequestHeader(authToken)
...
func (p *DdosDstZonePortZoneServiceStats33) Put(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortZoneServiceStats33::Put")
	headers := axapi.GenRequestHeader(authToken)
	payloadBytes, err := axapi.SerializeToJson(p)
	if err != nil {
		logger.Println("Failed to serialize struct as json", err)
...
func (p *DdosDstZonePortZoneServiceStats33) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortZoneServiceStats33::Delete")
	headers := axapi.GenRequestHeader(authToken)
