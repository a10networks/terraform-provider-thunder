...
type VrrpAStateStatsStats struct {
	...
	Sync_rx_dcmsg_counter_inter_pu                 int `json:"sync_rx_dcmsg_counter_inter_pu"`
	Sync_rx_drop_sync_packets                      int `json:"sync_rx_drop_sync_packets"`
	Sync_pkt_rcv_dc_msg_dir                        int `json:"sync_pkt_rcv_dc_msg_dir"`
	Sync_tx_update_misc_bearer                     int `json:"sync_tx_update_misc_bearer"`
	Query_pkt_rx_error                             int `json:"query_pkt_rx_error"`
}
