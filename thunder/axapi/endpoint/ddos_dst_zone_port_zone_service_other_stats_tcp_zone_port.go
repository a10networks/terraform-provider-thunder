...
type DdosDstZonePortZoneServiceOtherStats struct {
	Inst struct {
		PortOther string `json:"port-other"`

		Protocol string `json:"protocol"`

		Stats DdosDstZonePortZoneServiceOtherStatsStats `json:"stats"`

		ZoneName string
	} `json:"zone-service-other"`
}

type DdosDstZonePortZoneServiceOtherStatsStats struct {
	TcpZonePort DdosDstZonePortZoneServiceOtherStatsStatsTcpZonePort `json:"tcp-zone-port"`
}

type DdosDstZonePortZoneServiceOtherStatsStatsTcpZonePort struct {
...
func (p *DdosDstZonePortZoneServiceOtherStats) GetId() string {
	return "1"
}

func (p *DdosDstZonePortZoneServiceOtherStats) getPath() string {
	return "ddos/dst/zone/" + p.Inst.ZoneName + "/port/zone-service-other/" + p.Inst.PortOther + "+" + p.Inst.Protocol + "/stats?tcp-zone-port=true"
}

func (p *DdosDstZonePortZoneServiceOtherStats) Post(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortZoneServiceOtherStats::Post")
...
func (p *DdosDstZonePortZoneServiceOtherStats) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortZoneServiceOtherStats::Get")
	headers := axapi.GenRequestHeader(authToken)
...
func (p *DdosDstZonePortZoneServiceOtherStats) Put(authToken string, host string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortZoneServiceOtherStats::Put")
	headers := axapi.GenRequestHeader(authToken)
	payloadBytes, err := axapi.SerializeToJson(p)
	if err != nil {
		logger.Println("Failed to serialize struct as json", err)
...
func (p *DdosDstZonePortZoneServiceOtherStats) Delete(authToken string, host string, instId string, logger *axapi.ThunderLog) error {
	logger.Println("DdosDstZonePortZoneServiceOtherStats::Delete")
	headers := axapi.GenRequestHeader(authToken)
