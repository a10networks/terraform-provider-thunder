...
type SlbVirtualServerOper struct {
	MigrateVip SlbVirtualServerOperMigrateVip `json:"migrate-vip"`

	Name string `json:"name"`

	Oper SlbVirtualServerOperOper `json:"oper"`

	PortList []SlbVirtualServerOperPortList `json:"port-list"`
}
type DataSlbVirtualServerOper struct {
	DtSlbVirtualServerOper SlbVirtualServerOper `json:"virtual-server"`
}

type SlbVirtualServerOperMigrateVip struct {
	Oper SlbVirtualServerOperMigrateVipOper `json:"oper"`
}

type SlbVirtualServerOperMigrateVipOper struct {
	State string `json:"state"`
}

type SlbVirtualServerOperOper struct {
	Mac                     string `json:"mac"`
	State                   string `json:"state"`
	CurrConnRate            int    `json:"curr-conn-rate"`
	ConnRateUnit            string `json:"conn-rate-unit"`
	CurrIcmpRate            int    `json:"curr-icmp-rate"`
	IcmpLockupTimeLeft      int    `json:"icmp-lockup-time-left"`
	IcmpRateOverLimitDrop   int    `json:"icmp-rate-over-limit-drop"`
	CurrIcmpv6Rate          int    `json:"curr-icmpv6-rate"`
	Icmpv6LockupTimeLeft    int    `json:"icmpv6-lockup-time-left"`
	Icmpv6RateOverLimitDrop int    `json:"icmpv6-rate-over-limit-drop"`
	MigrationStatus         string `json:"migration-status"`
	PeakConn                int    `json:"peak-conn"`
	IpAddress               string `json:"ip-address"`
	Ipv6Address             string `json:"ipv6-address"`
	CurrConnOverflow        int    `json:"curr-conn-overflow"`
...
type SlbVirtualServerOperPortList struct {
	PortNumber int                              `json:"port-number"`
	Protocol   string                           `json:"protocol"`
	Oper       SlbVirtualServerOperPortListOper `json:"oper"`
}

type SlbVirtualServerOperPortListOper struct {
	State                string                                             `json:"state"`
	...
	HttpHitsList         []SlbVirtualServerOperPortListOperHttpHitsList     `json:"http-hits-list"`
	HttpVportCpuList     []SlbVirtualServerOperPortListOperHttpVportCpuList `json:"http-vport-cpu-list"`
...
type SlbVirtualServerOperPortListOperHttpHitsList struct {
	Name      string `json:"name"`
	HitsCount int    `json:"hits-count"`
}

type SlbVirtualServerOperPortListOperHttpVportCpuList struct {
	...
	Status_103                      int `json:"status_103"`
	...
	Transaction_limited             int `json:"transaction_limited"`
...
func (p *SlbVirtualServerOper) GetId() string {
	return "1"
}

func (p *SlbVirtualServerOper) getPath() string {
	return "slb/virtual-server/" + p.Name + "/oper"
}

func (p *SlbVirtualServerOper) Get(authToken string, host string, instId string, logger *axapi.ThunderLog) (DataSlbVirtualServerOper, error) {
	logger.Println("SlbVirtualServerOper::Get")
	headers := axapi.GenRequestHeader(authToken)
	_, axResp, err := axapi.SendGet(host, p.getPath(), "", nil, headers, logger)
	var payload DataSlbVirtualServerOper
	if err == nil {
		if len(axResp) > 0 {
