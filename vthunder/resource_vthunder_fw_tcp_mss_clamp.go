...
//vThunder resource FwTcpMssClamp
...
func resourceFwTcpMssClampCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if client.Host != "" {
		...
		go_vthunder.PostFwTcpMssClamp(client.Token, data, client.Host)
...
func resourceFwTcpMssClampRead(d *schema.ResourceData, meta interface{}) error {
	...
	if client.Host != "" {
		...
		data, err := go_vthunder.GetFwTcpMssClamp(client.Token, client.Host)
		if data == nil {
...
func dataToFwTcpMssClamp(d *schema.ResourceData) go_vthunder.FwTcpMssClamp {
	var vc go_vthunder.FwTcpMssClamp
	var c go_vthunder.FwTcpMssClampInstance
