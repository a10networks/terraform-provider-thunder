...
//vThunder resource InterfaceVeBFD
...
func resourceInterfaceVeBFDCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if client.Host != "" {
		...
		go_vthunder.PostInterfaceVeBFD(client.Token, name, data, client.Host)
...
func resourceInterfaceVeBFDRead(d *schema.ResourceData, meta interface{}) error {
	...
	if client.Host != "" {
		...
		data, err := go_vthunder.GetInterfaceVeBFD(client.Token, name, client.Host)
		if data == nil {
...
func dataToInterfaceVeBFD(d *schema.ResourceData) go_vthunder.VeBFD {
	var vc go_vthunder.VeBFD
	var c go_vthunder.VeBFDInstance
	var obj1 go_vthunder.VeBFDIntervalCfg
	...
	var obj2 go_vthunder.VeBFDAuthentication
