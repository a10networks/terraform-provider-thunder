...
//Acceptance test
func TestSlbTemplateServer_create(t *testing.T) {
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("vthunder_slb_template_server.testname", "name", "testser"),
					...
					resource.TestCheckResourceAttr("vthunder_slb_template_server.testname", "user_tag", "testtag"),
