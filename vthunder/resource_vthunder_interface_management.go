...
//vThunder resource InterfaceManagement
...
func resourceInterfaceManagementCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if client.Host != "" {
		...
		d.SetId("1")
		go_vthunder.PostInterfaceManagement(client.Token, data, client.Host)
...
func resourceInterfaceManagementRead(d *schema.ResourceData, meta interface{}) error {
	...
	if client.Host != "" {
		...
		data, err := go_vthunder.GetInterfaceManagement(client.Token, client.Host)
		if data == nil {
...
func dataToInterfaceManagement(d *schema.ResourceData) go_vthunder.Management {
	var vc go_vthunder.Management
	var c go_vthunder.ManagementInstance
	var obj1 go_vthunder.Lldp
	prefix := "lldp.0."

	var obj1_1 go_vthunder.TxDot1Cfg
	...
	var obj1_2 go_vthunder.NotificationCfg
	...
	var obj1_3 go_vthunder.EnableCfg
	...
	var obj1_4 go_vthunder.TxTlvsCfg
	...
	var obj2 go_vthunder.BroadcastRateLimit
	...
	var obj3 go_vthunder.ManagementIP
	prefix = "ip.0."
	...
	var obj4 go_vthunder.SecondaryIP
	...
	var obj5 go_vthunder.AccessList
	...
	c.Counters1 = make([]go_vthunder.ManagementSamplingEnable, 0, SamplingEnableCount)

	for i := 0; i < SamplingEnableCount; i++ {
		var obj6 go_vthunder.ManagementSamplingEnable
	...
	c.DefaultIpv6Gateway = make([]go_vthunder.Ipv6, 0, Ipv6Count)

	for i := 0; i < Ipv6Count; i++ {
		var obj7 go_vthunder.Ipv6
