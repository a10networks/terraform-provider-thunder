...
//vThunder resource InterfaceEthernetIPv6
...
func resourceInterfaceEthernetIPv6Create(d *schema.ResourceData, meta interface{}) error {
	...
	if client.Host != "" {
		...
		go_vthunder.PostInterfaceEthernetIPv6(client.Token, name, data, client.Host)
...
func resourceInterfaceEthernetIPv6Read(d *schema.ResourceData, meta interface{}) error {
	...
	if client.Host != "" {
		...
		data, err := go_vthunder.GetInterfaceEthernetIPv6(client.Token, name, client.Host)
		if data == nil {
...
func dataToInterfaceEthernetIPv6(d *schema.ResourceData) go_vthunder.EthernetIPv6 {
	var vc go_vthunder.EthernetIPv6
	var c go_vthunder.EthernetIPv6Instance
	AddressListCount := d.Get("address_list.#").(int)
	c.AddressType = make([]go_vthunder.EthernetIPv6AddressList, 0, AddressListCount)

	for i := 0; i < AddressListCount; i++ {
		var obj1 go_vthunder.EthernetIPv6AddressList
	...
	var obj2 go_vthunder.EthernetIPv6Rip
	prefix := "rip.0."

	var obj2_1 go_vthunder.EthernetIPv6SplitHorizonCfg
	...
	var obj3 go_vthunder.EthernetIPv6StatefulFirewall
	...
	var obj4 go_vthunder.EthernetIPv6Router
	prefix = "router.0."

	var obj4_1 go_vthunder.EthernetIPv6Ripng
	prefix1 = prefix + "ripng.0."
	obj4_1.Rip = d.Get(prefix1 + "rip").(int)
	obj4.Rip = obj4_1

	var obj4_2 go_vthunder.EthernetIPv6Ospf1
	prefix1 = prefix + "ospf.0."

	AreaListCount := d.Get(prefix1 + "area_list.#").(int)
	obj4_2.AreaIDAddr = make([]go_vthunder.EthernetIPv6AreaList, 0, AreaListCount)

	for i := 0; i < AreaListCount; i++ {
		var obj4_2_1 go_vthunder.EthernetIPv6AreaList
	...
	var obj4_3 go_vthunder.EthernetIPv6Isis
	prefix1 = "isis.0."
	...
	obj6.Priority = make([]go_vthunder.EthernetIPv6PriorityCfg, 0, PriorityCfgCount)

	for i := 0; i < PriorityCfgCount; i++ {
		var obj6_2 go_vthunder.EthernetIPv6PriorityCfg
	...
	obj6.HelloInterval = make([]go_vthunder.EthernetIPv6HelloIntervalCfg, 0, HelloIntervalCfgCount)

	for i := 0; i < HelloIntervalCfgCount; i++ {
		var obj6_3 go_vthunder.EthernetIPv6HelloIntervalCfg
	...
	obj6.MtuIgnore = make([]go_vthunder.EthernetIPv6MtuIgnoreCfg, 0, MtuIgnoreCfgCount)

	for i := 0; i < MtuIgnoreCfgCount; i++ {
		var obj6_4 go_vthunder.EthernetIPv6MtuIgnoreCfg
	...
	obj6.RetransmitInterval = make([]go_vthunder.EthernetIPv6RetransmitIntervalCfg, 0, RetransmitIntervalCfgCount)

	for i := 0; i < RetransmitIntervalCfgCount; i++ {
		var obj6_5 go_vthunder.EthernetIPv6RetransmitIntervalCfg
	...
	obj6.TransmitDelay = make([]go_vthunder.EthernetIPv6TransmitDelayCfg, 0, TransmitDelayCfgCount)

	for i := 0; i < TransmitDelayCfgCount; i++ {
		var obj6_6 go_vthunder.EthernetIPv6TransmitDelayCfg
	...
	obj6.NeighborPriority = make([]go_vthunder.EthernetIPv6NeighborCfg, 0, NeighborCfgCount)

	for i := 0; i < NeighborCfgCount; i++ {
		var obj6_7 go_vthunder.EthernetIPv6NeighborCfg
	...
	obj6.BroadcastType = make([]go_vthunder.EthernetIPv6NetworkList, 0, NetworkListCount)

	for i := 0; i < NetworkListCount; i++ {
		var obj6_8 go_vthunder.EthernetIPv6NetworkList
	...
	obj6.DeadInterval = make([]go_vthunder.EthernetIPv6DeadIntervalCfg, 0, DeadIntervalCfgCount)

	for i := 0; i < DeadIntervalCfgCount; i++ {
		var obj6_9 go_vthunder.EthernetIPv6DeadIntervalCfg
	...
	var obj7 go_vthunder.EthernetIPv6RouterAdver
	...
	obj7.NotAutonomous = make([]go_vthunder.EthernetIPv6PrefixList, 0, PrefixListCount)

	for i := 0; i < PrefixListCount; i++ {
		var obj7_1 go_vthunder.EthernetIPv6PrefixList
