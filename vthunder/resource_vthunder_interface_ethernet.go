...
func dataToInterfaceEthernet(d *schema.ResourceData) go_vthunder.InterfaceEthernet {
	...
	var obj1_3 go_vthunder.EthernetStatefulFirewallId
	...
	var obj1_6_2 go_vthunder.EthernetOspfGlobal
	...
	var obj1_6_2_1 go_vthunder.EthernetNetwork
	...
	var obj1_6_2_2 go_vthunder.EthernetAuthenticationCfg
	...
	var obj1_6_2_3 go_vthunder.EthernetBfdCfg
	...
	var obj1_6_2_4 go_vthunder.EthernetDatabaseFilterCfg
	...
	MessageDigestCfgCount := d.Get(prefix2 + "message_digest_cfg.#").(int)
	obj1_6_2.MessageDigestKey = make([]go_vthunder.EthernetMessageDigestCfg, 0, MessageDigestCfgCount)

	for i := 0; i < MessageDigestCfgCount; i++ {
		var obj1_6_2_5 go_vthunder.EthernetMessageDigestCfg
		prefix3 = prefix2 + fmt.Sprintf("message_digest_cfg.%d.", i)
		obj1_6_2_5.MessageDigestKey = d.Get(prefix3 + "message_digest_key").(int)

		var obj1_6_2_5_1 go_vthunder.EthernetMd5
		prefix4 := prefix3 + "md5.0."
	...
	var obj4_1 go_vthunder.EthernetTxDot1Cfg
	...
	var obj4_2 go_vthunder.EthernetNotificationCfg
	...
	var obj4_3 go_vthunder.EthernetEnableCfg
	...
	var obj4_4 go_vthunder.EthernetTxTlvsCfg
	...
	var obj5_1 go_vthunder.EthernetIntervalCfg
	...
	var obj5_2 go_vthunder.EthernetAuthentication2
	...
	for i := 0; i < TrunkGroupListCount; i++ {
		...
		var obj8_1 go_vthunder.EthernetUdldTimeoutCfg
	...
	for i := 0; i < DomainListCount; i++ {
		var obj9_1 go_vthunder.EthernetDomainList
	...
	var obj10 go_vthunder.EthernetIsis2
	prefix = "isis.0."
	...
	for i := 0; i < PriorityListCount; i++ {
		var obj10_1 go_vthunder.EthernetPriorityList
	...
	for i := 0; i < HelloIntervalMinimalListCount; i++ {
		var obj10_2 go_vthunder.EthernetHelloIntervalMinimalList
	...
	var obj10_3 go_vthunder.EthernetMeshGroup
	...
	var obj10_4 go_vthunder.EthernetAuthentication3
	prefix1 = prefix + "authentication.0."

	SendOnlyListCount := d.Get(prefix1 + "send_only_list.#").(int)
	obj10_4.SendOnly = make([]go_vthunder.EthernetSendOnlyList, 0, SendOnlyListCount)

	for i := 0; i < SendOnlyListCount; i++ {
		var obj10_4_1 go_vthunder.EthernetSendOnlyList
	...
	obj10_4.Mode = make([]go_vthunder.EthernetModeList, 0, ModeListCount)

	for i := 0; i < ModeListCount; i++ {
		var obj10_4_2 go_vthunder.EthernetModeList
	...
	obj10_4.KeyChain = make([]go_vthunder.EthernetKeyChainList, 0, KeyChainListCount)

	for i := 0; i < KeyChainListCount; i++ {
		var obj10_4_3 go_vthunder.EthernetKeyChainList
	...
	for i := 0; i < CsnpIntervalListCount; i++ {
		var obj10_5 go_vthunder.EthernetCsnpIntervalList
	...
	for i := 0; i < PasswordListCount; i++ {
		var obj10_6 go_vthunder.EthernetPasswordList
	...
	var obj10_7 go_vthunder.EthernetBfdCfg
	...
	for i := 0; i < WideMetricListCount; i++ {
		var obj10_8 go_vthunder.EthernetWideMetricList
	...
	for i := 0; i < HelloIntervalListCount; i++ {
		var obj10_9 go_vthunder.EthernetHelloIntervalList
	...
	for i := 0; i < HelloMultiplierListCount; i++ {
		var obj10_10 go_vthunder.EthernetHelloMultiplierList
	...
	for i := 0; i < MetricListCount; i++ {
		var obj10_11 go_vthunder.EthernetMetricList
	...
	for i := 0; i < AddressListCount; i++ {
		var obj12_1 go_vthunder.EthernetAddressList
		prefix1 = prefix + fmt.Sprintf("address_list.%d.", i)
	...
	var obj12_2 go_vthunder.EthernetRip2
	prefix1 = prefix + "rip.0."

	var obj12_2_1 go_vthunder.EthernetSplitHorizonCfg
	prefix2 = prefix1 + "split_horizon_cfg.0."
	...
	var obj12_3 go_vthunder.EthernetStatefulFirewall
	prefix1 = prefix + "stateful_firewall.0."
	...
	var obj12_4 go_vthunder.EthernetRouter2
	prefix1 = prefix + "router.0."

	var obj12_4_1 go_vthunder.EthernetRipng
	prefix2 = prefix1 + "ripng.0."
	obj12_4_1.Rip = d.Get(prefix2 + "rip").(int)
	obj12_4.UUID = obj12_4_1

	var obj12_4_2 go_vthunder.EthernetOspf2
	prefix2 = prefix1 + "ospf.0."

	AreaListCount := d.Get(prefix2 + "area_list.#").(int)
	obj12_4_2.AreaIDAddr = make([]go_vthunder.EthernetAreaList, 0, AreaListCount)

	for i := 0; i < AreaListCount; i++ {
		var obj12_4_2_1 go_vthunder.EthernetAreaList
	...
	var obj12_4_3 go_vthunder.EthernetIsis
	prefix2 = prefix1 + "isis.0."
	...
	var obj12_5 go_vthunder.EthernetAccessListCfg
	...
	var obj12_6 go_vthunder.EthernetOspf3
	prefix1 = prefix + "ospf.0."
	obj12_6.Bfd = d.Get(prefix1 + "bfd").(int)

	CostCfgCount := d.Get(prefix1 + "cost_cfg.#").(int)
	obj12_6.Cost = make([]go_vthunder.EthernetCostCfg, 0, CostCfgCount)

	for i := 0; i < CostCfgCount; i++ {
		var obj12_6_1 go_vthunder.EthernetCostCfg
	...
	obj12_6.Priority = make([]go_vthunder.EthernetPriorityCfg, 0, PriorityCfgCount)

	for i := 0; i < PriorityCfgCount; i++ {
		var obj12_6_2 go_vthunder.EthernetPriorityCfg
	...
	obj12_6.HelloInterval = make([]go_vthunder.EthernetHelloIntervalCfg, 0, HelloIntervalCfgCount)

	for i := 0; i < HelloIntervalCfgCount; i++ {
		var obj12_6_3 go_vthunder.EthernetHelloIntervalCfg
	...
	obj12_6.MtuIgnore = make([]go_vthunder.EthernetMtuIgnoreCfg, 0, MtuIgnoreCfgCount)

	for i := 0; i < MtuIgnoreCfgCount; i++ {
		var obj12_6_4 go_vthunder.EthernetMtuIgnoreCfg
	...
	obj12_6.RetransmitInterval = make([]go_vthunder.EthernetRetransmitIntervalCfg, 0, RetransmitIntervalCfgCount)

	for i := 0; i < RetransmitIntervalCfgCount; i++ {
		var obj12_6_5 go_vthunder.EthernetRetransmitIntervalCfg
	...
	obj12_6.TransmitDelay = make([]go_vthunder.EthernetTransmitDelayCfg, 0, TransmitDelayCfgCount)

	for i := 0; i < TransmitDelayCfgCount; i++ {
		var obj12_6_6 go_vthunder.EthernetTransmitDelayCfg
	...
	obj12_6.NeighborPriority = make([]go_vthunder.EthernetNeighborCfg, 0, NeighborCfgCount)

	for i := 0; i < NeighborCfgCount; i++ {
		var obj12_6_7 go_vthunder.EthernetNeighborCfg
	...
	obj12_6.BroadcastType = make([]go_vthunder.EthernetNetworkList, 0, NetworkListCount)

	for i := 0; i < NetworkListCount; i++ {
		var obj12_6_8 go_vthunder.EthernetNetworkList
	...
	obj12_6.DeadInterval = make([]go_vthunder.EthernetDeadIntervalCfg, 0, DeadIntervalCfgCount)

	for i := 0; i < DeadIntervalCfgCount; i++ {
		var obj12_6_9 go_vthunder.EthernetDeadIntervalCfg
	...
	var obj12_7 go_vthunder.EthernetRouterAdver
	...
	obj12_7.NotAutonomous = make([]go_vthunder.EthernetPrefixList, 0, PrefixListCount)

	for i := 0; i < PrefixListCount; i++ {
		var obj12_7_1 go_vthunder.EthernetPrefixList
