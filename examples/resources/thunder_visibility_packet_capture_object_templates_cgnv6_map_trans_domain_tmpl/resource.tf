...
resource "thunder_visibility_packet_capture_object_templates_cgnv6_map_trans_domain_tmpl" "thunder_visibility_packet_capture_object_templates_cgnv6_map_trans_domain_tmpl" {
