...
type FwTemplateLogging struct {
	IncludeHTTP FwTemplateLoggingInstance `json:"logging-instance,omitempty"`
}
...
type FwTemplateLoggingInstance struct {
	...
	HeaderCfg        FwTemplateLoggingIncludeHTTP            `json:"include-http,omitempty"`
	...
	RuleHTTPRequests FwTemplateLoggingRule                   `json:"rule,omitempty"`
