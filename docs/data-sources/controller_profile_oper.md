...
page_title: "thunder_controller_profile_oper Data Source - terraform-provider-thunder"
subcategory: ""
description: |-
  thunder_controller_profile_oper: Operational Status for the object profile
  PLACEHOLDER
---

# thunder_controller_profile_oper (Data Source)
...
- `number_of_orgunit_mapped_partitions` (Number)
- `number_of_orgunit_unmapped_partitions` (Number)
