...
- `chassis_incorrect_pu` (Number) chassis incorrect pu
...
- `data_session_created_sby` (Number) Data Session Created Standby
- `data_session_freed` (Number) Data Session Freed
- `data_session_freed_sby` (Number) Data Session Freed Standby
...
- `tcp_fullcone_created_sby` (Number) TCP Full-cone Session Created Standby
- `tcp_fullcone_freed` (Number) TCP Full-cone Session Freed
- `tcp_fullcone_freed_sby` (Number) TCP Full-cone Session Freed Standby
