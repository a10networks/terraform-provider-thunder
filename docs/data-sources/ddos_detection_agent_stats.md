...
- `xflow_dst_entry_miss_extend_byte_rcv` (Number) Extend Bytes Received of DDoS Destination Entry Miss
- `xflow_dst_entry_miss_extend_pkt_rcv` (Number) Extend Packets Received of DDoS Destination Entry Miss
- `xflow_dst_svc_miss_extend_byte_rcv` (Number) Extend Bytes Received of DDoS Destination Service Miss
