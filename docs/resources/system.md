...
- `cl_threat_category` (Block List, Max: 1) (see [below for nested schema](#nestedblock--cl_threat_category))
...
- `config_mgmt` (Block List, Max: 1) (see [below for nested schema](#nestedblock--config_mgmt))
...
- `domain_list_settings` (Block List, Max: 1) (see [below for nested schema](#nestedblock--domain_list_settings))
...
- `enable_disk_encryption` (Block List, Max: 1) (see [below for nested schema](#nestedblock--enable_disk_encryption))
...
- `rfc_ipfix_ie_spec` (String) 'enable': Use RFC-defined IPFIX information element lengths; 'disable': Use non-standard IPFIX information element lengths;
...
- `software_tcam` (Block List, Max: 1) (see [below for nested schema](#nestedblock--software_tcam))
...
<a id="nestedblock--cl_threat_category"></a>
### Nested Schema for `cl_threat_category`
...
<a id="nestedblock--config_mgmt"></a>
### Nested Schema for `config_mgmt`
...
- `mpm` (Block List, Max: 1) (see [below for nested schema](#nestedblock--config_mgmt--mpm))
- `notification` (Block List, Max: 1) (see [below for nested schema](#nestedblock--config_mgmt--notification))
- `pu_sync_detection` (Block List, Max: 1) (see [below for nested schema](#nestedblock--config_mgmt--pu_sync_detection))
- `uuid` (String) uuid of the object

<a id="nestedblock--config_mgmt--mpm"></a>
### Nested Schema for `config_mgmt.mpm`
...
<a id="nestedblock--config_mgmt--notification"></a>
### Nested Schema for `config_mgmt.notification`
...
<a id="nestedblock--config_mgmt--pu_sync_detection"></a>
### Nested Schema for `config_mgmt.pu_sync_detection`
...
<a id="nestedblock--domain_list_settings"></a>
### Nested Schema for `domain_list_settings`
...
<a id="nestedblock--enable_disk_encryption"></a>
### Nested Schema for `enable_disk_encryption`
...
- `geo_location_load_temp_include_ipv6` (Number) Include IPv6 address
- `template_name` (String) Use CSV template to load this file
...
- `uuid` (String) uuid of the object
- `white_list` (String) Bind exception-list (class-list name)
...
- `monitoring_mode` (Block List, Max: 1) (see [below for nested schema](#nestedblock--mon_template--monitoring_mode))
...
- `clear_all_partition` (String) Partition name to clear
- `clear_all_partition_all` (Number) Clear all partitions
- `clear_all_sequence` (Number) Sequence number (Specify the port physical port number)
- `clear_partition` (String) Partition name to clear
- `clear_partition_all` (Number) Clear all partitions
...
<a id="nestedblock--mon_template--monitoring_mode"></a>
### Nested Schema for `mon_template.monitoring_mode`
...
- `derived_attribute` (Block List, Max: 1) (see [below for nested schema](#nestedblock--radius--server--derived_attribute))
...
<a id="nestedblock--radius--server--derived_attribute"></a>
### Nested Schema for `radius.server.derived_attribute`

Optional:

- `usergroup` (Block List, Max: 1) (see [below for nested schema](#nestedblock--radius--server--derived_attribute--usergroup))
- `userid` (Block List, Max: 1) (see [below for nested schema](#nestedblock--radius--server--derived_attribute--userid))

<a id="nestedblock--radius--server--derived_attribute--usergroup"></a>
### Nested Schema for `radius.server.derived_attribute.usergroup`
...
<a id="nestedblock--radius--server--derived_attribute--userid"></a>
### Nested Schema for `radius.server.derived_attribute.userid`
...
<a id="nestedblock--software_tcam"></a>
### Nested Schema for `software_tcam`
...
- `http` (Number) set timeout to stop http transfer in seconds
- `https` (Number) set timeout to stop https transfer in seconds
