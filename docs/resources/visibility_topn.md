...
- `templ_gtp_plcy_topn_node` (Block List, Max: 1) (see [below for nested schema](#nestedblock--templ_gtp_plcy_topn_node))
- `templ_gtp_plcy_topn_tmpl_list` (Block List) (see [below for nested schema](#nestedblock--templ_gtp_plcy_topn_tmpl_list))
...
<a id="nestedblock--gtp_network_element_topn_node"></a>
...
<a id="nestedblock--templ_gtp_plcy_topn_node"></a>
### Nested Schema for `templ_gtp_plcy_topn_node`
...
<a id="nestedblock--templ_gtp_plcy_topn_tmpl_list"></a>
### Nested Schema for `templ_gtp_plcy_topn_tmpl_list`
...
- `interval` (String) '5': 5 minutes; '15': 15 minutes; '30': 30 minutes; '60': 60 minutes; 'all-time': Since template is activated;
- `metrics` (Block List, Max: 1) (see [below for nested schema](#nestedblock--templ_gtp_plcy_topn_tmpl_list--metrics))
- `topn_size` (Number) Congure value of N for topn
- `user_tag` (String) Customized tag
- `uuid` (String) uuid of the object

<a id="nestedblock--templ_gtp_plcy_topn_tmpl_list--metrics"></a>
### Nested Schema for `templ_gtp_plcy_topn_tmpl_list.metrics`
