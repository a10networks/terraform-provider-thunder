...
- `baseline_window_size` (Number) Configure baseline window size in minutes, 0 means disable
...
- `inbound_mitigation_enforce_enable` (Number) Enable mitigation actions for outbound-initiated connections
...
- `operational_mode` (String) 'idle': Idle mode; 'monitor': Monitor mode; 'learning': Learning mode; 'bypass': Bypass mode;
...
- `sflow_common` (Number) Enable sFlow counter polling packets, tcp-basic, tcp-stateful and http. WARNING: May induce heavy CPU load.
- `sflow_http` (Number) Enable sFlow HTTP counter polling. WARNING: May induce heavy CPU load.
- `sflow_layer_4` (Number) Enable sFlow Layer 4 counter polling. WARNING: May induce heavy CPU load.
- `sflow_packets` (Number) Enable sFlow packet-level counter polling. WARNING: May induce heavy CPU load.
...
- `zone_migrate_to_opposite` (Number) Migrate zone to opposite PU
...
- `topk_num_records` (Number) Maximum number of records to show in topk
- `topk_sort_key` (String) 'avg': window average; 'max-peak': max peak;
...
- `default_action_list` (String) Configure default-action-list in ip-proto
...
- `log_src_default_enable` (Number) Enable src default logging in ip-proto
...
- `set_counter_base_val` (Number) Set T2 counter value of current context to specified value
- `sflow_ip_filtering_policy` (Number) Enable sFlow IP filtering policy per port per rule counter polling
...
- `topk_dst_sort_key` (String) 'avg': window average; 'max-peak': max peak;
- `topk_num_records` (Number) Maximum number of records to show in topk
- `topk_sort_key` (String) 'avg': window average; 'max-peak': max peak;
...
- `action` (String) 'bypass': Always permit for the Source to bypass all feature & limit checks; 'deny': Blacklist incoming packets for service;
- `class_list_glid` (String) Global limit ID (class-list based)
...
- `same_source_dest_port_drop` (Number) Drop packet with same Source Port and Dest Port
- `set_counter_base_val` (Number) Set T2 counter value of current context to specified value
- `sflow_ip_filtering_policy` (Number) Enable sFlow IP filtering policy per port per rule counter polling
- `uuid` (String) uuid of the object
...
- `default_action_list` (String) Configure default-action-list in zone-service
...
- `log_src_default_enable` (Number) Enable src default logging in zone-service
- `manual_mode_enable` (Number) Toggle manual mode to use fix templates
...
- `clear_sources_upon_deescalation` (Number) Clear sources upon de-escalation from level 1 to 0 or manual to 0
- `close_sessions_for_all_sources` (Number) Close session for all sources
...
- `sflow_samp_sni` (Number) Enable sFlow Auto-Discoverd SNI Sampling
...
- `source_tracking_all` (Number) enable creation of source entries for all virtualhosts
- `uuid` (String) uuid of the object
...
- `deny` (Number) Blacklist and Drop all incoming packets for protocol
- `glid_cfg` (Block List, Max: 1) (see [below for nested schema](#nestedblock--port--zone_service_list--virtualhosts--virtualhost_list--glid_cfg))
- `level_list` (Block List) (see [below for nested schema](#nestedblock--port--zone_service_list--virtualhosts--virtualhost_list--level_list))
- `servername` (Block List) (see [below for nested schema](#nestedblock--port--zone_service_list--virtualhosts--virtualhost_list--servername))
...
<a id="nestedblock--port--zone_service_list--virtualhosts--virtualhost_list--glid_cfg"></a>
### Nested Schema for `port.zone_service_list.virtualhosts.virtualhost_list.glid_cfg`
...
<a id="nestedblock--port--zone_service_list--virtualhosts--virtualhost_list--level_list"></a>
### Nested Schema for `port.zone_service_list.virtualhosts.virtualhost_list.level_list`
...
- `user_tag` (String) Customized tag
- `uuid` (String) uuid of the object
- `zone_template` (Block List, Max: 1) (see [below for nested schema](#nestedblock--port--zone_service_list--virtualhosts--virtualhost_list--level_list--zone_template))

<a id="nestedblock--port--zone_service_list--virtualhosts--virtualhost_list--level_list--zone_template"></a>
### Nested Schema for `port.zone_service_list.virtualhosts.virtualhost_list.level_list.zone_template`
...
<a id="nestedblock--port--zone_service_list--virtualhosts--virtualhost_list--servername"></a>
### Nested Schema for `port.zone_service_list.virtualhosts.virtualhost_list.servername`
...
- `log_src_default_enable` (Number) Enable src default logging
- `manual_mode_enable` (Number) Toggle manual mode to use fix templates
...
- `deny` (Number) Blacklist and Drop all incoming packets for protocol
- `glid_cfg` (Block List, Max: 1) (see [below for nested schema](#nestedblock--port_range_list--virtualhosts--virtualhost_list--glid_cfg))
- `level_list` (Block List) (see [below for nested schema](#nestedblock--port_range_list--virtualhosts--virtualhost_list--level_list))
- `servername` (Block List) (see [below for nested schema](#nestedblock--port_range_list--virtualhosts--virtualhost_list--servername))
...
<a id="nestedblock--port_range_list--virtualhosts--virtualhost_list--glid_cfg"></a>
### Nested Schema for `port_range_list.virtualhosts.virtualhost_list.glid_cfg`
...
<a id="nestedblock--port_range_list--virtualhosts--virtualhost_list--level_list"></a>
### Nested Schema for `port_range_list.virtualhosts.virtualhost_list.level_list`
...
- `user_tag` (String) Customized tag
- `uuid` (String) uuid of the object
- `zone_template` (Block List, Max: 1) (see [below for nested schema](#nestedblock--port_range_list--virtualhosts--virtualhost_list--level_list--zone_template))

<a id="nestedblock--port_range_list--virtualhosts--virtualhost_list--level_list--zone_template"></a>
### Nested Schema for `port_range_list.virtualhosts.virtualhost_list.level_list.zone_template`
...
<a id="nestedblock--port_range_list--virtualhosts--virtualhost_list--servername"></a>
### Nested Schema for `port_range_list.virtualhosts.virtualhost_list.servername`
...
- `sflow_samp_packet` (Number) Enable sFlow Packet Sampling
- `sflow_samp_session` (Number) Enable sFlow Zone Session Sampling
- `sflow_tcp_basic` (Number) Enable sFlow basic TCP counter polling. WARNING: May induce heavy CPU load.
- `sflow_tcp_stateful` (Number) Enable sFlow stateful TCP counter polling. WARNING: May induce heavy CPU load.
...
- `sampling_enable` (Block List) (see [below for nested schema](#nestedblock--src_ip_filtering--sampling_enable))
- `uuid` (String) uuid of the object

<a id="nestedblock--src_ip_filtering--sampling_enable"></a>
### Nested Schema for `src_ip_filtering.sampling_enable`
