...
page_title: "thunder_ddos_dst_zone_port_zone_service Resource - terraform-provider-thunder"
subcategory: ""
description: |-
  thunder_ddos_dst_zone_port_zone_service: DDOS Port & Protocol configuration
  PLACEHOLDER
---

# thunder_ddos_dst_zone_port_zone_service (Resource)
...
- `virtualhosts` (Block List, Max: 1) (see [below for nested schema](#nestedblock--virtualhosts))
...
<a id="nestedblock--virtualhosts"></a>
### Nested Schema for `virtualhosts`
...
- `virtualhost_list` (Block List) (see [below for nested schema](#nestedblock--virtualhosts--virtualhost_list))

<a id="nestedblock--virtualhosts--virtualhost_list"></a>
### Nested Schema for `virtualhosts.virtualhost_list`
...
- `deny` (Number) Blacklist and Drop all incoming packets for protocol
- `glid_cfg` (Block List, Max: 1) (see [below for nested schema](#nestedblock--virtualhosts--virtualhost_list--glid_cfg))
- `level_list` (Block List) (see [below for nested schema](#nestedblock--virtualhosts--virtualhost_list--level_list))
- `servername` (Block List) (see [below for nested schema](#nestedblock--virtualhosts--virtualhost_list--servername))
...
<a id="nestedblock--virtualhosts--virtualhost_list--glid_cfg"></a>
### Nested Schema for `virtualhosts.virtualhost_list.glid_cfg`
...
<a id="nestedblock--virtualhosts--virtualhost_list--level_list"></a>
### Nested Schema for `virtualhosts.virtualhost_list.level_list`
...
- `user_tag` (String) Customized tag
- `uuid` (String) uuid of the object
- `zone_template` (Block List, Max: 1) (see [below for nested schema](#nestedblock--virtualhosts--virtualhost_list--level_list--zone_template))

<a id="nestedblock--virtualhosts--virtualhost_list--level_list--zone_template"></a>
### Nested Schema for `virtualhosts.virtualhost_list.level_list.zone_template`
...
<a id="nestedblock--virtualhosts--virtualhost_list--servername"></a>
### Nested Schema for `virtualhosts.virtualhost_list.servername`
