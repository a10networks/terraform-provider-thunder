...
page_title: "thunder_visibility_topn_gtp_apn_prefix_topn_tmpl_metrics Resource - terraform-provider-thunder"
subcategory: ""
description: |-
  thunder_visibility_topn_gtp_apn_prefix_topn_tmpl_metrics: Configure topn metrics for fw.gtp.apn-prefix
  PLACEHOLDER
---

# thunder_visibility_topn_gtp_apn_prefix_topn_tmpl_metrics (Resource)
...
- `gtp_apn_prefix_topn_tmpl_name` (String) Gtp_apn_prefix_topn_tmpl_name
