...
- `ssl_l4_tmpl_name` (String) DDOS SSL-L4 Template Name
...
- `ssl_handshake_policy` (Block List, Max: 1) (see [below for nested schema](#nestedblock--ssl_handshake_policy))
...
<a id="nestedblock--ssl_handshake_policy"></a>
### Nested Schema for `ssl_handshake_policy`
