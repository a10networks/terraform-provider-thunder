...
- `ipv4` (String) 'up': Scaleout is up and running; 'down': Scaleout is down or disabled;
- `ipv6` (String) 'up': Scaleout is up and running; 'down': Scaleout is down or disabled;
