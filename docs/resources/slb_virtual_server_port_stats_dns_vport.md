...
- `virtual_server_name` (String) Virtual_server_name
...
- `dns_category_action_drop` (Number) DNS Category Action Drop
- `dns_category_action_permit` (Number) DNS Category Action Permit
- `dns_category_action_respond` (Number) DNS Category Action Respond
- `dns_category_async_received` (Number) DNS Category Async Result Received
- `dns_category_async_sent` (Number) DNS Category Async Request Sent
- `dns_category_bypass` (Number) DNS Category Bypass
- `dns_category_no_local_result` (Number) Cannot find DNS Category in local DB
- `dns_category_resp_a` (Number) DNS Category Action Type A
- `dns_category_resp_aaaa` (Number) DNS Category Action Type AAAA
- `dns_category_resp_cname` (Number) DNS Category Action Type CNAME
- `dns_category_resp_noanswer` (Number) DNS Category Action NO Answer
- `dns_category_resp_nxdomain` (Number) DNS Category Action NXDomain
...
- `dns_filter_tld_drop` (Number) counters Total DNS Filter TLD Drop
...
- `dns_recursive_resolution_late_ans` (Number) DNS Recursive Resolution Parallel Queries Late Response
...
- `dns_recursive_resolution_response_receive` (Number) DNS Recursive Resolution Response Receive
...
- `dns_recursive_resolution_tcp_conn` (Number) DNS Recursive Resolution TCP Conn Created for Parallel Queries
...
- `dns_recursive_resolution_udp_conn` (Number) DNS Recursive Resolution UDP Conn Created for Parallel Queries
...
- `dnsrrl_nx_drop` (Number) DNS Response-Rate-Limiting NXDomain Drop (Client-Side)
- `dnsrrl_nx_exceed` (Number) DNS Response-Rate-Limiting NXDomain Exceed (Server-Side)
- `dnsrrl_qps_drop` (Number) DNS Response-Rate-Limiting QPS Drop
...
- `rcode_notzone_receive` (Number) response rcode name not in zone receive
...
- `rcode_tsig_badkey_receive` (Number) response rcode TSIG key or algorithm not recognized receive
- `rcode_tsig_badsig_receive` (Number) response rcode TSIG signature failure receive
- `rcode_tsig_badtime_receive` (Number) response rcode TSIG time checking error receive
- `rcode_tsig_badtrunc_receive` (Number) response rcode TSIG MAC truncation error receive
