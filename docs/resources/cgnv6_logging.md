...
- `pool_based_log` (Block List, Max: 1) (see [below for nested schema](#nestedblock--pool_based_log))
...
<a id="nestedblock--pool_based_log"></a>
### Nested Schema for `pool_based_log`
