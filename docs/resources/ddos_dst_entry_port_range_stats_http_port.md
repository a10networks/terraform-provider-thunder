...
page_title: "thunder_ddos_dst_entry_port_range_stats_http_port Resource - terraform-provider-thunder"
subcategory: ""
description: |-
  thunder_ddos_dst_entry_port_range_stats_http_port: Statistics for the object port-range
  PLACEHOLDER
---

# thunder_ddos_dst_entry_port_range_stats_http_port (Resource)
...
- `http_port` (Block List, Max: 1) (see [below for nested schema](#nestedblock--stats--http_port))

<a id="nestedblock--stats--http_port"></a>
### Nested Schema for `stats.http_port`
