...
- `alias_rate_threshold` (Number) ALIAS(Record Type 65300) Query Forwarding Rate Limit (Only for DNS Cache Mode)
...
- `dnssec_wildcard_rate_threshold` (Number) DNSSEC Wildcard Query Forwarding Rate Limit (only for DNS Cache Mode)
