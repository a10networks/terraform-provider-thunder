...
page_title: "thunder_system_radius_server Resource - terraform-provider-thunder"
subcategory: ""
description: |-
  thunder_system_radius_server: Configure system as a RADIUS server
  PLACEHOLDER
---

# thunder_system_radius_server (Resource)
...
- `derived_attribute` (Block List, Max: 1) (see [below for nested schema](#nestedblock--derived_attribute))
...
<a id="nestedblock--derived_attribute"></a>
### Nested Schema for `derived_attribute`

Optional:

- `usergroup` (Block List, Max: 1) (see [below for nested schema](#nestedblock--derived_attribute--usergroup))
- `userid` (Block List, Max: 1) (see [below for nested schema](#nestedblock--derived_attribute--userid))

<a id="nestedblock--derived_attribute--usergroup"></a>
### Nested Schema for `derived_attribute.usergroup`
...
<a id="nestedblock--derived_attribute--userid"></a>
### Nested Schema for `derived_attribute.userid`
