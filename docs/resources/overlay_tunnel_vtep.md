...
- `remote_ipv6_vtep` (String) Configure the VTEP IPv6 address (IPv6 address of the VTEP for the remote host)
...
- `ipv6_addr` (String) IPv6 address of the overlay host
- `uuid` (String) uuid of the object
...
- `uuid` (String) uuid of the object
- `vni_list` (Block List) (see [below for nested schema](#nestedblock--local_ipv6_address--vni_list))

<a id="nestedblock--local_ipv6_address--vni_list"></a>
### Nested Schema for `local_ipv6_address.vni_list`
...
- `class_list` (String) Name of the class-list
...
- `class_list` (String) Name of the class-list
- `encap` (String) 'vxlan': Tunnel Encapsulation Type is VXLAN;
- `gre_keepalive` (Block List, Max: 1) (see [below for nested schema](#nestedblock--remote_ipv6_address_list--gre_keepalive))
- `use_gre_key` (Block List, Max: 1) (see [below for nested schema](#nestedblock--remote_ipv6_address_list--use_gre_key))
- `use_lif` (Block List, Max: 1) (see [below for nested schema](#nestedblock--remote_ipv6_address_list--use_lif))
- `user_tag` (String) Customized tag
- `uuid` (String) uuid of the object
- `vni_list` (Block List) (see [below for nested schema](#nestedblock--remote_ipv6_address_list--vni_list))

<a id="nestedblock--remote_ipv6_address_list--gre_keepalive"></a>
### Nested Schema for `remote_ipv6_address_list.gre_keepalive`
...
<a id="nestedblock--remote_ipv6_address_list--use_gre_key"></a>
### Nested Schema for `remote_ipv6_address_list.use_gre_key`
...
<a id="nestedblock--remote_ipv6_address_list--vni_list"></a>
### Nested Schema for `remote_ipv6_address_list.vni_list`
