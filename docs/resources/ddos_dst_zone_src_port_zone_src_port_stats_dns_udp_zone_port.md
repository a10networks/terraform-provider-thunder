...
page_title: "thunder_ddos_dst_zone_src_port_zone_src_port_stats_dns_udp_zone_port Resource - terraform-provider-thunder"
subcategory: ""
description: |-
  thunder_ddos_dst_zone_src_port_zone_src_port_stats_dns_udp_zone_port: Statistics for the object zone-src-port
  PLACEHOLDER
---

# thunder_ddos_dst_zone_src_port_zone_src_port_stats_dns_udp_zone_port (Resource)
...
- `dns_udp_zone_port` (Block List, Max: 1) (see [below for nested schema](#nestedblock--stats--dns_udp_zone_port))

<a id="nestedblock--stats--dns_udp_zone_port"></a>
### Nested Schema for `stats.dns_udp_zone_port`
...
- `src_udp_auth_init` (Number) Src Auth UDP Init
...
- `udp_auth_init` (Number) Auth UDP Init
