...
page_title: "thunder_ddos_dst_entry_src_port_stats_udp_port Resource - terraform-provider-thunder"
subcategory: ""
description: |-
  thunder_ddos_dst_entry_src_port_stats_udp_port: Statistics for the object src-port
  PLACEHOLDER
---

# thunder_ddos_dst_entry_src_port_stats_udp_port (Resource)
