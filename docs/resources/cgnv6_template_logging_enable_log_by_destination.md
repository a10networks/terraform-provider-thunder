...
page_title: "thunder_cgnv6_template_logging_enable_log_by_destination Resource - terraform-provider-thunder"
subcategory: ""
description: |-
  thunder_cgnv6_template_logging_enable_log_by_destination: Enable CGNAT logging by the destination IP address, protocol, and port
  PLACEHOLDER
---

# thunder_cgnv6_template_logging_enable_log_by_destination (Resource)
