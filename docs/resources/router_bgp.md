...
- `public_ip_cfg` (Block List, Max: 1) (see [below for nested schema](#nestedblock--address_family--ipv6--redistribute--public_ip_cfg))
...
<a id="nestedblock--address_family--ipv6--redistribute--public_ip_cfg"></a>
### Nested Schema for `address_family.ipv6.redistribute.public_ip_cfg`

Optional:

- `public_ip` (Number) Public IPv6/IPv4 Prefixes
- `route_map` (String) Route map reference (Pointer to route-map entries)
...
- `public_ip_cfg` (Block List, Max: 1) (see [below for nested schema](#nestedblock--redistribute--public_ip_cfg))
...
<a id="nestedblock--redistribute--public_ip_cfg"></a>
### Nested Schema for `redistribute.public_ip_cfg`
