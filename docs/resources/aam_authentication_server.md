...
- `message_authenticator_verify_enable` (Number) Verify Message-Authenticator attribute
- `packet_capture_template` (String) Name of the packet capture template to be bind with this object
