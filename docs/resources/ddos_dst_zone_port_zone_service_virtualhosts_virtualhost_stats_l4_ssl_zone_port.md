...
page_title: "thunder_ddos_dst_zone_port_zone_service_virtualhosts_virtualhost_stats_l4_ssl_zone_port Resource - terraform-provider-thunder"
subcategory: ""
description: |-
  thunder_ddos_dst_zone_port_zone_service_virtualhosts_virtualhost_stats_l4_ssl_zone_port: Statistics for the object virtualhost
  PLACEHOLDER
---

# thunder_ddos_dst_zone_port_zone_service_virtualhosts_virtualhost_stats_l4_ssl_zone_port (Resource)
...
- `l4_ssl_zone_port` (Block List, Max: 1) (see [below for nested schema](#nestedblock--stats--l4_ssl_zone_port))

<a id="nestedblock--stats--l4_ssl_zone_port"></a>
### Nested Schema for `stats.l4_ssl_zone_port`
