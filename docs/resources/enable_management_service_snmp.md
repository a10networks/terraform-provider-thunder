...
- `lif_cfg` (Block List, Max: 1) (see [below for nested schema](#nestedblock--lif_cfg))
...
- `lif_cfg` (Block List, Max: 1) (see [below for nested schema](#nestedblock--acl_v4_list--lif_cfg))
...
<a id="nestedblock--acl_v4_list--lif_cfg"></a>
### Nested Schema for `acl_v4_list.lif_cfg`

Optional:

- `lif` (String) Lif name (Lif interface name)
...
- `lif_cfg` (Block List, Max: 1) (see [below for nested schema](#nestedblock--acl_v6_list--lif_cfg))
- `management` (Number) Management Interface
...
<a id="nestedblock--acl_v6_list--lif_cfg"></a>
### Nested Schema for `acl_v6_list.lif_cfg`
...
<a id="nestedblock--lif_cfg"></a>
### Nested Schema for `lif_cfg`
