...
- `encap` (Block List, Max: 1) (see [below for nested schema](#nestedblock--traffic_redirection--encap))
...
<a id="nestedblock--traffic_redirection--encap"></a>
### Nested Schema for `traffic_redirection.encap`
