...
- `edns_udp_size` (Number) Set the global maximum EDNS UDP message size (Default: 1232)
...
- `minimal_truncation_responses` (Number) Enable sending an empty DNS message when the response is truncated.
