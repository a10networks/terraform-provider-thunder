...
page_title: "thunder_interface_tunnel_ip Resource - terraform-provider-thunder"
subcategory: ""
description: |-
  thunder_interface_tunnel_ip: Global IP configuration subcommands
  PLACEHOLDER
---

# thunder_interface_tunnel_ip (Resource)
...
- `ip_cfg` (Block List) (see [below for nested schema](#nestedblock--address--ip_cfg))

<a id="nestedblock--address--ip_cfg"></a>
### Nested Schema for `address.ip_cfg`
