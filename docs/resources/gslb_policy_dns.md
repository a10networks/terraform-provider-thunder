...
- `sticky_options` (Block List, Max: 1) (see [below for nested schema](#nestedblock--sticky_options))
...
<a id="nestedblock--sticky_options"></a>
### Nested Schema for `sticky_options`
