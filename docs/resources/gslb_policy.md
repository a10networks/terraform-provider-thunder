...
- `connection_count_by_site` (Block List, Max: 1) (see [below for nested schema](#nestedblock--connection_count_by_site))
...
- `prefer_dns_sticky` (Number) Use dns sticky if available
...
- `sticky_difference` (Number) The difference between the round-delay-time of sticky entry
...
<a id="nestedblock--connection_count_by_site"></a>
### Nested Schema for `connection_count_by_site`
...
- `sticky_options` (Block List, Max: 1) (see [below for nested schema](#nestedblock--dns--sticky_options))
...
<a id="nestedblock--dns--sticky_options"></a>
### Nested Schema for `dns.sticky_options`
