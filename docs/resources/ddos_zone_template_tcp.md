...
- `name` (String) DDOS TCP Template Name
...
- `age_out_reset_server` (Number) Send TCP reset to server if aging time has passed
- `age_second` (Number) Session age in seconds
...
- `no_conn_rst_rate` (Number) Rate limit the number of RST to send out for create-conn-on-syn-only
...
- `small_win_cfg` (Block List, Max: 1) (see [below for nested schema](#nestedblock--small_win_cfg))
...
- `tcp_half_open_timeout` (Number) TCP half-open session age in seconds
- `tcp_half_open_timeout_reset_server` (Number) Send TCP reset to server if TCP half-open session timeout
...
- `mitigation` (Block List, Max: 1) (see [below for nested schema](#nestedblock--progression_tracking--mitigation))
- `profiling` (Block List, Max: 1) (see [below for nested schema](#nestedblock--progression_tracking--profiling))
- `progression_tracking_enabled` (String) 'enable-check': Enable Progression Tracking Check;
- `uuid` (String) uuid of the object

<a id="nestedblock--progression_tracking--mitigation"></a>
### Nested Schema for `progression_tracking.mitigation`

Optional:

- `connection_tracking` (Block List, Max: 1) (see [below for nested schema](#nestedblock--progression_tracking--mitigation--connection_tracking))
- `request_tracking` (Block List, Max: 1) (see [below for nested schema](#nestedblock--progression_tracking--mitigation--request_tracking))
- `slow_attack` (Block List, Max: 1) (see [below for nested schema](#nestedblock--progression_tracking--mitigation--slow_attack))
- `time_window_tracking` (Block List, Max: 1) (see [below for nested schema](#nestedblock--progression_tracking--mitigation--time_window_tracking))

<a id="nestedblock--progression_tracking--mitigation--connection_tracking"></a>
### Nested Schema for `progression_tracking.mitigation.connection_tracking`
...
<a id="nestedblock--progression_tracking--mitigation--request_tracking"></a>
### Nested Schema for `progression_tracking.mitigation.request_tracking`
...
<a id="nestedblock--progression_tracking--mitigation--slow_attack"></a>
### Nested Schema for `progression_tracking.mitigation.slow_attack`
...
- `slow_attacker_identification` (Block List, Max: 1) (see [below for nested schema](#nestedblock--progression_tracking--mitigation--slow_attack--slow_attacker_identification))
- `uuid` (String) uuid of the object

<a id="nestedblock--progression_tracking--mitigation--slow_attack--slow_attacker_identification"></a>
### Nested Schema for `progression_tracking.mitigation.slow_attack.slow_attacker_identification`
...
<a id="nestedblock--progression_tracking--mitigation--time_window_tracking"></a>
### Nested Schema for `progression_tracking.mitigation.time_window_tracking`
...
<a id="nestedblock--progression_tracking--profiling"></a>
### Nested Schema for `progression_tracking.profiling`
...
<a id="nestedblock--small_win_cfg"></a>
### Nested Schema for `small_win_cfg`

Optional:

- `small_window` (Number) Smallest allowed window size
- `small_window_action` (String) 'drop': Drop packets for small-window exceed (Default); 'blacklist-src': help Blacklist-src for small-window exceed; 'ignore': Ignore small-window exceed;
- `small_window_action_list_name` (String) Configure action-list to take for small window exceed
- `small_window_threshold` (Number) Take action if small window pkts exceed configured threshold
...
- `fail_on_ack` (Number) Enable fail action on bare-ACK if configured
