...
page_title: "thunder_ddos_dst_zone_port_zone_service_stats_sip_udp_zone_port Resource - terraform-provider-thunder"
subcategory: ""
description: |-
  thunder_ddos_dst_zone_port_zone_service_stats_sip_udp_zone_port: Statistics for the object zone-service
  PLACEHOLDER
---

# thunder_ddos_dst_zone_port_zone_service_stats_sip_udp_zone_port (Resource)
...
- `sip_udp_zone_port` (Block List, Max: 1) (see [below for nested schema](#nestedblock--stats--sip_udp_zone_port))

<a id="nestedblock--stats--sip_udp_zone_port"></a>
### Nested Schema for `stats.sip_udp_zone_port`
