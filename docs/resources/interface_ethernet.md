...
- `dac_link_training_enable` (Number) turn on the DAC-IEEE-LINK-TRAINING
...
- `traffic_distribution_mode` (String) 'sip': sip; 'dip': dip; 'l3-lookup': l3-lookup; 'primary': primary; 'blade': blade; 'l4-src-port': l4-src-port; 'l4-dst-port': l4-dst-port;
...
- `dmz` (Number) DMZ network facing interface for IPv4/v6 traffic
