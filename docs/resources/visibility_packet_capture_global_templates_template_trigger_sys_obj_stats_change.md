...
- `cgnv6_icmp` (Block List, Max: 1) (see [below for nested schema](#nestedblock--cgnv6_icmp))
...
- `slb_rc_cache` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_rc_cache))
...
- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--aam_auth_saml_global--trigger_stats_inc))
...
<a id="nestedblock--cgnv6_fixed_nat_alg_rtsp"></a>
...
<a id="nestedblock--cgnv6_lsn_alg_h323--trigger_stats_inc"></a>
...
<a id="nestedblock--cgnv6_lsn_alg_rtsp--trigger_stats_inc"></a>
...
<a id="nestedblock--fw_global--trigger_stats_inc"></a>
...
<a id="nestedblock--fw_rad_server--trigger_stats_rate"></a>
### Nested Schema for `fw_rad_server.trigger_stats_rate`
...
<a id="nestedblock--fw_tcp_syn_cookie"></a>
### Nested Schema for `fw_tcp_syn_cookie`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--fw_tcp_syn_cookie--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--fw_tcp_syn_cookie--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--fw_tcp_syn_cookie--trigger_stats_inc"></a>
### Nested Schema for `fw_tcp_syn_cookie.trigger_stats_inc`
...
<a id="nestedblock--fw_tcp_syn_cookie--trigger_stats_rate"></a>
### Nested Schema for `fw_tcp_syn_cookie.trigger_stats_rate`
...
<a id="nestedblock--ip_anomaly_drop"></a>
### Nested Schema for `ip_anomaly_drop`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--ip_anomaly_drop--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--ip_anomaly_drop--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--ip_anomaly_drop--trigger_stats_inc"></a>
### Nested Schema for `ip_anomaly_drop.trigger_stats_inc`
...
<a id="nestedblock--ip_anomaly_drop--trigger_stats_rate"></a>
### Nested Schema for `ip_anomaly_drop.trigger_stats_rate`
...
<a id="nestedblock--logging_local_log_global"></a>
### Nested Schema for `logging_local_log_global`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--logging_local_log_global--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--logging_local_log_global--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--logging_local_log_global--trigger_stats_inc"></a>
### Nested Schema for `logging_local_log_global.trigger_stats_inc`
...
<a id="nestedblock--logging_local_log_global--trigger_stats_rate"></a>
### Nested Schema for `logging_local_log_global.trigger_stats_rate`
...
<a id="nestedblock--slb_aflow"></a>
### Nested Schema for `slb_aflow`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_aflow--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_aflow--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--slb_aflow--trigger_stats_inc"></a>
### Nested Schema for `slb_aflow.trigger_stats_inc`
...
<a id="nestedblock--slb_aflow--trigger_stats_rate"></a>
### Nested Schema for `slb_aflow.trigger_stats_rate`
...
<a id="nestedblock--slb_conn_reuse"></a>
### Nested Schema for `slb_conn_reuse`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_conn_reuse--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_conn_reuse--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--slb_conn_reuse--trigger_stats_inc"></a>
### Nested Schema for `slb_conn_reuse.trigger_stats_inc`
...
<a id="nestedblock--slb_conn_reuse--trigger_stats_rate"></a>
### Nested Schema for `slb_conn_reuse.trigger_stats_rate`
...
<a id="nestedblock--slb_crl_srcip"></a>
### Nested Schema for `slb_crl_srcip`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_crl_srcip--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_crl_srcip--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--slb_crl_srcip--trigger_stats_inc"></a>
### Nested Schema for `slb_crl_srcip.trigger_stats_inc`
...
<a id="nestedblock--slb_crl_srcip--trigger_stats_rate"></a>
### Nested Schema for `slb_crl_srcip.trigger_stats_rate`
...
<a id="nestedblock--slb_fast_http"></a>
### Nested Schema for `slb_fast_http`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_fast_http--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_fast_http--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--slb_fast_http--trigger_stats_inc"></a>
### Nested Schema for `slb_fast_http.trigger_stats_inc`
...
<a id="nestedblock--slb_fast_http--trigger_stats_rate"></a>
### Nested Schema for `slb_fast_http.trigger_stats_rate`
...
<a id="nestedblock--slb_fix"></a>
### Nested Schema for `slb_fix`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_fix--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_fix--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--slb_fix--trigger_stats_inc"></a>
### Nested Schema for `slb_fix.trigger_stats_inc`
...
<a id="nestedblock--slb_fix--trigger_stats_rate"></a>
### Nested Schema for `slb_fix.trigger_stats_rate`
...
<a id="nestedblock--slb_ftp_proxy"></a>
### Nested Schema for `slb_ftp_proxy`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_ftp_proxy--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_ftp_proxy--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--slb_ftp_proxy--trigger_stats_inc"></a>
### Nested Schema for `slb_ftp_proxy.trigger_stats_inc`
...
<a id="nestedblock--slb_ftp_proxy--trigger_stats_rate"></a>
### Nested Schema for `slb_ftp_proxy.trigger_stats_rate`
...
<a id="nestedblock--slb_generic"></a>
### Nested Schema for `slb_generic`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_generic--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_generic--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--slb_generic--trigger_stats_inc"></a>
### Nested Schema for `slb_generic.trigger_stats_inc`
...
<a id="nestedblock--slb_generic--trigger_stats_rate"></a>
### Nested Schema for `slb_generic.trigger_stats_rate`
...
<a id="nestedblock--slb_http2"></a>
### Nested Schema for `slb_http2`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_http2--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_http2--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--slb_http2--trigger_stats_inc"></a>
### Nested Schema for `slb_http2.trigger_stats_inc`
...
<a id="nestedblock--slb_http2--trigger_stats_rate"></a>
### Nested Schema for `slb_http2.trigger_stats_rate`
...
<a id="nestedblock--slb_http_proxy"></a>
### Nested Schema for `slb_http_proxy`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_http_proxy--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_http_proxy--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--slb_http_proxy--trigger_stats_inc"></a>
### Nested Schema for `slb_http_proxy.trigger_stats_inc`
...
<a id="nestedblock--slb_http_proxy--trigger_stats_rate"></a>
### Nested Schema for `slb_http_proxy.trigger_stats_rate`
...
<a id="nestedblock--slb_hw_compress"></a>
### Nested Schema for `slb_hw_compress`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_hw_compress--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_hw_compress--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--slb_hw_compress--trigger_stats_inc"></a>
### Nested Schema for `slb_hw_compress.trigger_stats_inc`
...
<a id="nestedblock--slb_hw_compress--trigger_stats_rate"></a>
### Nested Schema for `slb_hw_compress.trigger_stats_rate`
...
<a id="nestedblock--slb_icap"></a>
### Nested Schema for `slb_icap`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_icap--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_icap--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--slb_icap--trigger_stats_inc"></a>
### Nested Schema for `slb_icap.trigger_stats_inc`
...
<a id="nestedblock--slb_icap--trigger_stats_rate"></a>
### Nested Schema for `slb_icap.trigger_stats_rate`
...
<a id="nestedblock--slb_imap_proxy"></a>
### Nested Schema for `slb_imap_proxy`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_imap_proxy--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_imap_proxy--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--slb_imap_proxy--trigger_stats_inc"></a>
### Nested Schema for `slb_imap_proxy.trigger_stats_inc`
...
<a id="nestedblock--slb_imap_proxy--trigger_stats_rate"></a>
### Nested Schema for `slb_imap_proxy.trigger_stats_rate`
...
<a id="nestedblock--slb_l4"></a>
### Nested Schema for `slb_l4`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_l4--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_l4--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--slb_l4--trigger_stats_inc"></a>
### Nested Schema for `slb_l4.trigger_stats_inc`
...
<a id="nestedblock--slb_l4--trigger_stats_rate"></a>
### Nested Schema for `slb_l4.trigger_stats_rate`
...
<a id="nestedblock--slb_l7session"></a>
### Nested Schema for `slb_l7session`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_l7session--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_l7session--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--slb_l7session--trigger_stats_inc"></a>
### Nested Schema for `slb_l7session.trigger_stats_inc`
...
<a id="nestedblock--slb_l7session--trigger_stats_rate"></a>
### Nested Schema for `slb_l7session.trigger_stats_rate`
...
<a id="nestedblock--slb_link_probe"></a>
### Nested Schema for `slb_link_probe`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_link_probe--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_link_probe--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--slb_link_probe--trigger_stats_inc"></a>
### Nested Schema for `slb_link_probe.trigger_stats_inc`
...
<a id="nestedblock--slb_link_probe--trigger_stats_rate"></a>
### Nested Schema for `slb_link_probe.trigger_stats_rate`
...
<a id="nestedblock--slb_mlb"></a>
### Nested Schema for `slb_mlb`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_mlb--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_mlb--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--slb_mlb--trigger_stats_inc"></a>
### Nested Schema for `slb_mlb.trigger_stats_inc`
...
<a id="nestedblock--slb_mlb--trigger_stats_rate"></a>
### Nested Schema for `slb_mlb.trigger_stats_rate`
...
<a id="nestedblock--slb_mqtt"></a>
### Nested Schema for `slb_mqtt`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_mqtt--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_mqtt--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--slb_mqtt--trigger_stats_inc"></a>
### Nested Schema for `slb_mqtt.trigger_stats_inc`
...
<a id="nestedblock--slb_mqtt--trigger_stats_rate"></a>
### Nested Schema for `slb_mqtt.trigger_stats_rate`
...
<a id="nestedblock--slb_mssql"></a>
### Nested Schema for `slb_mssql`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_mssql--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_mssql--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--slb_mssql--trigger_stats_inc"></a>
### Nested Schema for `slb_mssql.trigger_stats_inc`
...
<a id="nestedblock--slb_mssql--trigger_stats_rate"></a>
### Nested Schema for `slb_mssql.trigger_stats_rate`
...
<a id="nestedblock--slb_mysql"></a>
### Nested Schema for `slb_mysql`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_mysql--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_mysql--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--slb_mysql--trigger_stats_inc"></a>
### Nested Schema for `slb_mysql.trigger_stats_inc`
...
<a id="nestedblock--slb_mysql--trigger_stats_rate"></a>
### Nested Schema for `slb_mysql.trigger_stats_rate`
...
<a id="nestedblock--slb_persist"></a>
### Nested Schema for `slb_persist`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_persist--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_persist--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--slb_persist--trigger_stats_inc"></a>
### Nested Schema for `slb_persist.trigger_stats_inc`
...
<a id="nestedblock--slb_persist--trigger_stats_rate"></a>
### Nested Schema for `slb_persist.trigger_stats_rate`
...
<a id="nestedblock--slb_plyr_id_gbl"></a>
### Nested Schema for `slb_plyr_id_gbl`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_plyr_id_gbl--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_plyr_id_gbl--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--slb_plyr_id_gbl--trigger_stats_inc"></a>
### Nested Schema for `slb_plyr_id_gbl.trigger_stats_inc`
...
<a id="nestedblock--slb_plyr_id_gbl--trigger_stats_rate"></a>
### Nested Schema for `slb_plyr_id_gbl.trigger_stats_rate`
...
<a id="nestedblock--slb_pop3_proxy"></a>
### Nested Schema for `slb_pop3_proxy`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_pop3_proxy--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_pop3_proxy--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--slb_pop3_proxy--trigger_stats_inc"></a>
### Nested Schema for `slb_pop3_proxy.trigger_stats_inc`
...
<a id="nestedblock--slb_pop3_proxy--trigger_stats_rate"></a>
### Nested Schema for `slb_pop3_proxy.trigger_stats_rate`
...
<a id="nestedblock--slb_rc_cache"></a>
### Nested Schema for `slb_rc_cache`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_rc_cache--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_rc_cache--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--slb_rc_cache--trigger_stats_inc"></a>
### Nested Schema for `slb_rc_cache.trigger_stats_inc`
...
<a id="nestedblock--slb_rc_cache--trigger_stats_rate"></a>
### Nested Schema for `slb_rc_cache.trigger_stats_rate`
...
<a id="nestedblock--slb_rpz"></a>
### Nested Schema for `slb_rpz`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_rpz--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_rpz--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--slb_rpz--trigger_stats_inc"></a>
### Nested Schema for `slb_rpz.trigger_stats_inc`
...
<a id="nestedblock--slb_rpz--trigger_stats_rate"></a>
### Nested Schema for `slb_rpz.trigger_stats_rate`
...
<a id="nestedblock--slb_sip"></a>
### Nested Schema for `slb_sip`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_sip--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_sip--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--slb_sip--trigger_stats_inc"></a>
### Nested Schema for `slb_sip.trigger_stats_inc`
...
<a id="nestedblock--slb_sip--trigger_stats_rate"></a>
### Nested Schema for `slb_sip.trigger_stats_rate`
...
<a id="nestedblock--slb_smpp"></a>
### Nested Schema for `slb_smpp`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_smpp--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_smpp--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--slb_smpp--trigger_stats_inc"></a>
### Nested Schema for `slb_smpp.trigger_stats_inc`
...
<a id="nestedblock--slb_smpp--trigger_stats_rate"></a>
### Nested Schema for `slb_smpp.trigger_stats_rate`
...
<a id="nestedblock--slb_smtp"></a>
### Nested Schema for `slb_smtp`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_smtp--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_smtp--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--slb_smtp--trigger_stats_inc"></a>
### Nested Schema for `slb_smtp.trigger_stats_inc`
...
<a id="nestedblock--slb_smtp--trigger_stats_rate"></a>
### Nested Schema for `slb_smtp.trigger_stats_rate`
...
<a id="nestedblock--slb_spdy_proxy"></a>
### Nested Schema for `slb_spdy_proxy`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_spdy_proxy--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_spdy_proxy--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--slb_spdy_proxy--trigger_stats_inc"></a>
### Nested Schema for `slb_spdy_proxy.trigger_stats_inc`
...
<a id="nestedblock--slb_spdy_proxy--trigger_stats_rate"></a>
### Nested Schema for `slb_spdy_proxy.trigger_stats_rate`
...
<a id="nestedblock--slb_sport_rate"></a>
### Nested Schema for `slb_sport_rate`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_sport_rate--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_sport_rate--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--slb_sport_rate--trigger_stats_inc"></a>
### Nested Schema for `slb_sport_rate.trigger_stats_inc`
...
<a id="nestedblock--slb_sport_rate--trigger_stats_rate"></a>
### Nested Schema for `slb_sport_rate.trigger_stats_rate`
...
<a id="nestedblock--slb_ssl_cert_revoke"></a>
### Nested Schema for `slb_ssl_cert_revoke`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_ssl_cert_revoke--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_ssl_cert_revoke--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--slb_ssl_cert_revoke--trigger_stats_inc"></a>
### Nested Schema for `slb_ssl_cert_revoke.trigger_stats_inc`
...
<a id="nestedblock--slb_ssl_cert_revoke--trigger_stats_rate"></a>
### Nested Schema for `slb_ssl_cert_revoke.trigger_stats_rate`
...
<a id="nestedblock--slb_ssl_error"></a>
### Nested Schema for `slb_ssl_error`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_ssl_error--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_ssl_error--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--slb_ssl_error--trigger_stats_inc"></a>
### Nested Schema for `slb_ssl_error.trigger_stats_inc`
...
<a id="nestedblock--slb_ssl_error--trigger_stats_rate"></a>
### Nested Schema for `slb_ssl_error.trigger_stats_rate`
...
<a id="nestedblock--slb_ssl_forward_proxy"></a>
### Nested Schema for `slb_ssl_forward_proxy`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_ssl_forward_proxy--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_ssl_forward_proxy--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--slb_ssl_forward_proxy--trigger_stats_inc"></a>
### Nested Schema for `slb_ssl_forward_proxy.trigger_stats_inc`
...
<a id="nestedblock--slb_ssl_forward_proxy--trigger_stats_rate"></a>
### Nested Schema for `slb_ssl_forward_proxy.trigger_stats_rate`
...
<a id="nestedblock--slb_switch"></a>
### Nested Schema for `slb_switch`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_switch--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--slb_switch--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--slb_switch--trigger_stats_inc"></a>
### Nested Schema for `slb_switch.trigger_stats_inc`
...
<a id="nestedblock--slb_switch--trigger_stats_rate"></a>
### Nested Schema for `slb_switch.trigger_stats_rate`
...
<a id="nestedblock--so_counters"></a>
### Nested Schema for `so_counters`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--so_counters--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--so_counters--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--so_counters--trigger_stats_inc"></a>
### Nested Schema for `so_counters.trigger_stats_inc`
...
<a id="nestedblock--so_counters--trigger_stats_rate"></a>
### Nested Schema for `so_counters.trigger_stats_rate`
...
<a id="nestedblock--system_ctr_lib_acct"></a>
### Nested Schema for `system_ctr_lib_acct`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--system_ctr_lib_acct--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--system_ctr_lib_acct--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--system_ctr_lib_acct--trigger_stats_inc"></a>
### Nested Schema for `system_ctr_lib_acct.trigger_stats_inc`
...
<a id="nestedblock--system_ctr_lib_acct--trigger_stats_rate"></a>
### Nested Schema for `system_ctr_lib_acct.trigger_stats_rate`
...
<a id="nestedblock--system_dpdk_stats"></a>
### Nested Schema for `system_dpdk_stats`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--system_dpdk_stats--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--system_dpdk_stats--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--system_dpdk_stats--trigger_stats_inc"></a>
### Nested Schema for `system_dpdk_stats.trigger_stats_inc`
...
<a id="nestedblock--system_dpdk_stats--trigger_stats_rate"></a>
### Nested Schema for `system_dpdk_stats.trigger_stats_rate`
...
<a id="nestedblock--system_fpga_drop"></a>
### Nested Schema for `system_fpga_drop`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--system_fpga_drop--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--system_fpga_drop--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--system_fpga_drop--trigger_stats_inc"></a>
### Nested Schema for `system_fpga_drop.trigger_stats_inc`
...
<a id="nestedblock--system_fpga_drop--trigger_stats_rate"></a>
### Nested Schema for `system_fpga_drop.trigger_stats_rate`
...
<a id="nestedblock--system_hardware_accelerate"></a>
### Nested Schema for `system_hardware_accelerate`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--system_hardware_accelerate--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--system_hardware_accelerate--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--system_hardware_accelerate--trigger_stats_inc"></a>
### Nested Schema for `system_hardware_accelerate.trigger_stats_inc`
...
<a id="nestedblock--system_hardware_accelerate--trigger_stats_rate"></a>
### Nested Schema for `system_hardware_accelerate.trigger_stats_rate`
...
<a id="nestedblock--system_ip_threat_list"></a>
### Nested Schema for `system_ip_threat_list`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--system_ip_threat_list--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--system_ip_threat_list--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--system_ip_threat_list--trigger_stats_inc"></a>
### Nested Schema for `system_ip_threat_list.trigger_stats_inc`
...
<a id="nestedblock--system_ip_threat_list--trigger_stats_rate"></a>
### Nested Schema for `system_ip_threat_list.trigger_stats_rate`
...
<a id="nestedblock--system_radius_server"></a>
### Nested Schema for `system_radius_server`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--system_radius_server--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--system_radius_server--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--system_radius_server--trigger_stats_inc"></a>
### Nested Schema for `system_radius_server.trigger_stats_inc`
...
<a id="nestedblock--system_radius_server--trigger_stats_rate"></a>
### Nested Schema for `system_radius_server.trigger_stats_rate`
...
<a id="nestedblock--system_tcp"></a>
### Nested Schema for `system_tcp`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--system_tcp--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--system_tcp--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--system_tcp--trigger_stats_inc"></a>
### Nested Schema for `system_tcp.trigger_stats_inc`
...
<a id="nestedblock--system_tcp--trigger_stats_rate"></a>
### Nested Schema for `system_tcp.trigger_stats_rate`
...
<a id="nestedblock--vpn_error"></a>
### Nested Schema for `vpn_error`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--vpn_error--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--vpn_error--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--vpn_error--trigger_stats_inc"></a>
### Nested Schema for `vpn_error.trigger_stats_inc`
...
<a id="nestedblock--vpn_error--trigger_stats_rate"></a>
### Nested Schema for `vpn_error.trigger_stats_rate`
