...
page_title: "thunder_ddos_dst_entry_port_range_stats_dns_tcp_port Resource - terraform-provider-thunder"
subcategory: ""
description: |-
  thunder_ddos_dst_entry_port_range_stats_dns_tcp_port: Statistics for the object port-range
  PLACEHOLDER
---

# thunder_ddos_dst_entry_port_range_stats_dns_tcp_port (Resource)
...
- `dns_tcp_port` (Block List, Max: 1) (see [below for nested schema](#nestedblock--stats--dns_tcp_port))

<a id="nestedblock--stats--dns_tcp_port"></a>
### Nested Schema for `stats.dns_tcp_port`
...
- `dns_fqdn_stage_2_rate_exceed` (Number) FQDN Rate Exceeded
...
- `req_incomplete` (Number) TCP Request Incomplete
