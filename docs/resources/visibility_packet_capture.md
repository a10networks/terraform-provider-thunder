...
- `cgnv6_nat64_global` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_nat64_global))
...
- `slb_plyr_id_gbl` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_plyr_id_gbl))
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--aam_auth_captcha--trigger_stats_inc"></a>
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--aam_auth_relay_kerberos--trigger_stats_inc"></a>
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--aam_auth_saml_global--trigger_stats_inc"></a>
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--aam_auth_server_win--trigger_stats_inc"></a>
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_ddos_proc--trigger_stats_inc"></a>
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_http_alg"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.cgnv6_http_alg`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_http_alg--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_http_alg--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_http_alg--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.cgnv6_http_alg.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_http_alg--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.cgnv6_http_alg.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_icmp"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.cgnv6_icmp`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_icmp--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_icmp--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_icmp--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.cgnv6_icmp.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_icmp--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.cgnv6_icmp.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_l4"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.cgnv6_l4`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_l4--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_l4--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_l4--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.cgnv6_l4.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_l4--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.cgnv6_l4.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_logging"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.cgnv6_logging`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_logging--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_logging--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_logging--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.cgnv6_logging.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_logging--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.cgnv6_logging.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_lsn"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.cgnv6_lsn`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_lsn--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_lsn--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_lsn--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.cgnv6_lsn.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_lsn--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.cgnv6_lsn.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_lsn_alg_esp"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.cgnv6_lsn_alg_esp`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_lsn_alg_esp--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_lsn_alg_esp--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_lsn_alg_esp--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.cgnv6_lsn_alg_esp.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_lsn_alg_esp--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.cgnv6_lsn_alg_esp.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_lsn_alg_h323"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.cgnv6_lsn_alg_h323`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_lsn_alg_h323--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_lsn_alg_h323--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_lsn_alg_h323--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.cgnv6_lsn_alg_h323.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_lsn_alg_h323--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.cgnv6_lsn_alg_h323.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_lsn_alg_mgcp"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.cgnv6_lsn_alg_mgcp`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_lsn_alg_mgcp--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_lsn_alg_mgcp--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_lsn_alg_mgcp--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.cgnv6_lsn_alg_mgcp.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_lsn_alg_mgcp--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.cgnv6_lsn_alg_mgcp.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_lsn_alg_pptp"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.cgnv6_lsn_alg_pptp`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_lsn_alg_pptp--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_lsn_alg_pptp--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_lsn_alg_pptp--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.cgnv6_lsn_alg_pptp.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_lsn_alg_pptp--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.cgnv6_lsn_alg_pptp.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_lsn_alg_rtsp"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.cgnv6_lsn_alg_rtsp`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_lsn_alg_rtsp--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_lsn_alg_rtsp--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_lsn_alg_rtsp--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.cgnv6_lsn_alg_rtsp.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_lsn_alg_rtsp--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.cgnv6_lsn_alg_rtsp.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_lsn_alg_sip"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.cgnv6_lsn_alg_sip`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_lsn_alg_sip--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_lsn_alg_sip--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_lsn_alg_sip--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.cgnv6_lsn_alg_sip.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_lsn_alg_sip--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.cgnv6_lsn_alg_sip.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_lsn_radius"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.cgnv6_lsn_radius`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_lsn_radius--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_lsn_radius--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_lsn_radius--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.cgnv6_lsn_radius.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_lsn_radius--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.cgnv6_lsn_radius.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_nat64_global"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.cgnv6_nat64_global`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_nat64_global--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_nat64_global--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_nat64_global--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.cgnv6_nat64_global.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_nat64_global--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.cgnv6_nat64_global.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_pcp"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.cgnv6_pcp`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_pcp--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_pcp--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_pcp--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.cgnv6_pcp.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--cgnv6_pcp--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.cgnv6_pcp.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--fw_alg_pptp"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.fw_alg_pptp`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--fw_alg_pptp--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--fw_alg_pptp--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--fw_alg_pptp--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.fw_alg_pptp.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--fw_alg_pptp--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.fw_alg_pptp.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--fw_alg_rtsp"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.fw_alg_rtsp`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--fw_alg_rtsp--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--fw_alg_rtsp--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--fw_alg_rtsp--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.fw_alg_rtsp.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--fw_alg_rtsp--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.fw_alg_rtsp.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--fw_ddos_protection"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.fw_ddos_protection`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--fw_ddos_protection--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--fw_ddos_protection--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--fw_ddos_protection--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.fw_ddos_protection.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--fw_ddos_protection--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.fw_ddos_protection.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--fw_global"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.fw_global`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--fw_global--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--fw_global--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--fw_global--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.fw_global.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--fw_global--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.fw_global.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--fw_gtp"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.fw_gtp`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--fw_gtp--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--fw_gtp--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--fw_gtp--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.fw_gtp.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--fw_gtp--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.fw_gtp.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--fw_logging"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.fw_logging`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--fw_logging--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--fw_logging--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--fw_logging--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.fw_logging.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--fw_logging--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.fw_logging.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--fw_rad_server"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.fw_rad_server`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--fw_rad_server--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--fw_rad_server--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--fw_rad_server--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.fw_rad_server.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--fw_rad_server--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.fw_rad_server.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--fw_tcp_syn_cookie"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.fw_tcp_syn_cookie`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--fw_tcp_syn_cookie--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--fw_tcp_syn_cookie--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--fw_tcp_syn_cookie--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.fw_tcp_syn_cookie.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--fw_tcp_syn_cookie--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.fw_tcp_syn_cookie.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--ip_anomaly_drop"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.ip_anomaly_drop`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--ip_anomaly_drop--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--ip_anomaly_drop--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--ip_anomaly_drop--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.ip_anomaly_drop.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--ip_anomaly_drop--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.ip_anomaly_drop.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--logging_local_log_global"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.logging_local_log_global`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--logging_local_log_global--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--logging_local_log_global--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--logging_local_log_global--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.logging_local_log_global.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--logging_local_log_global--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.logging_local_log_global.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_aflow"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_aflow`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_aflow--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_aflow--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_aflow--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_aflow.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_aflow--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_aflow.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_conn_reuse"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_conn_reuse`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_conn_reuse--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_conn_reuse--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_conn_reuse--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_conn_reuse.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_conn_reuse--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_conn_reuse.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_crl_srcip"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_crl_srcip`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_crl_srcip--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_crl_srcip--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_crl_srcip--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_crl_srcip.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_crl_srcip--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_crl_srcip.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_fast_http"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_fast_http`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_fast_http--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_fast_http--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_fast_http--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_fast_http.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_fast_http--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_fast_http.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_fix"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_fix`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_fix--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_fix--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_fix--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_fix.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_fix--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_fix.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_ftp_proxy"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_ftp_proxy`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_ftp_proxy--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_ftp_proxy--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_ftp_proxy--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_ftp_proxy.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_ftp_proxy--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_ftp_proxy.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_generic"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_generic`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_generic--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_generic--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_generic--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_generic.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_generic--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_generic.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_http2"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_http2`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_http2--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_http2--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_http2--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_http2.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_http2--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_http2.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_http_proxy"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_http_proxy`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_http_proxy--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_http_proxy--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_http_proxy--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_http_proxy.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_http_proxy--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_http_proxy.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_hw_compress"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_hw_compress`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_hw_compress--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_hw_compress--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_hw_compress--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_hw_compress.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_hw_compress--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_hw_compress.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_icap"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_icap`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_icap--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_icap--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_icap--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_icap.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_icap--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_icap.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_imap_proxy"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_imap_proxy`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_imap_proxy--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_imap_proxy--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_imap_proxy--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_imap_proxy.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_imap_proxy--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_imap_proxy.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_l4"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_l4`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_l4--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_l4--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_l4--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_l4.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_l4--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_l4.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_l7session"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_l7session`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_l7session--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_l7session--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_l7session--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_l7session.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_l7session--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_l7session.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_link_probe"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_link_probe`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_link_probe--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_link_probe--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_link_probe--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_link_probe.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_link_probe--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_link_probe.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_mlb"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_mlb`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_mlb--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_mlb--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_mlb--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_mlb.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_mlb--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_mlb.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_mqtt"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_mqtt`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_mqtt--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_mqtt--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_mqtt--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_mqtt.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_mqtt--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_mqtt.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_mssql"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_mssql`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_mssql--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_mssql--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_mssql--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_mssql.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_mssql--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_mssql.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_mysql"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_mysql`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_mysql--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_mysql--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_mysql--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_mysql.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_mysql--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_mysql.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_persist"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_persist`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_persist--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_persist--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_persist--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_persist.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_persist--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_persist.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_plyr_id_gbl"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_plyr_id_gbl`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_plyr_id_gbl--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_plyr_id_gbl--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_plyr_id_gbl--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_plyr_id_gbl.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_plyr_id_gbl--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_plyr_id_gbl.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_pop3_proxy"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_pop3_proxy`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_pop3_proxy--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_pop3_proxy--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_pop3_proxy--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_pop3_proxy.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_pop3_proxy--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_pop3_proxy.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_rc_cache"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_rc_cache`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_rc_cache--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_rc_cache--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_rc_cache--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_rc_cache.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_rc_cache--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_rc_cache.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_rpz"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_rpz`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_rpz--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_rpz--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_rpz--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_rpz.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_rpz--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_rpz.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_sip"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_sip`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_sip--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_sip--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_sip--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_sip.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_sip--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_sip.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_smpp"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_smpp`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_smpp--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_smpp--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_smpp--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_smpp.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_smpp--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_smpp.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_smtp"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_smtp`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_smtp--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_smtp--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_smtp--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_smtp.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_smtp--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_smtp.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_spdy_proxy"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_spdy_proxy`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_spdy_proxy--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_spdy_proxy--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_spdy_proxy--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_spdy_proxy.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_spdy_proxy--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_spdy_proxy.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_sport_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_sport_rate`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_sport_rate--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_sport_rate--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_sport_rate--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_sport_rate.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_sport_rate--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_sport_rate.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_ssl_cert_revoke"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_ssl_cert_revoke`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_ssl_cert_revoke--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_ssl_cert_revoke--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_ssl_cert_revoke--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_ssl_cert_revoke.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_ssl_cert_revoke--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_ssl_cert_revoke.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_ssl_error"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_ssl_error`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_ssl_error--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_ssl_error--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_ssl_error--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_ssl_error.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_ssl_error--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_ssl_error.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_ssl_forward_proxy"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_ssl_forward_proxy`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_ssl_forward_proxy--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_ssl_forward_proxy--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_ssl_forward_proxy--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_ssl_forward_proxy.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_ssl_forward_proxy--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_ssl_forward_proxy.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_switch"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_switch`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_switch--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_switch--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_switch--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_switch.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--slb_switch--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.slb_switch.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--so_counters"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.so_counters`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--so_counters--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--so_counters--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--so_counters--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.so_counters.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--so_counters--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.so_counters.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--system_ctr_lib_acct"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.system_ctr_lib_acct`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--system_ctr_lib_acct--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--system_ctr_lib_acct--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--system_ctr_lib_acct--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.system_ctr_lib_acct.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--system_ctr_lib_acct--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.system_ctr_lib_acct.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--system_dpdk_stats"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.system_dpdk_stats`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--system_dpdk_stats--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--system_dpdk_stats--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--system_dpdk_stats--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.system_dpdk_stats.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--system_dpdk_stats--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.system_dpdk_stats.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--system_fpga_drop"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.system_fpga_drop`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--system_fpga_drop--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--system_fpga_drop--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--system_fpga_drop--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.system_fpga_drop.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--system_fpga_drop--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.system_fpga_drop.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--system_hardware_accelerate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.system_hardware_accelerate`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--system_hardware_accelerate--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--system_hardware_accelerate--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--system_hardware_accelerate--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.system_hardware_accelerate.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--system_hardware_accelerate--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.system_hardware_accelerate.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--system_ip_threat_list"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.system_ip_threat_list`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--system_ip_threat_list--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--system_ip_threat_list--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--system_ip_threat_list--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.system_ip_threat_list.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--system_ip_threat_list--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.system_ip_threat_list.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--system_radius_server"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.system_radius_server`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--system_radius_server--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--system_radius_server--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--system_radius_server--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.system_radius_server.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--system_radius_server--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.system_radius_server.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--system_tcp"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.system_tcp`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--system_tcp--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--system_tcp--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--system_tcp--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.system_tcp.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--system_tcp--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.system_tcp.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--vpn_error"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.vpn_error`

Optional:

- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--vpn_error--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--vpn_error--trigger_stats_rate))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--vpn_error--trigger_stats_inc"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.vpn_error.trigger_stats_inc`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_change--vpn_error--trigger_stats_rate"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_change.vpn_error.trigger_stats_rate`
...
<a id="nestedblock--global_templates--template_list--trigger_sys_obj_stats_severity"></a>
### Nested Schema for `global_templates.template_list.trigger_sys_obj_stats_severity`
...
<a id="nestedblock--object_templates"></a>
### Nested Schema for `object_templates`

Optional:

- `aam_aaa_policy_tmpl_list` (Block List) (see [below for nested schema](#nestedblock--object_templates--aam_aaa_policy_tmpl_list))
- `aam_auth_captcha_inst_tmpl_list` (Block List) (see [below for nested schema](#nestedblock--object_templates--aam_auth_captcha_inst_tmpl_list))
- `aam_auth_logon_http_ins_tmpl_list` (Block List) (see [below for nested schema](#nestedblock--object_templates--aam_auth_logon_http_ins_tmpl_list))
- `aam_auth_relay_form_inst_tmpl_list` (Block List) (see [below for nested schema](#nestedblock--object_templates--aam_auth_relay_form_inst_tmpl_list))
- `aam_auth_relay_hbase_inst_tmpl_list` (Block List) (see [below for nested schema](#nestedblock--object_templates--aam_auth_relay_hbase_inst_tmpl_list))
- `aam_auth_relay_ws_fed_tmpl_list` (Block List) (see [below for nested schema](#nestedblock--object_templates--aam_auth_relay_ws_fed_tmpl_list))
- `aam_auth_saml_id_prov_tmpl_list` (Block List) (see [below for nested schema](#nestedblock--object_templates--aam_auth_saml_id_prov_tmpl_list))
- `aam_auth_saml_service_prov_tmpl_list` (Block List) (see [below for nested schema](#nestedblock--object_templates--aam_auth_saml_service_prov_tmpl_list))
- `aam_auth_server_ldap_inst_tmpl_list` (Block List) (see [below for nested schema](#nestedblock--object_templates--aam_auth_server_ldap_inst_tmpl_list))
- `aam_auth_server_ocsp_inst_tmpl_list` (Block List) (see [below for nested schema](#nestedblock--object_templates--aam_auth_server_ocsp_inst_tmpl_list))
- `aam_auth_server_rad_inst_tmpl_list` (Block List) (see [below for nested schema](#nestedblock--object_templates--aam_auth_server_rad_inst_tmpl_list))
- `aam_auth_server_win_inst_tmpl_list` (Block List) (see [below for nested schema](#nestedblock--object_templates--aam_auth_server_win_inst_tmpl_list))
- `aam_auth_service_group_mem_tmpl_list` (Block List) (see [below for nested schema](#nestedblock--object_templates--aam_auth_service_group_mem_tmpl_list))
- `aam_auth_service_group_tmpl_list` (Block List) (see [below for nested schema](#nestedblock--object_templates--aam_auth_service_group_tmpl_list))
- `aam_jwt_authorization_tmpl_list` (Block List) (see [below for nested schema](#nestedblock--object_templates--aam_jwt_authorization_tmpl_list))
- `captcha_template_inst_tmpl_list` (Block List) (see [below for nested schema](#nestedblock--object_templates--captcha_template_inst_tmpl_list))
- `cgnv6_dns64_vs_port_tmpl_list` (Block List) (see [below for nested schema](#nestedblock--object_templates--cgnv6_dns64_vs_port_tmpl_list))
- `cgnv6_encap_domain_tmpl_list` (Block List) (see [below for nested schema](#nestedblock--object_templates--cgnv6_encap_domain_tmpl_list))
- `cgnv6_map_trans_domain_tmpl_list` (Block List) (see [below for nested schema](#nestedblock--object_templates--cgnv6_map_trans_domain_tmpl_list))
- `cgnv6_serv_group_tmpl_list` (Block List) (see [below for nested schema](#nestedblock--object_templates--cgnv6_serv_group_tmpl_list))
- `dns_vport_tmpl_list` (Block List) (see [below for nested schema](#nestedblock--object_templates--dns_vport_tmpl_list))
- `fw_server_port_tmpl_list` (Block List) (see [below for nested schema](#nestedblock--object_templates--fw_server_port_tmpl_list))
- `fw_service_group_mem_tmpl_list` (Block List) (see [below for nested schema](#nestedblock--object_templates--fw_service_group_mem_tmpl_list))
- `fw_service_group_tmpl_list` (Block List) (see [below for nested schema](#nestedblock--object_templates--fw_service_group_tmpl_list))
- `imap_vport_tmpl_list` (Block List) (see [below for nested schema](#nestedblock--object_templates--imap_vport_tmpl_list))
- `interface_ethernet_tmpl_list` (Block List) (see [below for nested schema](#nestedblock--object_templates--interface_ethernet_tmpl_list))
- `interface_tunnel_tmpl_list` (Block List) (see [below for nested schema](#nestedblock--object_templates--interface_tunnel_tmpl_list))
- `netflow_monitor_tmpl_list` (Block List) (see [below for nested schema](#nestedblock--object_templates--netflow_monitor_tmpl_list))
- `pop3_vport_tmpl_list` (Block List) (see [below for nested schema](#nestedblock--object_templates--pop3_vport_tmpl_list))
- `rule_set_rule_tmpl_list` (Block List) (see [below for nested schema](#nestedblock--object_templates--rule_set_rule_tmpl_list))
- `rule_set_tmpl_list` (Block List) (see [below for nested schema](#nestedblock--object_templates--rule_set_tmpl_list))
- `slb_port_tmpl_list` (Block List) (see [below for nested schema](#nestedblock--object_templates--slb_port_tmpl_list))
- `slb_service_tmpl_list` (Block List) (see [below for nested schema](#nestedblock--object_templates--slb_service_tmpl_list))
- `slb_templ_cache_tmpl_list` (Block List) (see [below for nested schema](#nestedblock--object_templates--slb_templ_cache_tmpl_list))
- `slb_vport_tmpl_list` (Block List) (see [below for nested schema](#nestedblock--object_templates--slb_vport_tmpl_list))
- `smtp_vport_tmpl_list` (Block List) (see [below for nested schema](#nestedblock--object_templates--smtp_vport_tmpl_list))
- `templ_gtp_plcy_tmpl_list` (Block List) (see [below for nested schema](#nestedblock--object_templates--templ_gtp_plcy_tmpl_list))
- `uuid` (String) uuid of the object

<a id="nestedblock--object_templates--aam_aaa_policy_tmpl_list"></a>
### Nested Schema for `object_templates.aam_aaa_policy_tmpl_list`
...
- `capture_config` (String) Specify name of the capture-config to use with this template
- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--aam_aaa_policy_tmpl_list--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--aam_aaa_policy_tmpl_list--trigger_stats_rate))
- `trigger_stats_severity` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--aam_aaa_policy_tmpl_list--trigger_stats_severity))
- `user_tag` (String) Customized tag
- `uuid` (String) uuid of the object

<a id="nestedblock--object_templates--aam_aaa_policy_tmpl_list--trigger_stats_inc"></a>
### Nested Schema for `object_templates.aam_aaa_policy_tmpl_list.trigger_stats_inc`
...
<a id="nestedblock--object_templates--aam_aaa_policy_tmpl_list--trigger_stats_rate"></a>
### Nested Schema for `object_templates.aam_aaa_policy_tmpl_list.trigger_stats_rate`
...
<a id="nestedblock--object_templates--aam_aaa_policy_tmpl_list--trigger_stats_severity"></a>
### Nested Schema for `object_templates.aam_aaa_policy_tmpl_list.trigger_stats_severity`
...
<a id="nestedblock--object_templates--aam_auth_captcha_inst_tmpl_list"></a>
### Nested Schema for `object_templates.aam_auth_captcha_inst_tmpl_list`
...
- `capture_config` (String) Specify name of the capture-config to use with this template
- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--aam_auth_captcha_inst_tmpl_list--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--aam_auth_captcha_inst_tmpl_list--trigger_stats_rate))
- `trigger_stats_severity` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--aam_auth_captcha_inst_tmpl_list--trigger_stats_severity))
- `user_tag` (String) Customized tag
- `uuid` (String) uuid of the object

<a id="nestedblock--object_templates--aam_auth_captcha_inst_tmpl_list--trigger_stats_inc"></a>
### Nested Schema for `object_templates.aam_auth_captcha_inst_tmpl_list.trigger_stats_inc`
...
<a id="nestedblock--object_templates--aam_auth_captcha_inst_tmpl_list--trigger_stats_rate"></a>
### Nested Schema for `object_templates.aam_auth_captcha_inst_tmpl_list.trigger_stats_rate`
...
<a id="nestedblock--object_templates--aam_auth_captcha_inst_tmpl_list--trigger_stats_severity"></a>
### Nested Schema for `object_templates.aam_auth_captcha_inst_tmpl_list.trigger_stats_severity`
...
<a id="nestedblock--object_templates--aam_auth_logon_http_ins_tmpl_list"></a>
### Nested Schema for `object_templates.aam_auth_logon_http_ins_tmpl_list`
...
- `capture_config` (String) Specify name of the capture-config to use with this template
- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--aam_auth_logon_http_ins_tmpl_list--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--aam_auth_logon_http_ins_tmpl_list--trigger_stats_rate))
- `trigger_stats_severity` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--aam_auth_logon_http_ins_tmpl_list--trigger_stats_severity))
- `user_tag` (String) Customized tag
- `uuid` (String) uuid of the object

<a id="nestedblock--object_templates--aam_auth_logon_http_ins_tmpl_list--trigger_stats_inc"></a>
### Nested Schema for `object_templates.aam_auth_logon_http_ins_tmpl_list.trigger_stats_inc`
...
<a id="nestedblock--object_templates--aam_auth_logon_http_ins_tmpl_list--trigger_stats_rate"></a>
### Nested Schema for `object_templates.aam_auth_logon_http_ins_tmpl_list.trigger_stats_rate`
...
<a id="nestedblock--object_templates--aam_auth_logon_http_ins_tmpl_list--trigger_stats_severity"></a>
### Nested Schema for `object_templates.aam_auth_logon_http_ins_tmpl_list.trigger_stats_severity`
...
<a id="nestedblock--object_templates--aam_auth_relay_form_inst_tmpl_list"></a>
### Nested Schema for `object_templates.aam_auth_relay_form_inst_tmpl_list`
...
- `capture_config` (String) Specify name of the capture-config to use with this template
- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--aam_auth_relay_form_inst_tmpl_list--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--aam_auth_relay_form_inst_tmpl_list--trigger_stats_rate))
- `trigger_stats_severity` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--aam_auth_relay_form_inst_tmpl_list--trigger_stats_severity))
- `user_tag` (String) Customized tag
- `uuid` (String) uuid of the object

<a id="nestedblock--object_templates--aam_auth_relay_form_inst_tmpl_list--trigger_stats_inc"></a>
### Nested Schema for `object_templates.aam_auth_relay_form_inst_tmpl_list.trigger_stats_inc`
...
<a id="nestedblock--object_templates--aam_auth_relay_form_inst_tmpl_list--trigger_stats_rate"></a>
### Nested Schema for `object_templates.aam_auth_relay_form_inst_tmpl_list.trigger_stats_rate`
...
<a id="nestedblock--object_templates--aam_auth_relay_form_inst_tmpl_list--trigger_stats_severity"></a>
### Nested Schema for `object_templates.aam_auth_relay_form_inst_tmpl_list.trigger_stats_severity`
...
<a id="nestedblock--object_templates--aam_auth_relay_hbase_inst_tmpl_list"></a>
### Nested Schema for `object_templates.aam_auth_relay_hbase_inst_tmpl_list`
...
- `capture_config` (String) Specify name of the capture-config to use with this template
- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--aam_auth_relay_hbase_inst_tmpl_list--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--aam_auth_relay_hbase_inst_tmpl_list--trigger_stats_rate))
- `trigger_stats_severity` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--aam_auth_relay_hbase_inst_tmpl_list--trigger_stats_severity))
- `user_tag` (String) Customized tag
- `uuid` (String) uuid of the object

<a id="nestedblock--object_templates--aam_auth_relay_hbase_inst_tmpl_list--trigger_stats_inc"></a>
### Nested Schema for `object_templates.aam_auth_relay_hbase_inst_tmpl_list.trigger_stats_inc`
...
<a id="nestedblock--object_templates--aam_auth_relay_hbase_inst_tmpl_list--trigger_stats_rate"></a>
### Nested Schema for `object_templates.aam_auth_relay_hbase_inst_tmpl_list.trigger_stats_rate`
...
<a id="nestedblock--object_templates--aam_auth_relay_hbase_inst_tmpl_list--trigger_stats_severity"></a>
### Nested Schema for `object_templates.aam_auth_relay_hbase_inst_tmpl_list.trigger_stats_severity`
...
<a id="nestedblock--object_templates--aam_auth_relay_ws_fed_tmpl_list"></a>
### Nested Schema for `object_templates.aam_auth_relay_ws_fed_tmpl_list`
...
- `capture_config` (String) Specify name of the capture-config to use with this template
- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--aam_auth_relay_ws_fed_tmpl_list--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--aam_auth_relay_ws_fed_tmpl_list--trigger_stats_rate))
- `trigger_stats_severity` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--aam_auth_relay_ws_fed_tmpl_list--trigger_stats_severity))
- `user_tag` (String) Customized tag
- `uuid` (String) uuid of the object

<a id="nestedblock--object_templates--aam_auth_relay_ws_fed_tmpl_list--trigger_stats_inc"></a>
### Nested Schema for `object_templates.aam_auth_relay_ws_fed_tmpl_list.trigger_stats_inc`
...
<a id="nestedblock--object_templates--aam_auth_relay_ws_fed_tmpl_list--trigger_stats_rate"></a>
### Nested Schema for `object_templates.aam_auth_relay_ws_fed_tmpl_list.trigger_stats_rate`
...
<a id="nestedblock--object_templates--aam_auth_relay_ws_fed_tmpl_list--trigger_stats_severity"></a>
### Nested Schema for `object_templates.aam_auth_relay_ws_fed_tmpl_list.trigger_stats_severity`
...
<a id="nestedblock--object_templates--aam_auth_saml_id_prov_tmpl_list"></a>
### Nested Schema for `object_templates.aam_auth_saml_id_prov_tmpl_list`
...
- `capture_config` (String) Specify name of the capture-config to use with this template
- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--aam_auth_saml_id_prov_tmpl_list--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--aam_auth_saml_id_prov_tmpl_list--trigger_stats_rate))
- `trigger_stats_severity` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--aam_auth_saml_id_prov_tmpl_list--trigger_stats_severity))
- `user_tag` (String) Customized tag
- `uuid` (String) uuid of the object

<a id="nestedblock--object_templates--aam_auth_saml_id_prov_tmpl_list--trigger_stats_inc"></a>
### Nested Schema for `object_templates.aam_auth_saml_id_prov_tmpl_list.trigger_stats_inc`
...
<a id="nestedblock--object_templates--aam_auth_saml_id_prov_tmpl_list--trigger_stats_rate"></a>
### Nested Schema for `object_templates.aam_auth_saml_id_prov_tmpl_list.trigger_stats_rate`
...
<a id="nestedblock--object_templates--aam_auth_saml_id_prov_tmpl_list--trigger_stats_severity"></a>
### Nested Schema for `object_templates.aam_auth_saml_id_prov_tmpl_list.trigger_stats_severity`
...
<a id="nestedblock--object_templates--aam_auth_saml_service_prov_tmpl_list"></a>
### Nested Schema for `object_templates.aam_auth_saml_service_prov_tmpl_list`
...
- `capture_config` (String) Specify name of the capture-config to use with this template
- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--aam_auth_saml_service_prov_tmpl_list--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--aam_auth_saml_service_prov_tmpl_list--trigger_stats_rate))
- `trigger_stats_severity` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--aam_auth_saml_service_prov_tmpl_list--trigger_stats_severity))
- `user_tag` (String) Customized tag
- `uuid` (String) uuid of the object

<a id="nestedblock--object_templates--aam_auth_saml_service_prov_tmpl_list--trigger_stats_inc"></a>
### Nested Schema for `object_templates.aam_auth_saml_service_prov_tmpl_list.trigger_stats_inc`
...
<a id="nestedblock--object_templates--aam_auth_saml_service_prov_tmpl_list--trigger_stats_rate"></a>
### Nested Schema for `object_templates.aam_auth_saml_service_prov_tmpl_list.trigger_stats_rate`
...
<a id="nestedblock--object_templates--aam_auth_saml_service_prov_tmpl_list--trigger_stats_severity"></a>
### Nested Schema for `object_templates.aam_auth_saml_service_prov_tmpl_list.trigger_stats_severity`
...
<a id="nestedblock--object_templates--aam_auth_server_ldap_inst_tmpl_list"></a>
### Nested Schema for `object_templates.aam_auth_server_ldap_inst_tmpl_list`
...
- `capture_config` (String) Specify name of the capture-config to use with this template
- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--aam_auth_server_ldap_inst_tmpl_list--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--aam_auth_server_ldap_inst_tmpl_list--trigger_stats_rate))
- `trigger_stats_severity` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--aam_auth_server_ldap_inst_tmpl_list--trigger_stats_severity))
- `user_tag` (String) Customized tag
- `uuid` (String) uuid of the object

<a id="nestedblock--object_templates--aam_auth_server_ldap_inst_tmpl_list--trigger_stats_inc"></a>
### Nested Schema for `object_templates.aam_auth_server_ldap_inst_tmpl_list.trigger_stats_inc`
...
<a id="nestedblock--object_templates--aam_auth_server_ldap_inst_tmpl_list--trigger_stats_rate"></a>
### Nested Schema for `object_templates.aam_auth_server_ldap_inst_tmpl_list.trigger_stats_rate`
...
<a id="nestedblock--object_templates--aam_auth_server_ldap_inst_tmpl_list--trigger_stats_severity"></a>
### Nested Schema for `object_templates.aam_auth_server_ldap_inst_tmpl_list.trigger_stats_severity`
...
<a id="nestedblock--object_templates--aam_auth_server_ocsp_inst_tmpl_list"></a>
### Nested Schema for `object_templates.aam_auth_server_ocsp_inst_tmpl_list`
...
- `capture_config` (String) Specify name of the capture-config to use with this template
- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--aam_auth_server_ocsp_inst_tmpl_list--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--aam_auth_server_ocsp_inst_tmpl_list--trigger_stats_rate))
- `trigger_stats_severity` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--aam_auth_server_ocsp_inst_tmpl_list--trigger_stats_severity))
- `user_tag` (String) Customized tag
- `uuid` (String) uuid of the object

<a id="nestedblock--object_templates--aam_auth_server_ocsp_inst_tmpl_list--trigger_stats_inc"></a>
### Nested Schema for `object_templates.aam_auth_server_ocsp_inst_tmpl_list.trigger_stats_inc`
...
<a id="nestedblock--object_templates--aam_auth_server_ocsp_inst_tmpl_list--trigger_stats_rate"></a>
### Nested Schema for `object_templates.aam_auth_server_ocsp_inst_tmpl_list.trigger_stats_rate`
...
<a id="nestedblock--object_templates--aam_auth_server_ocsp_inst_tmpl_list--trigger_stats_severity"></a>
### Nested Schema for `object_templates.aam_auth_server_ocsp_inst_tmpl_list.trigger_stats_severity`
...
<a id="nestedblock--object_templates--aam_auth_server_rad_inst_tmpl_list"></a>
### Nested Schema for `object_templates.aam_auth_server_rad_inst_tmpl_list`
...
- `capture_config` (String) Specify name of the capture-config to use with this template
- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--aam_auth_server_rad_inst_tmpl_list--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--aam_auth_server_rad_inst_tmpl_list--trigger_stats_rate))
- `trigger_stats_severity` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--aam_auth_server_rad_inst_tmpl_list--trigger_stats_severity))
- `user_tag` (String) Customized tag
- `uuid` (String) uuid of the object

<a id="nestedblock--object_templates--aam_auth_server_rad_inst_tmpl_list--trigger_stats_inc"></a>
### Nested Schema for `object_templates.aam_auth_server_rad_inst_tmpl_list.trigger_stats_inc`
...
<a id="nestedblock--object_templates--aam_auth_server_rad_inst_tmpl_list--trigger_stats_rate"></a>
### Nested Schema for `object_templates.aam_auth_server_rad_inst_tmpl_list.trigger_stats_rate`
...
<a id="nestedblock--object_templates--aam_auth_server_rad_inst_tmpl_list--trigger_stats_severity"></a>
### Nested Schema for `object_templates.aam_auth_server_rad_inst_tmpl_list.trigger_stats_severity`
...
<a id="nestedblock--object_templates--aam_auth_server_win_inst_tmpl_list"></a>
### Nested Schema for `object_templates.aam_auth_server_win_inst_tmpl_list`
...
- `capture_config` (String) Specify name of the capture-config to use with this template
- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--aam_auth_server_win_inst_tmpl_list--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--aam_auth_server_win_inst_tmpl_list--trigger_stats_rate))
- `trigger_stats_severity` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--aam_auth_server_win_inst_tmpl_list--trigger_stats_severity))
- `user_tag` (String) Customized tag
- `uuid` (String) uuid of the object

<a id="nestedblock--object_templates--aam_auth_server_win_inst_tmpl_list--trigger_stats_inc"></a>
### Nested Schema for `object_templates.aam_auth_server_win_inst_tmpl_list.trigger_stats_inc`
...
<a id="nestedblock--object_templates--aam_auth_server_win_inst_tmpl_list--trigger_stats_rate"></a>
### Nested Schema for `object_templates.aam_auth_server_win_inst_tmpl_list.trigger_stats_rate`
...
<a id="nestedblock--object_templates--aam_auth_server_win_inst_tmpl_list--trigger_stats_severity"></a>
### Nested Schema for `object_templates.aam_auth_server_win_inst_tmpl_list.trigger_stats_severity`
...
<a id="nestedblock--object_templates--aam_auth_service_group_mem_tmpl_list"></a>
### Nested Schema for `object_templates.aam_auth_service_group_mem_tmpl_list`
...
- `capture_config` (String) Specify name of the capture-config to use with this template
- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--aam_auth_service_group_mem_tmpl_list--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--aam_auth_service_group_mem_tmpl_list--trigger_stats_rate))
- `trigger_stats_severity` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--aam_auth_service_group_mem_tmpl_list--trigger_stats_severity))
- `user_tag` (String) Customized tag
- `uuid` (String) uuid of the object

<a id="nestedblock--object_templates--aam_auth_service_group_mem_tmpl_list--trigger_stats_inc"></a>
### Nested Schema for `object_templates.aam_auth_service_group_mem_tmpl_list.trigger_stats_inc`
...
<a id="nestedblock--object_templates--aam_auth_service_group_mem_tmpl_list--trigger_stats_rate"></a>
### Nested Schema for `object_templates.aam_auth_service_group_mem_tmpl_list.trigger_stats_rate`
...
<a id="nestedblock--object_templates--aam_auth_service_group_mem_tmpl_list--trigger_stats_severity"></a>
### Nested Schema for `object_templates.aam_auth_service_group_mem_tmpl_list.trigger_stats_severity`
...
<a id="nestedblock--object_templates--aam_auth_service_group_tmpl_list"></a>
### Nested Schema for `object_templates.aam_auth_service_group_tmpl_list`
...
- `capture_config` (String) Specify name of the capture-config to use with this template
- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--aam_auth_service_group_tmpl_list--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--aam_auth_service_group_tmpl_list--trigger_stats_rate))
- `trigger_stats_severity` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--aam_auth_service_group_tmpl_list--trigger_stats_severity))
- `user_tag` (String) Customized tag
- `uuid` (String) uuid of the object

<a id="nestedblock--object_templates--aam_auth_service_group_tmpl_list--trigger_stats_inc"></a>
### Nested Schema for `object_templates.aam_auth_service_group_tmpl_list.trigger_stats_inc`
...
<a id="nestedblock--object_templates--aam_auth_service_group_tmpl_list--trigger_stats_rate"></a>
### Nested Schema for `object_templates.aam_auth_service_group_tmpl_list.trigger_stats_rate`
...
<a id="nestedblock--object_templates--aam_auth_service_group_tmpl_list--trigger_stats_severity"></a>
### Nested Schema for `object_templates.aam_auth_service_group_tmpl_list.trigger_stats_severity`
...
<a id="nestedblock--object_templates--aam_jwt_authorization_tmpl_list"></a>
### Nested Schema for `object_templates.aam_jwt_authorization_tmpl_list`
...
- `capture_config` (String) Specify name of the capture-config to use with this template
- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--aam_jwt_authorization_tmpl_list--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--aam_jwt_authorization_tmpl_list--trigger_stats_rate))
- `trigger_stats_severity` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--aam_jwt_authorization_tmpl_list--trigger_stats_severity))
- `user_tag` (String) Customized tag
- `uuid` (String) uuid of the object

<a id="nestedblock--object_templates--aam_jwt_authorization_tmpl_list--trigger_stats_inc"></a>
### Nested Schema for `object_templates.aam_jwt_authorization_tmpl_list.trigger_stats_inc`
...
<a id="nestedblock--object_templates--aam_jwt_authorization_tmpl_list--trigger_stats_rate"></a>
### Nested Schema for `object_templates.aam_jwt_authorization_tmpl_list.trigger_stats_rate`
...
<a id="nestedblock--object_templates--aam_jwt_authorization_tmpl_list--trigger_stats_severity"></a>
### Nested Schema for `object_templates.aam_jwt_authorization_tmpl_list.trigger_stats_severity`
...
<a id="nestedblock--object_templates--captcha_template_inst_tmpl_list"></a>
### Nested Schema for `object_templates.captcha_template_inst_tmpl_list`
...
- `capture_config` (String) Specify name of the capture-config to use with this template
- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--captcha_template_inst_tmpl_list--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--captcha_template_inst_tmpl_list--trigger_stats_rate))
- `trigger_stats_severity` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--captcha_template_inst_tmpl_list--trigger_stats_severity))
- `user_tag` (String) Customized tag
- `uuid` (String) uuid of the object

<a id="nestedblock--object_templates--captcha_template_inst_tmpl_list--trigger_stats_inc"></a>
### Nested Schema for `object_templates.captcha_template_inst_tmpl_list.trigger_stats_inc`
...
<a id="nestedblock--object_templates--captcha_template_inst_tmpl_list--trigger_stats_rate"></a>
### Nested Schema for `object_templates.captcha_template_inst_tmpl_list.trigger_stats_rate`
...
<a id="nestedblock--object_templates--captcha_template_inst_tmpl_list--trigger_stats_severity"></a>
### Nested Schema for `object_templates.captcha_template_inst_tmpl_list.trigger_stats_severity`
...
<a id="nestedblock--object_templates--cgnv6_dns64_vs_port_tmpl_list"></a>
### Nested Schema for `object_templates.cgnv6_dns64_vs_port_tmpl_list`
...
- `capture_config` (String) Specify name of the capture-config to use with this template
- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--cgnv6_dns64_vs_port_tmpl_list--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--cgnv6_dns64_vs_port_tmpl_list--trigger_stats_rate))
- `trigger_stats_severity` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--cgnv6_dns64_vs_port_tmpl_list--trigger_stats_severity))
- `user_tag` (String) Customized tag
- `uuid` (String) uuid of the object

<a id="nestedblock--object_templates--cgnv6_dns64_vs_port_tmpl_list--trigger_stats_inc"></a>
### Nested Schema for `object_templates.cgnv6_dns64_vs_port_tmpl_list.trigger_stats_inc`
...
<a id="nestedblock--object_templates--cgnv6_dns64_vs_port_tmpl_list--trigger_stats_rate"></a>
### Nested Schema for `object_templates.cgnv6_dns64_vs_port_tmpl_list.trigger_stats_rate`
...
<a id="nestedblock--object_templates--cgnv6_dns64_vs_port_tmpl_list--trigger_stats_severity"></a>
### Nested Schema for `object_templates.cgnv6_dns64_vs_port_tmpl_list.trigger_stats_severity`
...
<a id="nestedblock--object_templates--cgnv6_encap_domain_tmpl_list"></a>
### Nested Schema for `object_templates.cgnv6_encap_domain_tmpl_list`
...
- `capture_config` (String) Specify name of the capture-config to use with this template
- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--cgnv6_encap_domain_tmpl_list--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--cgnv6_encap_domain_tmpl_list--trigger_stats_rate))
- `trigger_stats_severity` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--cgnv6_encap_domain_tmpl_list--trigger_stats_severity))
- `user_tag` (String) Customized tag
- `uuid` (String) uuid of the object

<a id="nestedblock--object_templates--cgnv6_encap_domain_tmpl_list--trigger_stats_inc"></a>
### Nested Schema for `object_templates.cgnv6_encap_domain_tmpl_list.trigger_stats_inc`
...
<a id="nestedblock--object_templates--cgnv6_encap_domain_tmpl_list--trigger_stats_rate"></a>
### Nested Schema for `object_templates.cgnv6_encap_domain_tmpl_list.trigger_stats_rate`
...
<a id="nestedblock--object_templates--cgnv6_encap_domain_tmpl_list--trigger_stats_severity"></a>
### Nested Schema for `object_templates.cgnv6_encap_domain_tmpl_list.trigger_stats_severity`
...
<a id="nestedblock--object_templates--cgnv6_map_trans_domain_tmpl_list"></a>
### Nested Schema for `object_templates.cgnv6_map_trans_domain_tmpl_list`
...
- `capture_config` (String) Specify name of the capture-config to use with this template
- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--cgnv6_map_trans_domain_tmpl_list--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--cgnv6_map_trans_domain_tmpl_list--trigger_stats_rate))
- `trigger_stats_severity` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--cgnv6_map_trans_domain_tmpl_list--trigger_stats_severity))
- `user_tag` (String) Customized tag
- `uuid` (String) uuid of the object

<a id="nestedblock--object_templates--cgnv6_map_trans_domain_tmpl_list--trigger_stats_inc"></a>
### Nested Schema for `object_templates.cgnv6_map_trans_domain_tmpl_list.trigger_stats_inc`
...
<a id="nestedblock--object_templates--cgnv6_map_trans_domain_tmpl_list--trigger_stats_rate"></a>
### Nested Schema for `object_templates.cgnv6_map_trans_domain_tmpl_list.trigger_stats_rate`
...
<a id="nestedblock--object_templates--cgnv6_map_trans_domain_tmpl_list--trigger_stats_severity"></a>
### Nested Schema for `object_templates.cgnv6_map_trans_domain_tmpl_list.trigger_stats_severity`
...
<a id="nestedblock--object_templates--cgnv6_serv_group_tmpl_list"></a>
### Nested Schema for `object_templates.cgnv6_serv_group_tmpl_list`
...
- `capture_config` (String) Specify name of the capture-config to use with this template
- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--cgnv6_serv_group_tmpl_list--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--cgnv6_serv_group_tmpl_list--trigger_stats_rate))
- `trigger_stats_severity` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--cgnv6_serv_group_tmpl_list--trigger_stats_severity))
- `user_tag` (String) Customized tag
- `uuid` (String) uuid of the object

<a id="nestedblock--object_templates--cgnv6_serv_group_tmpl_list--trigger_stats_inc"></a>
### Nested Schema for `object_templates.cgnv6_serv_group_tmpl_list.trigger_stats_inc`
...
<a id="nestedblock--object_templates--cgnv6_serv_group_tmpl_list--trigger_stats_rate"></a>
### Nested Schema for `object_templates.cgnv6_serv_group_tmpl_list.trigger_stats_rate`
...
<a id="nestedblock--object_templates--cgnv6_serv_group_tmpl_list--trigger_stats_severity"></a>
### Nested Schema for `object_templates.cgnv6_serv_group_tmpl_list.trigger_stats_severity`
...
<a id="nestedblock--object_templates--dns_vport_tmpl_list"></a>
### Nested Schema for `object_templates.dns_vport_tmpl_list`
...
- `capture_config` (String) Specify name of the capture-config to use with this template
- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--dns_vport_tmpl_list--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--dns_vport_tmpl_list--trigger_stats_rate))
- `trigger_stats_severity` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--dns_vport_tmpl_list--trigger_stats_severity))
- `user_tag` (String) Customized tag
- `uuid` (String) uuid of the object

<a id="nestedblock--object_templates--dns_vport_tmpl_list--trigger_stats_inc"></a>
### Nested Schema for `object_templates.dns_vport_tmpl_list.trigger_stats_inc`
...
<a id="nestedblock--object_templates--dns_vport_tmpl_list--trigger_stats_rate"></a>
### Nested Schema for `object_templates.dns_vport_tmpl_list.trigger_stats_rate`
...
<a id="nestedblock--object_templates--dns_vport_tmpl_list--trigger_stats_severity"></a>
### Nested Schema for `object_templates.dns_vport_tmpl_list.trigger_stats_severity`
...
<a id="nestedblock--object_templates--fw_server_port_tmpl_list"></a>
### Nested Schema for `object_templates.fw_server_port_tmpl_list`
...
- `capture_config` (String) Specify name of the capture-config to use with this template
- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--fw_server_port_tmpl_list--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--fw_server_port_tmpl_list--trigger_stats_rate))
- `trigger_stats_severity` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--fw_server_port_tmpl_list--trigger_stats_severity))
- `user_tag` (String) Customized tag
- `uuid` (String) uuid of the object

<a id="nestedblock--object_templates--fw_server_port_tmpl_list--trigger_stats_inc"></a>
### Nested Schema for `object_templates.fw_server_port_tmpl_list.trigger_stats_inc`
...
<a id="nestedblock--object_templates--fw_server_port_tmpl_list--trigger_stats_rate"></a>
### Nested Schema for `object_templates.fw_server_port_tmpl_list.trigger_stats_rate`
...
<a id="nestedblock--object_templates--fw_server_port_tmpl_list--trigger_stats_severity"></a>
### Nested Schema for `object_templates.fw_server_port_tmpl_list.trigger_stats_severity`
...
<a id="nestedblock--object_templates--fw_service_group_mem_tmpl_list"></a>
### Nested Schema for `object_templates.fw_service_group_mem_tmpl_list`
...
- `capture_config` (String) Specify name of the capture-config to use with this template
- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--fw_service_group_mem_tmpl_list--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--fw_service_group_mem_tmpl_list--trigger_stats_rate))
- `trigger_stats_severity` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--fw_service_group_mem_tmpl_list--trigger_stats_severity))
- `user_tag` (String) Customized tag
- `uuid` (String) uuid of the object

<a id="nestedblock--object_templates--fw_service_group_mem_tmpl_list--trigger_stats_inc"></a>
### Nested Schema for `object_templates.fw_service_group_mem_tmpl_list.trigger_stats_inc`
...
<a id="nestedblock--object_templates--fw_service_group_mem_tmpl_list--trigger_stats_rate"></a>
### Nested Schema for `object_templates.fw_service_group_mem_tmpl_list.trigger_stats_rate`
...
<a id="nestedblock--object_templates--fw_service_group_mem_tmpl_list--trigger_stats_severity"></a>
### Nested Schema for `object_templates.fw_service_group_mem_tmpl_list.trigger_stats_severity`
...
<a id="nestedblock--object_templates--fw_service_group_tmpl_list"></a>
### Nested Schema for `object_templates.fw_service_group_tmpl_list`
...
- `capture_config` (String) Specify name of the capture-config to use with this template
- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--fw_service_group_tmpl_list--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--fw_service_group_tmpl_list--trigger_stats_rate))
- `trigger_stats_severity` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--fw_service_group_tmpl_list--trigger_stats_severity))
- `user_tag` (String) Customized tag
- `uuid` (String) uuid of the object

<a id="nestedblock--object_templates--fw_service_group_tmpl_list--trigger_stats_inc"></a>
### Nested Schema for `object_templates.fw_service_group_tmpl_list.trigger_stats_inc`
...
<a id="nestedblock--object_templates--fw_service_group_tmpl_list--trigger_stats_rate"></a>
### Nested Schema for `object_templates.fw_service_group_tmpl_list.trigger_stats_rate`
...
<a id="nestedblock--object_templates--fw_service_group_tmpl_list--trigger_stats_severity"></a>
### Nested Schema for `object_templates.fw_service_group_tmpl_list.trigger_stats_severity`
...
<a id="nestedblock--object_templates--imap_vport_tmpl_list"></a>
### Nested Schema for `object_templates.imap_vport_tmpl_list`
...
- `capture_config` (String) Specify name of the capture-config to use with this template
- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--imap_vport_tmpl_list--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--imap_vport_tmpl_list--trigger_stats_rate))
- `trigger_stats_severity` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--imap_vport_tmpl_list--trigger_stats_severity))
- `user_tag` (String) Customized tag
- `uuid` (String) uuid of the object

<a id="nestedblock--object_templates--imap_vport_tmpl_list--trigger_stats_inc"></a>
### Nested Schema for `object_templates.imap_vport_tmpl_list.trigger_stats_inc`
...
<a id="nestedblock--object_templates--imap_vport_tmpl_list--trigger_stats_rate"></a>
### Nested Schema for `object_templates.imap_vport_tmpl_list.trigger_stats_rate`
...
<a id="nestedblock--object_templates--imap_vport_tmpl_list--trigger_stats_severity"></a>
### Nested Schema for `object_templates.imap_vport_tmpl_list.trigger_stats_severity`
...
<a id="nestedblock--object_templates--interface_ethernet_tmpl_list"></a>
### Nested Schema for `object_templates.interface_ethernet_tmpl_list`
...
- `capture_config` (String) Specify name of the capture-config to use with this template
- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--interface_ethernet_tmpl_list--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--interface_ethernet_tmpl_list--trigger_stats_rate))
- `trigger_stats_severity` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--interface_ethernet_tmpl_list--trigger_stats_severity))
- `user_tag` (String) Customized tag
- `uuid` (String) uuid of the object

<a id="nestedblock--object_templates--interface_ethernet_tmpl_list--trigger_stats_inc"></a>
### Nested Schema for `object_templates.interface_ethernet_tmpl_list.trigger_stats_inc`
...
<a id="nestedblock--object_templates--interface_ethernet_tmpl_list--trigger_stats_rate"></a>
### Nested Schema for `object_templates.interface_ethernet_tmpl_list.trigger_stats_rate`
...
<a id="nestedblock--object_templates--interface_ethernet_tmpl_list--trigger_stats_severity"></a>
### Nested Schema for `object_templates.interface_ethernet_tmpl_list.trigger_stats_severity`
...
<a id="nestedblock--object_templates--interface_tunnel_tmpl_list"></a>
### Nested Schema for `object_templates.interface_tunnel_tmpl_list`
...
- `capture_config` (String) Specify name of the capture-config to use with this template
- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--interface_tunnel_tmpl_list--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--interface_tunnel_tmpl_list--trigger_stats_rate))
- `trigger_stats_severity` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--interface_tunnel_tmpl_list--trigger_stats_severity))
- `user_tag` (String) Customized tag
- `uuid` (String) uuid of the object

<a id="nestedblock--object_templates--interface_tunnel_tmpl_list--trigger_stats_inc"></a>
### Nested Schema for `object_templates.interface_tunnel_tmpl_list.trigger_stats_inc`
...
<a id="nestedblock--object_templates--interface_tunnel_tmpl_list--trigger_stats_rate"></a>
### Nested Schema for `object_templates.interface_tunnel_tmpl_list.trigger_stats_rate`
...
<a id="nestedblock--object_templates--interface_tunnel_tmpl_list--trigger_stats_severity"></a>
### Nested Schema for `object_templates.interface_tunnel_tmpl_list.trigger_stats_severity`
...
<a id="nestedblock--object_templates--netflow_monitor_tmpl_list"></a>
### Nested Schema for `object_templates.netflow_monitor_tmpl_list`
...
- `capture_config` (String) Specify name of the capture-config to use with this template
- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--netflow_monitor_tmpl_list--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--netflow_monitor_tmpl_list--trigger_stats_rate))
- `trigger_stats_severity` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--netflow_monitor_tmpl_list--trigger_stats_severity))
- `user_tag` (String) Customized tag
- `uuid` (String) uuid of the object

<a id="nestedblock--object_templates--netflow_monitor_tmpl_list--trigger_stats_inc"></a>
### Nested Schema for `object_templates.netflow_monitor_tmpl_list.trigger_stats_inc`
...
<a id="nestedblock--object_templates--netflow_monitor_tmpl_list--trigger_stats_rate"></a>
### Nested Schema for `object_templates.netflow_monitor_tmpl_list.trigger_stats_rate`
...
<a id="nestedblock--object_templates--netflow_monitor_tmpl_list--trigger_stats_severity"></a>
### Nested Schema for `object_templates.netflow_monitor_tmpl_list.trigger_stats_severity`
...
<a id="nestedblock--object_templates--pop3_vport_tmpl_list"></a>
### Nested Schema for `object_templates.pop3_vport_tmpl_list`
...
- `capture_config` (String) Specify name of the capture-config to use with this template
- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--pop3_vport_tmpl_list--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--pop3_vport_tmpl_list--trigger_stats_rate))
- `trigger_stats_severity` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--pop3_vport_tmpl_list--trigger_stats_severity))
- `user_tag` (String) Customized tag
- `uuid` (String) uuid of the object

<a id="nestedblock--object_templates--pop3_vport_tmpl_list--trigger_stats_inc"></a>
### Nested Schema for `object_templates.pop3_vport_tmpl_list.trigger_stats_inc`
...
<a id="nestedblock--object_templates--pop3_vport_tmpl_list--trigger_stats_rate"></a>
### Nested Schema for `object_templates.pop3_vport_tmpl_list.trigger_stats_rate`
...
<a id="nestedblock--object_templates--pop3_vport_tmpl_list--trigger_stats_severity"></a>
### Nested Schema for `object_templates.pop3_vport_tmpl_list.trigger_stats_severity`
...
<a id="nestedblock--object_templates--rule_set_rule_tmpl_list"></a>
### Nested Schema for `object_templates.rule_set_rule_tmpl_list`
...
- `capture_config` (String) Specify name of the capture-config to use with this template
- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--rule_set_rule_tmpl_list--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--rule_set_rule_tmpl_list--trigger_stats_rate))
- `trigger_stats_severity` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--rule_set_rule_tmpl_list--trigger_stats_severity))
- `user_tag` (String) Customized tag
- `uuid` (String) uuid of the object

<a id="nestedblock--object_templates--rule_set_rule_tmpl_list--trigger_stats_inc"></a>
### Nested Schema for `object_templates.rule_set_rule_tmpl_list.trigger_stats_inc`
...
<a id="nestedblock--object_templates--rule_set_rule_tmpl_list--trigger_stats_rate"></a>
### Nested Schema for `object_templates.rule_set_rule_tmpl_list.trigger_stats_rate`
...
<a id="nestedblock--object_templates--rule_set_rule_tmpl_list--trigger_stats_severity"></a>
### Nested Schema for `object_templates.rule_set_rule_tmpl_list.trigger_stats_severity`
...
<a id="nestedblock--object_templates--rule_set_tmpl_list"></a>
### Nested Schema for `object_templates.rule_set_tmpl_list`
...
- `capture_config` (String) Specify name of the capture-config to use with this template
- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--rule_set_tmpl_list--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--rule_set_tmpl_list--trigger_stats_rate))
- `trigger_stats_severity` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--rule_set_tmpl_list--trigger_stats_severity))
- `user_tag` (String) Customized tag
- `uuid` (String) uuid of the object

<a id="nestedblock--object_templates--rule_set_tmpl_list--trigger_stats_inc"></a>
### Nested Schema for `object_templates.rule_set_tmpl_list.trigger_stats_inc`
...
<a id="nestedblock--object_templates--rule_set_tmpl_list--trigger_stats_rate"></a>
### Nested Schema for `object_templates.rule_set_tmpl_list.trigger_stats_rate`
...
<a id="nestedblock--object_templates--rule_set_tmpl_list--trigger_stats_severity"></a>
### Nested Schema for `object_templates.rule_set_tmpl_list.trigger_stats_severity`
...
<a id="nestedblock--object_templates--slb_port_tmpl_list"></a>
### Nested Schema for `object_templates.slb_port_tmpl_list`
...
- `capture_config` (String) Specify name of the capture-config to use with this template
- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--slb_port_tmpl_list--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--slb_port_tmpl_list--trigger_stats_rate))
- `trigger_stats_severity` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--slb_port_tmpl_list--trigger_stats_severity))
- `user_tag` (String) Customized tag
- `uuid` (String) uuid of the object

<a id="nestedblock--object_templates--slb_port_tmpl_list--trigger_stats_inc"></a>
### Nested Schema for `object_templates.slb_port_tmpl_list.trigger_stats_inc`
...
<a id="nestedblock--object_templates--slb_port_tmpl_list--trigger_stats_rate"></a>
### Nested Schema for `object_templates.slb_port_tmpl_list.trigger_stats_rate`
...
<a id="nestedblock--object_templates--slb_port_tmpl_list--trigger_stats_severity"></a>
### Nested Schema for `object_templates.slb_port_tmpl_list.trigger_stats_severity`
...
<a id="nestedblock--object_templates--slb_service_tmpl_list"></a>
### Nested Schema for `object_templates.slb_service_tmpl_list`
...
- `capture_config` (String) Specify name of the capture-config to use with this template
- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--slb_service_tmpl_list--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--slb_service_tmpl_list--trigger_stats_rate))
- `trigger_stats_severity` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--slb_service_tmpl_list--trigger_stats_severity))
- `user_tag` (String) Customized tag
- `uuid` (String) uuid of the object

<a id="nestedblock--object_templates--slb_service_tmpl_list--trigger_stats_inc"></a>
### Nested Schema for `object_templates.slb_service_tmpl_list.trigger_stats_inc`
...
<a id="nestedblock--object_templates--slb_service_tmpl_list--trigger_stats_rate"></a>
### Nested Schema for `object_templates.slb_service_tmpl_list.trigger_stats_rate`
...
<a id="nestedblock--object_templates--slb_service_tmpl_list--trigger_stats_severity"></a>
### Nested Schema for `object_templates.slb_service_tmpl_list.trigger_stats_severity`
...
<a id="nestedblock--object_templates--slb_templ_cache_tmpl_list"></a>
### Nested Schema for `object_templates.slb_templ_cache_tmpl_list`
...
- `capture_config` (String) Specify name of the capture-config to use with this template
- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--slb_templ_cache_tmpl_list--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--slb_templ_cache_tmpl_list--trigger_stats_rate))
- `trigger_stats_severity` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--slb_templ_cache_tmpl_list--trigger_stats_severity))
- `user_tag` (String) Customized tag
- `uuid` (String) uuid of the object

<a id="nestedblock--object_templates--slb_templ_cache_tmpl_list--trigger_stats_inc"></a>
### Nested Schema for `object_templates.slb_templ_cache_tmpl_list.trigger_stats_inc`
...
<a id="nestedblock--object_templates--slb_templ_cache_tmpl_list--trigger_stats_rate"></a>
### Nested Schema for `object_templates.slb_templ_cache_tmpl_list.trigger_stats_rate`
...
<a id="nestedblock--object_templates--slb_templ_cache_tmpl_list--trigger_stats_severity"></a>
### Nested Schema for `object_templates.slb_templ_cache_tmpl_list.trigger_stats_severity`
...
<a id="nestedblock--object_templates--slb_vport_tmpl_list"></a>
### Nested Schema for `object_templates.slb_vport_tmpl_list`
...
- `capture_config` (String) Specify name of the capture-config to use with this template
- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--slb_vport_tmpl_list--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--slb_vport_tmpl_list--trigger_stats_rate))
- `trigger_stats_severity` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--slb_vport_tmpl_list--trigger_stats_severity))
- `user_tag` (String) Customized tag
- `uuid` (String) uuid of the object

<a id="nestedblock--object_templates--slb_vport_tmpl_list--trigger_stats_inc"></a>
### Nested Schema for `object_templates.slb_vport_tmpl_list.trigger_stats_inc`
...
<a id="nestedblock--object_templates--slb_vport_tmpl_list--trigger_stats_rate"></a>
### Nested Schema for `object_templates.slb_vport_tmpl_list.trigger_stats_rate`
...
<a id="nestedblock--object_templates--slb_vport_tmpl_list--trigger_stats_severity"></a>
### Nested Schema for `object_templates.slb_vport_tmpl_list.trigger_stats_severity`
...
<a id="nestedblock--object_templates--smtp_vport_tmpl_list"></a>
### Nested Schema for `object_templates.smtp_vport_tmpl_list`
...
- `capture_config` (String) Specify name of the capture-config to use with this template
- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--smtp_vport_tmpl_list--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--smtp_vport_tmpl_list--trigger_stats_rate))
- `trigger_stats_severity` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--smtp_vport_tmpl_list--trigger_stats_severity))
- `user_tag` (String) Customized tag
- `uuid` (String) uuid of the object

<a id="nestedblock--object_templates--smtp_vport_tmpl_list--trigger_stats_inc"></a>
### Nested Schema for `object_templates.smtp_vport_tmpl_list.trigger_stats_inc`
...
<a id="nestedblock--object_templates--smtp_vport_tmpl_list--trigger_stats_rate"></a>
### Nested Schema for `object_templates.smtp_vport_tmpl_list.trigger_stats_rate`
...
<a id="nestedblock--object_templates--smtp_vport_tmpl_list--trigger_stats_severity"></a>
### Nested Schema for `object_templates.smtp_vport_tmpl_list.trigger_stats_severity`
...
<a id="nestedblock--object_templates--templ_gtp_plcy_tmpl_list"></a>
### Nested Schema for `object_templates.templ_gtp_plcy_tmpl_list`
...
- `capture_config` (String) Specify name of the capture-config to use with this template
- `trigger_stats_inc` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--templ_gtp_plcy_tmpl_list--trigger_stats_inc))
- `trigger_stats_rate` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--templ_gtp_plcy_tmpl_list--trigger_stats_rate))
- `trigger_stats_severity` (Block List, Max: 1) (see [below for nested schema](#nestedblock--object_templates--templ_gtp_plcy_tmpl_list--trigger_stats_severity))
- `user_tag` (String) Customized tag
- `uuid` (String) uuid of the object

<a id="nestedblock--object_templates--templ_gtp_plcy_tmpl_list--trigger_stats_inc"></a>
### Nested Schema for `object_templates.templ_gtp_plcy_tmpl_list.trigger_stats_inc`
...
<a id="nestedblock--object_templates--templ_gtp_plcy_tmpl_list--trigger_stats_rate"></a>
### Nested Schema for `object_templates.templ_gtp_plcy_tmpl_list.trigger_stats_rate`
...
<a id="nestedblock--object_templates--templ_gtp_plcy_tmpl_list--trigger_stats_severity"></a>
### Nested Schema for `object_templates.templ_gtp_plcy_tmpl_list.trigger_stats_severity`
