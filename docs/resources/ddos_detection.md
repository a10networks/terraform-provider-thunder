...
- `agent_group_list` (Block List) (see [below for nested schema](#nestedblock--agent_group_list))
...
<a id="nestedblock--agent_group_list"></a>
### Nested Schema for `agent_group_list`
...
- `agent` (Block List) (see [below for nested schema](#nestedblock--agent_group_list--agent))
- `user_tag` (String) Customized tag
- `uuid` (String) uuid of the object

<a id="nestedblock--agent_group_list--agent"></a>
### Nested Schema for `agent_group_list.agent`
...
- `pkt_sampling` (Block List) (see [below for nested schema](#nestedblock--settings--pkt_sampling))
...
- `uuid` (String) uuid of the object
- `zone_notifications` (Block List, Max: 1) (see [below for nested schema](#nestedblock--settings--zone_notifications))
...
<a id="nestedblock--settings--zone_notifications"></a>
### Nested Schema for `settings.zone_notifications`
