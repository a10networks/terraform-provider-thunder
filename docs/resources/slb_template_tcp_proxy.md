...
- `tcp_do_newsack` (String) 'enable': Enable fast sack loss recovery; 'disable': Disable fast sack loss recovery; 'auto-select': Auto select fast sack loss recovery (disable);
