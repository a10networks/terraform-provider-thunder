...
page_title: "thunder_interface_tunnel_ipv6 Resource - terraform-provider-thunder"
subcategory: ""
description: |-
  thunder_interface_tunnel_ipv6: Global IPv6 configuration subcommands
  PLACEHOLDER
---

# thunder_interface_tunnel_ipv6 (Resource)
...
- `address_cfg` (Block List) (see [below for nested schema](#nestedblock--address_cfg))
...
<a id="nestedblock--address_cfg"></a>
### Nested Schema for `address_cfg`
