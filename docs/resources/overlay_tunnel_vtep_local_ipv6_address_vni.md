...
page_title: "thunder_overlay_tunnel_vtep_local_ipv6_address_vni Resource - terraform-provider-thunder"
subcategory: ""
description: |-
  thunder_overlay_tunnel_vtep_local_ipv6_address_vni: IP Address of the local tunnel end point
  PLACEHOLDER
---

# thunder_overlay_tunnel_vtep_local_ipv6_address_vni (Resource)
