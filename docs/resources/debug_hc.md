...
- `logd_audit_export` (Number) Debug logs for harmony controller (logd-audit-export)
- `logd_syslog_export` (Number) Debug logs for harmony controller (logd-syslog-export)
