...
page_title: "thunder_ddos_dst_entry_port_range_stats_l4_ssl_port Resource - terraform-provider-thunder"
subcategory: ""
description: |-
  thunder_ddos_dst_entry_port_range_stats_l4_ssl_port: Statistics for the object port-range
  PLACEHOLDER
---

# thunder_ddos_dst_entry_port_range_stats_l4_ssl_port (Resource)
...
- `l4_ssl_port` (Block List, Max: 1) (see [below for nested schema](#nestedblock--stats--l4_ssl_port))

<a id="nestedblock--stats--l4_ssl_port"></a>
### Nested Schema for `stats.l4_ssl_port`
