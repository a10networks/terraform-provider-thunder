...
page_title: "thunder_ddos_dst_zone_ip_proto_proto_number_stats_other_zone_ipproto Resource - terraform-provider-thunder"
subcategory: ""
description: |-
  thunder_ddos_dst_zone_ip_proto_proto_number_stats_other_zone_ipproto: Statistics for the object proto-number
  PLACEHOLDER
---

# thunder_ddos_dst_zone_ip_proto_proto_number_stats_other_zone_ipproto (Resource)
...
- `other_zone_ipproto` (Block List, Max: 1) (see [below for nested schema](#nestedblock--stats--other_zone_ipproto))

<a id="nestedblock--stats--other_zone_ipproto"></a>
### Nested Schema for `stats.other_zone_ipproto`
