...
- `aflex_persist_uie_chassis_sync_enable` (Number) Enable aflex persist uie cross PU sync
...
- `dns_cache_hitcount_enable` (Number) Enable DNS cache entry hit count
...
- `global_dns_cache` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_dns_cache))
...
- `odd_even_nat_one_arm` (Number) Enable odd even nat pool allocation in one-arm deployment
...
- `qat4` (Number) HW assisted QAT Gen4 SSL module
...
- `redirect_dummy_ethernet` (Number) Ethernet interface (Ethernet interface number)
- `redirect_dummy_vlan` (Number) VLAN Id
...
- `source_entry_age` (Number) Source entry age in minutes (default 2)
- `uuid` (String) uuid of the object


<a id="nestedblock--global_dns_cache"></a>
### Nested Schema for `global_dns_cache`

Optional:

- `class_list` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_dns_cache--class_list))
- `uuid` (String) uuid of the object

<a id="nestedblock--global_dns_cache--class_list"></a>
### Nested Schema for `global_dns_cache.class_list`

Optional:

- `lid_list` (Block List) (see [below for nested schema](#nestedblock--global_dns_cache--class_list--lid_list))
- `name` (String) Specify a class list name
- `uuid` (String) uuid of the object

<a id="nestedblock--global_dns_cache--class_list--lid_list"></a>
### Nested Schema for `global_dns_cache.class_list.lid_list`
...
- `dns` (Block List, Max: 1) (see [below for nested schema](#nestedblock--global_dns_cache--class_list--lid_list--dns))
...
<a id="nestedblock--global_dns_cache--class_list--lid_list--dns"></a>
### Nested Schema for `global_dns_cache.class_list.lid_list.dns`
