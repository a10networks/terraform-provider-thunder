...
page_title: "thunder_ddos_dst_zone_ip_proto_proto_name_stats_ipproto_icmp Resource - terraform-provider-thunder"
subcategory: ""
description: |-
  thunder_ddos_dst_zone_ip_proto_proto_name_stats_ipproto_icmp: Statistics for the object proto-name
  PLACEHOLDER
---

# thunder_ddos_dst_zone_ip_proto_proto_name_stats_ipproto_icmp (Resource)
...
- `ipproto_icmp` (Block List, Max: 1) (see [below for nested schema](#nestedblock--stats--ipproto_icmp))

<a id="nestedblock--stats--ipproto_icmp"></a>
### Nested Schema for `stats.ipproto_icmp`
