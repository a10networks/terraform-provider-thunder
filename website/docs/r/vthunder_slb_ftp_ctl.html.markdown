---
layout: "vthunder"
page_title: "vthunder: vthunder_slb_ftp_ctl"
sidebar_current: "docs-vthunder-resource-slb-ftp-ctl"
description: |-
    Provides details about vthunder SLB ftp-ctl resource for A10
---

# vthunder\_slb\_ftp_ctl

`vthunder_slb_ftp_ctl` Provides details about vthunder SLB ftp-ctl
## Example Usage
...
resource "vthunder_slb_ftp_ctl" "ftp_ctl" {
	sampling_enable {
		counters1 = "all"
	}
}
