---
layout: "thunder"
page_title: "thunder: thunder_slb_ftp_ctl"
sidebar_current: "docs-thunder-resource-slb-ftp-ctl"
description: |-
    Provides details about thunder SLB ftp-ctl resource for A10
---

# thunder\_slb\_ftp_ctl

`thunder_slb_ftp_ctl` Provides details about thunder SLB ftp-ctl
## Example Usage
...
resource "thunder_slb_ftp_ctl" "ftp_ctl" {
	sampling_enable {
		counters1 = "all"
	}
}
