...
func PostRouterBgpAddressFamilyIpv6NeighborIpv4Neighbor(id string, name1 string, inst RouterBgpAddressFamilyIpv6NeighborIpv4Neighbor, host string) {
	...
	if err != nil {
		...
		if erro != nil {
			...
			check_api_status("PostRouterBgpAddressFamilyIpv6NeighborIpv4Neighbor", data)
...
func GetRouterBgpAddressFamilyIpv6NeighborIpv4Neighbor(id string, name1 string, name2 string, host string) (*RouterBgpAddressFamilyIpv6NeighborIpv4Neighbor, error) {
	...
	if err != nil {
		...
		if erro != nil {
			...
			check_api_status("GetRouterBgpAddressFamilyIpv6NeighborIpv4Neighbor", data)
			return &m, nil
		}
	}
...
func PutRouterBgpAddressFamilyIpv6NeighborIpv4Neighbor(id string, name1 string, name2 string, inst RouterBgpAddressFamilyIpv6NeighborIpv4Neighbor, host string) {
	...
	if err != nil {
		...
		if erro != nil {
			...
			check_api_status("PutRouterBgpAddressFamilyIpv6NeighborIpv4Neighbor", data)
